...
const messages = {
    ...
    bypassKerberosDetail:
        "O bien no está identificado mediante Kerberos o su navegador no está configurado para identificarse mediante Kerberos. Por favor haga clic para identificarse por otro medio",
    ...
    loginTotpIntro:
        "Es necesario configurar un generador de claves de un sólo uso para acceder a esta cuenta",
    ...
    loginTotpStep3:
        "Introduzca el código único que le muestra la aplicación de autenticación y haga clic en Enviar para finalizar la configuración.",
    loginTotpStep3DeviceName:
        "Introduce un nombre de dispositivo para que te ayude a gestionar tus dispositivos OTP.",
    loginTotpManualStep2: "Abre la aplicación e introduce la clave:",
    loginTotpManualStep3:
        "Usa los siguientes parámetros de configuración si la aplicación te permite introducirlos:",
    ...
    emailVerifyInstruction1:
        "Se ha enviado un correo electrónico con instrucciones para verificar tu dirección de correo a {0}.",
    ...
    emailInstruction:
        "Indique su usuario o email y le enviaremos instrucciones indicando cómo generar una nueva contraseña.",
    ...
    federatedIdentityExistsMessage:
        "El usuario con {0} {1} ya existe. Inicie sesión en la administración de cuentas para vincular la cuenta.",
    federatedIdentityUnavailableMessage:
        "El usuario {0} autenticado con el proveedor de identidad {1} no existe. Póngase en contacto con su administrador.",
    configureTotpMessage:
        "Tiene que configurar la aplicación móvil de identificación para activar su cuenta.",
    ...
    updateEmailMessage:
        "Tiene que actualizar su dirección de correo electrónico para activar su cuenta.",
    ...
    identityProviderAlreadyLinkedMessage:
        "La identidad federada devuelta por {0} ya está vinculada a otro usuario.",
    ...
    identityProviderNotFoundMessage:
        "No se pudo encontrar un proveedor de identidad con el identificador.",
    realmSupportsNoCredentialsMessage: "El realm no soporta ningún tipo de credenciales.",
    identityProviderNotUniqueMessage:
        "El realm soporta múltiples proveedores de identidad. No se pudo determinar el proveedor de identidad que debería ser utilizado para identificarse.",
    emailVerifiedMessage: "Tu email ha sido verificado.",
    staleEmailVerificationLink:
        "El enlace en el que hizo clic es un enlace obsoleto antiguo y ya no es válido. Tal vez ya haya verificado su correo electrónico.",
    identityProviderInvalidResponseMessage: "Respuesta no válida del proveedor de identidad.",
    confirmAccountLinking:
        "Confirme la vinculación de la cuenta {0} del proveedor de identidad {1} con su cuenta.",
    identityProviderMissingStateMessage:
        "Falta el parámetro de estado en respuesta del proveedor de identidad.",
    ...
    deletingAccountForbidden:
        "No tiene suficientes permisos para eliminar su propia cuenta, comuníquese con un administrador.",
    ...
    emailUpdateConfirmationSent:
        "Se ha enviado un correo electrónico de confirmación a {0}. Debe seguir las instrucciones de este para completar la actualización del correo electrónico.",
    ...
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "El cliente no puede iniciar la petición de autorización del dispositivo OAuth 2.0. El flujo está deshabilitado para el cliente.",
    emailLinkIdpTitle: "Enlace {0}",
    emailLinkIdp1:
        "Se le ha enviado un correo electrónico con instrucciones para vincular {0} cuenta {1} con su cuenta {2}.",
    ...
    emailInstructionUsername:
        "Ingrese su nombre de usuario y le enviaremos instrucciones sobre cómo crear una nueva contraseña.",
    ...
    federatedIdentityUnmatchedEssentialClaimMessage:
        "El token de identificación emitido por el proveedor de identidad no coincide con el reclamo esencial configurado. Póngase en contacto con su administrador.",
    ...
    delegationCompleteMessage:
        "Puede cerrar esta ventana del navegador y volver a la aplicación de su consola.",
    delegationFailedHeader: "Error de inicio de sesión",
    delegationFailedMessage:
        "Puede cerrar esta ventana del navegador, volver a la aplicación de su consola e intentar iniciar sesión nuevamente.",
    ...
    invalidPasswordGenericMessage:
        "Contraseña no válida: la nueva contraseña no coincide con las políticas de contraseña.",
    successLogout: "Está desconectado",
    standardFlowDisabledMessage:
        "El cliente no puede iniciar el inicio de sesión del navegador con el tipo de respuesta dado. El flujo estándar está deshabilitado para el cliente.",
    implicitFlowDisabledMessage:
        "El cliente no puede iniciar el inicio de sesión del navegador con el tipo de respuesta dado. El flujo implícito está deshabilitado para el cliente.",
    cookieNotFoundMessage:
        "No se encontró la cookie de reinicio de inicio de sesión. Puede haber expirado, haber sido eliminada o las cookies pueden estar deshabilitadas en su navegador. Si las cookies están deshabilitadas, habilítelas. Haga clic en Volver a la aplicación para iniciar sesión nuevamente.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Código faltante o parámetro de error en respuesta del proveedor de identidad.",
    ...
    identityProviderLinkSuccess:
        "Verificó con éxito su correo electrónico. Vuelva a su navegador original y continúe allí con el inicio de sesión.",
    ...
    differentUserAuthenticated:
        "Ya está autenticado como un usuario diferente '{0}' en esta sesión. Por favor cierre sesión primero.",
    brokerLinkingSessionExpired:
        "Vinculación de la cuenta del corredor solicitada, pero la sesión actual ya no es válida.",
    ...
    "console-verify-email":
        "Debe verificar su dirección de correo electrónico. Enviamos un correo electrónico a {0} que contiene un código de verificación. Ingrese este código en la entrada a continuación.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript está deshabilitado. Recomendamos encarecidamente habilitarlo. Haga clic en el botón de abajo para continuar.",
    ...
    "recovery-authn-codes-display-name": "Código de autenticación de recuperación",
    "recovery-authn-codes-help-text":
        "Ingrese un código de autenticación de recuperación desde una lista generada anteriormente.",
    ...
    "recovery-code-config-warning-title":
        "Estos códigos de recuperación no volverán a aparecer después de salir de esta página",
    "recovery-code-config-warning-message":
        "Asegúrese de imprimir, descargarlos o copiarlos a un administrador de contraseñas y mantenerlos seguros. Cancelar esta configuración eliminará estos códigos de recuperación de su cuenta.",
    ...
    "recovery-codes-download-file-header":
        "Mantenga estos códigos de recuperación en algún lugar seguros.",
    "recovery-codes-download-file-description":
        "Los códigos de recuperación son códigos de acceso de un solo uso que le permiten iniciar sesión en su cuenta si no tiene acceso a su autenticador.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn no es compatible con este navegador. Pruebe con otro o comuníquese con su administrador.",
    ...
    "webauthn-error-different-user":
        "El primer usuario autenticado no es el autenticado por el Passkey.",
    "webauthn-error-auth-verification":
        "El resultado de la autenticación con el Passkey no es válido.  {0}",
    ...
    finalDeletionConfirmation:
        "Si elimina su cuenta, no se puede restaurar. Para mantener su cuenta, haga clic en Cancelar.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Está intentando vincular su cuenta {0} con la cuenta {1} {2}. Pero su cuenta ya está vinculada con otra cuenta {3} {4}. ¿Puede confirmar si desea reemplazar el enlace existente con la nueva cuenta?",
    confirmOverrideIdpContinue: "Sí, reemplazar el enlace con la cuenta actual",
    invalidPasswordNotContainsUsernameMessage:
        "Contraseña no válida: no puede contener el nombre de usuario.",
    ...
    "error-invalid-multivalued-size":
        "El atributo {0} debe tener al menos {1} y como máximo {2} {2,choice,0#valores|1#valor|1<valores}.",
    ...
    "organization.confirm-membership":
        "Al hacer clic en el enlace de abajo, se convertirá en miembro de la organización {0}:",
    ...
    "passkey-unsupported-browser-text":
        "Este navegador no admite Passkey. Pruebe con otro o contacte a su administrador.",
    ...
    emailVerifyInstruction4:
        "Para verificar su dirección de correo electrónico, le enviaremos un correo con instrucciones a la dirección {0}.",
    ...
    confirmAccountLinkingBody:
        "Si vincula la cuenta, también podrá iniciar sesión utilizando la cuenta {0} del proveedor de identidad {1}. No continúe si usted no inició este proceso o no desea vincular la cuenta.",
    codeSuccess: "Código de éxito",
    emailVerifySendCooldown:
        "Debe esperar {0} segundos antes de volver a enviar el correo electrónico de verificación.",
    "error-non-ascii-local-part-email":
        "La parte local de la dirección debe contener únicamente caracteres ASCII.",
    ...
    emailVerificationCancelled:
        "Esta verificación de correo electrónico ha sido cancelada por un administrador.",
    ...
    emailVerificationPending:
        "Se envió un correo electrónico de verificación a {0}. Puede enviarlo sin cambios para reenviarlo o ingresar una dirección de correo electrónico diferente.",
    orgMemberAlready: "Usted ya es miembro de la organización {1}.",
    staleInviteOrgLink:
        "El enlace en el que hiciste clic ya no es válido. Es posible que haya caducado o que ya se haya utilizado.",
