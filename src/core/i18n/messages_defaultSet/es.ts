...
const messages = {
    ...
    "updateEmailMessage":
        "Tienes que actualizar su dirección de correo electrónico para activar su cuenta.",
    ...
    "linkIdpMessage":
        "Debe verificar su dirección de correo electrónico para vincular su cuenta con {0}.",
    ...
    "staleEmailVerificationLink":
        "El enlace en el que hizo clic es un enlace obsoleto antiguo y ya no es válido. Tal vez ya hayas verificado tu correo electrónico.",
    ...
    "delegationFailedMessage":
        "Puede cerrar esta ventana del navegador y volver a la aplicación de su consola e intentar iniciar sesión nuevamente.",
    ...
    "cookieNotFoundMessage":
        "Cookie no encontrada. Asegúrese de que las cookies estén habilitadas en su navegador.",
    ...
    "identityProviderInvalidSignatureMessage":
        "Firma no válida en respuesta del proveedor de identidad.",
    ...
    "recovery-code-config-warning-title":
        "Estos códigos de recuperación no aparecerán nuevamente después de dejar esta página.",
    ...
    "webauthn-error-different-user":
        "El primer usuario autenticado no es el autenticado por la clave de seguridad.",
    "webauthn-error-auth-verification":
        "El resultado de la autenticación de la clave de seguridad no es válido. <br/> {0}",
    "webauthn-error-register-verification":
        "El resultado de registro de clave de seguridad no es válido. <br/> {0}",
