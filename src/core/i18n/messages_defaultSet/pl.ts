...
const messages = {
    ...
    deletingAccountForbidden:
        "Nie masz uprawnień do usunięcia własnego konta. Skontaktuj się z administratorem.",
    ...
    oauthGrantInformation:
        "Upewnij się, że ufasz {0}, dowiedz się, jak {0} będzie przetwarzać Twoje dane.",
    ...
    emailUpdateConfirmationSent:
        "E-mail z potwierdzeniem został wysłany na adres {0}. Musisz postępować zgodnie z instrukcjami, aby zakończyć aktualizację adresu e-mail.",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Kod wygasł. Wróć do swojego urządzenia i spróbuj ponownie się połączyć.",
    oauth2DeviceVerificationCompleteHeader: "Logowanie urządzenia zakończone pomyślnie",
    oauth2DeviceVerificationCompleteMessage:
        "Możesz zamknąć to okno przeglądarki i wrócić do swojego urządzenia.",
    oauth2DeviceVerificationFailedHeader: "Logowanie urządzenia nie powiodło się",
    oauth2DeviceVerificationFailedMessage:
        "Możesz zamknąć to okno przeglądarki i wrócić do swojego urządzenia i spróbować ponownie się zalogować.",
    oauth2DeviceConsentDeniedMessage: "Odmowa zgody na połączenie urządzenia.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Klient nie ma uprawnień do inicjowania udzielenia autoryzacji urządzenia OAuth 2.0. Przepływ jest wyłączony dla klienta.",
    ...
    emailVerifyInstruction4:
        "Aby zweryfikować swój adres e-mail, wyślemy Ci wiadomość e-mail z instrukcjami na adres {0}.",
    ...
    emailInstructionUsername:
        "Wprowadź swoją nazwę użytkownika, a wyślemy Ci instrukcje dotyczące tworzenia nowego hasła.",
    ...
    federatedIdentityUnavailableMessage:
        "Użytkownik {0} uwierzytelniony u dostawcy tożsamości {1} nie istnieje. Skontaktuj się z administratorem.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Token ID wydany przez dostawcę tożsamości nie pasuje do skonfigurowanego kluczowego roszczenia. Skontaktuj się z administratorem.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Próbujesz połączyć swoje konto {0} z kontem {1} {2}. Ale Twoje konto jest już połączone z innym kontem {3} {4}. Czy potwierdzasz, że chcesz zastąpić istniejące połączenie nowym kontem?",
    ...
    invalidPasswordNotContainsUsernameMessage:
        "Nieprawidłowe hasło: nie może zawierać nazwy użytkownika.",
    ...
    cookieNotFoundMessage:
        "Nie znaleziono pliku cookie do ponownego logowania. Mógł on wygasnąć, zostać usunięty lub masz wyłączone pliki cookie w przeglądarce. Jeśli pliki cookie są wyłączone, włącz je. Kliknij 'Powrót do aplikacji', aby zalogować się ponownie",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Brak kodu lub parametru błędu w odpowiedzi od dostawcy tożsamości.",
    ...
    credentialSetupRequired:
        "Nie można się zalogować, wymagana jest konfiguracja danych uwierzytelniających.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript jest wyłączony. Zdecydowanie zalecamy jej włączenie. Kliknij przycisk poniżej, aby kontynuować.",
    ...
    "auth-username-password-form-help-text":
        "Zaloguj się, wprowadzając swoją nazwę użytkownika i hasło.",
    ...
    "recovery-authn-codes-display-name": "Kod uwierzytelniający odzyskiwanie",
    "recovery-authn-codes-help-text":
        "Wpisz kod uwierzytelniający odzyskiwanie z poprzednio wygenerowanej listy.",
    ...
    "recovery-code-config-warning-title":
        "Te kody odzyskiwania nie pojawią się ponownie po opuszczeniu tej strony",
    "recovery-code-config-warning-message":
        "Należy je wydrukować, pobrać lub skopiować do menedżera haseł i trzymać je w bezpiecznym miejscu. Anulowanie tej konfiguracji spowoduje usunięcie kodów odzyskiwania z konta.",
    ...
    "recovery-codes-download-file-description":
        "Kody odzyskiwania to jednorazowe kody dostępu, które umożliwiają zalogowanie się na konto, jeśli nie masz dostępu do narzędzia uwierzytelniającego.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn nie jest obsługiwany przez tę przeglądarkę. Wypróbuj inną lub skontaktuj się z administratorem.",
    ...
    "webauthn-error-different-user":
        "Pierwszy uwierzytelniony użytkownik nie jest tym który został uwierzytelniony przez Passkey",
    ...
    "passkey-unsupported-browser-text":
        "Passkey nie jest obsługiwany przez tę przeglądarkę. Wypróbuj inną lub skontaktuj się z administratorem.",
    ...
    finalDeletionConfirmation:
        "Jeśli usuniesz swoje konto, nie będzie można go przywrócić. Aby zachować swoje konto, kliknij Anuluj.",
    ...
    "error-invalid-multivalued-size":
        "Atrybut {0} musi mieć co najmniej {1} i najwyżej {2} {2,choice,0#wartości|1#wartość|1<wartości}.",
    "organization.confirm-membership.title": "Zaraz dołączysz do organizacji ${kc.org.name}",
    "organization.confirm-membership":
        "Klikając na poniższy link, zostaniesz członkiem organizacji {0}:",
