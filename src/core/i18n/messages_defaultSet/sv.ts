...
const messages = {
    ...
    deletingAccountForbidden:
        "Du har inte tillräcklig behörighet för att ta bort ditt eget konto, kontakta administratör.",
    ...
    oauthGrantInformation:
        "Försäkra dig om att du kan lita på {0} genom att lära dig hur {0} kommer att hantera dina uppgifter.",
    ...
    emailUpdateConfirmationSent:
        "Ett verifieringsmail har skickats till {0}. Följ instruktionerna i meddelandet för att verifiera uppdateringen av din e-postadress.",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Koden är utgången. Vänligen gå tillbaks till din enhet och försök ansluta igen.",
    oauth2DeviceVerificationCompleteHeader: "Enhetsinloggning lyckad",
    oauth2DeviceVerificationCompleteMessage:
        "Du kan nu stänga det här webbläsarfönstret och gå tillbaka till din enhet.",
    oauth2DeviceVerificationFailedHeader: "Enhetsinloggning misslyckad",
    oauth2DeviceVerificationFailedMessage:
        "Du kan nu stänga det här webbläsarfönstret, gå tillbaka till din enhet och försöka ansluta igen.",
    oauth2DeviceConsentDeniedMessage: "Samtycke att ansluta till enheten nekades.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Klienten har inte tillstånd att initiera OAuth 2.0 Device Authorization Grant. Detta flöde är ej tillgängligt för klienten.",
    ...
    emailVerifyInstruction4:
        "För att verifiera din e-postadress kommer vi att skicka ett meddelande med instruktioner till adressen {0}.",
    ...
    emailInstructionUsername:
        "Fyll i ditt användarnamn, så kommer vi att skicka instruktioner för hur du skapar ett nytt lösenord.",
    ...
    federatedIdentityUnavailableMessage:
        "Användare {0} autentiserad med identitetsleverantör {1} hittades inte. Vänligen kontakta din administratör.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        'ID token utfärdad av identitetsleverantör matchar inte konfigurerad nödvändig "claim". Vänligen kontakta din administratör.',
    ...
    federatedIdentityConfirmOverrideMessage:
        "Du försöker länka till konto {0} med {1}-kontot {2} men ditt konto är redan länkat med ett annat {3}-konto {4}. Vill du ersätta den befintliga länken med det nya kontot?",
    ...
    delegationCompleteMessage:
        "Du kan nu stänga detta webbläsarfönster och gå tillbaka till din konsol-applikation.",
    delegationFailedHeader: "Inloggning misslyckad",
    delegationFailedMessage:
        "Du kan nu stänga detta webbläsarfönster och gå tillbaka till din konsol-applikation och försöka logga in på nytt.",
    ...
    cookieNotFoundMessage:
        "Cookie för att börja om inloggningen hittades inte. Den kan vara utgången, borttagen eller så är cookies avslaget i din webbläsare. Om stöd för cookies är avslaget så slå på detta. Klicka Tillbaka till applikationen för att logga in igen.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Saknad code eller error parameter i svar från identitetsleverantör.",
    ...
    identityProviderAlreadyLinkedMessage:
        "Federerad identitet returnerad från {0} är redan länkad till en annan användare.",
    confirmAccountLinking:
        "Bekräfta länkning av kontot {0} från identitetsleverantör {1} med ditt konto.",
    confirmAccountLinkingBody:
        "Om du länkar ditt konto kommer du också kunna logga in genom att använda konto {0} från identitetsleverantör {1}. Fortsätt inte om du inte själv initierade denna process eller om du inte längre vill länka kontot.",
    ...
    differentUserAuthenticated:
        "Du är redan autentiserad som en annan användare '{0}' i den här sessionen. Vänligen logga ut först.",
    brokerLinkingSessionExpired:
        "Kontolänkning efterfrågades, men den nuvarande sessionen är inte längre giltig.",
    ...
    "console-verify-email":
        "Du måste bekräfta din e-postadress. Vi har skickat ett meddelande till {0} som innehåller en verifieringskod. Vänligen skriv in koden i fältet nedan.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript är avstängt. Vi rekommenderar starkt att slå på det. Klicka på knappen nedan för att fortsätta.",
    ...
    "auth-username-password-form-help-text":
        "Logga in genom att fylla i ditt användarnamn och lösenord.",
    ...
    "recovery-code-config-warning-title":
        "Dessa återställningskoder kommer inte att visas igen efter att du lämnat denna sida",
    "recovery-code-config-warning-message":
        "Skriv ut, ladda ner eller kopiera dem till en lösenordshanterare och förvara dem säkert. Om du avbryter den här konfigurationen kommer återställningskoderna att tas bort från ditt konto.",
    ...
    "recovery-codes-download-file-description":
        "Återställningskoder är engångskoder som låter dig logga in på ditt konto om du inte har tillgång till din autentiseringsapplikation.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn stöds inte av denna webbläsare. Försök med en annan eller kontakta din administratör.",
    ...
    "webauthn-error-different-user":
        "Den först autentiserade användaren är inte samma som är autentiserad via Passkey.",
    ...
    "passkey-unsupported-browser-text":
        "Passkey stöds inte av denna webbläsare. Försök med en annan eller kontakta din administratör.",
    ...
    finalDeletionConfirmation:
        "Om du tar bort ditt konto kan det inte återställas. För att behålla ditt konto, klicka Avbryt.",
    ...
    "error-invalid-multivalued-size":
        "Attribut {0} måste ha minst {1} och som mest {2} {2,choice,0#values|1#value|1<values}.",
    "organization.confirm-membership.title":
        "Du är på väg att ansluta till organisationen ${kc.org.name}",
    "organization.confirm-membership":
        "Genom att klicka på länken nedan kommer du att bli medlem i organisationen {0}:",
    "organization.member.register.title":
        "Skapa ett konto för att ansluta till organisationen ${kc.org.name}",
