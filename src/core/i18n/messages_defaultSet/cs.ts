...
const messages = {
    ...
    authenticateStrong: "Pro pokračování je potřeba silné přihlášení",
    ...
    loginTotpStep1: "Nainstalujte si do mobilu jednu z následujících aplikací:",
    ...
    emailVerifyInstruction1: "Byl Vám zaslán e-mail s pokyny k ověření vaší e-mailové adresy na {0}.",
    ...
    emailVerifyInstruction4:
        "Pro ověření Vaší e-mailové adresy Vám pošleme email s instrukcemi na adresu {0}.",
    emailVerifyResend: "Znovu poslat ověřovací e-mail",
    emailVerifySend: "Poslat ověřovací e-mail",
    emailLinkIdpTitle: "Propojit {0}",
    ...
    expiredActionTokenSessionExistsMessage: "Akce vypršela. Začněte prosím znovu.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Snažíte se propojit Váš {0} účet s {1} účtem {2}. Ale Váš účet už je propojený s jiným {3} účtem {4}. Potvrďte, jestli chcete nahradit existující propojení s novým účtem?",
    federatedIdentityConfirmReauthenticateMessage: "Ověřte se a propojte svůj účet s {0}",
    ...
    staleEmailVerificationLink:
        "Odkaz, na který jste klikli, je již neplatný. Je možné, že jste svůj e-mail už ověřili?",
    ...
    "auth-x509-client-username-form-help-text": "Přihlásit se pomocí klientského X509 certifikátu.",
    "recovery-authn-codes-display-name": "Kód pro obnovu přístupu",
    "recovery-authn-codes-help-text": "Zadejte kód pro obnovu přístupu z dříve vygenerovaného seznamu.",
    ...
    "webauthn-registration-init-label": "Přístupový klíč (Výchozí Popisek)",
    "webauthn-registration-init-label-prompt":
        "Zadejte prosím popisek svého registrovaného přístupového klíče",
    ...
    "passkey-login-title": "Přihlášení přístupovým klíčem",
    "passkey-available-authenticators": "Dostupné přístupové klíče",
    "passkey-unsupported-browser-text":
        "Přístupový klíč není v tomto prohlížeči podporován. Zkuste jiný nebo kontaktujte svého administrátora.",
    "passkey-doAuthenticate": "Přihlásit se pomocí přístupového klíče",
    "passkey-createdAt-label": "Vytvořeno",
    "passkey-autofill-select": "Vyberte svůj přístupový klíč",
    ...
    "error-invalid-multivalued-size":
        "Atribut {0} musí mít nejméně {1} a nejvíce {2} {2,choice,0#hodnot|1#hodnotu|1<hodnoty|4<hodnot}.",
    ...
    codeSuccess: "Kód úspěchu",
    linkIdpActionTitle: "Propojení {0}",
    linkIdpActionMessage: "Chcete propojit svůj účet s {0}?",
    emailVerifySendCooldown: "Před opětovným odesláním ověřovacího e-mailu musíte počkat {0} sekund.",
    "client_security-admin-console": "Konzole správce zabezpečení",
    ...
    emailVerifiedMessageHeader: "E-mailová adresa ověřena",
    emailVerifiedAlreadyMessageHeader: "E-mailová adresa ověřena",
    emailVerificationCancelled: "Toto ověření e-mailu bylo zrušeno správcem.",
    confirmAccountLinkingBody:
        "Pokud si propojíte účet, budete se také moci přihlásit pomocí účtu {0} poskytovatele identity {1}. Nepokračujte, pokud jste tento proces nezahájili nebo pokud nechcete účet propojit.",
    confirmEmailAddressVerificationHeader: "Ověření e-mailové adresy",
    "requiredAction.delete_account": "Smazat účet",
    "requiredAction.UPDATE_EMAIL": "Aktualizovat e-mail",
    "requiredAction.webauthn-register-passwordless": "Registrace bez-heslového přihlášení (WebAuthn)",
    "requiredAction.VERIFY_PROFILE": "Ověřit účet",
    "requiredAction.delete_credential": "Smazat přihlašovací údaj",
    "requiredAction.idp_link": "Propojení poskytovatele identit",
    "requiredAction.update_user_locale": "Aktualizovat nastavení lokalizace",
    "code-clipboard-label": "Zobrazit obsah",
    "code-copy-label": "Kopírovat do schránky",
    "code-copy-success": "Kód zkopírován do schránky",
    "code-copy-failure": "Kopírování kódu do schránky se nezdařilo",
    emailVerificationPending:
        "Na adresu {0} byl odeslán ověřovací e-mail. Můžete odeslat bez změn a ověřovací e-mail bude odeslán znovu, nebo můžete zadat jinou e-mailovou adresu.",
    orgMemberAlready: "Již jste členem organizace {1}.",
    staleInviteOrgLink:
        "Odkaz, na který jste klikli, již není platný. Možná vypršela jeho platnost nebo již byl použit.",
