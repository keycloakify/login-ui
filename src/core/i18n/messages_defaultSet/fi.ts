...
const messages = {
    ...
    "deletingAccountForbidden":
        "Sinulla ei ole riittäviä oikeuksia poistaakseesi omaa tiliä, ota yhteyttä järjestelmänvalvojaan.",
    ...
    "loginTotpIntro":
        "Sinun täytyy asentaa OTP (One Time Password) luontityökalu päästäksesi tälle tilille",
    "loginTotpStep1": "Asenna yksi seuraavista sovelluksista puhelimeesi:",
    "loginTotpStep2": "Avaa sovellus ja skannaa viivakoodi",
    "loginTotpStep3":
        "Liitä sovelluksesta saatu kertaluontoinen koodi ja paina Lähetä viimeistelläksesi asennuksen",
    ...
    "oauth2DeviceExpiredUserCodeMessage":
        "Koodi on vanhentunut. Ole hyvä ja mene takaisin laitteellesi ja yritä yhdistämistä uudellleen.",
    "oauth2DeviceVerificationCompleteHeader": "Laitekirjautuminen onnistui",
    "oauth2DeviceVerificationCompleteMessage":
        "Voit sulkea tämän ikkunan ja mennä takaisin laitteellesi.",
    "oauth2DeviceVerificationFailedHeader": "Laitekirjautuminen epäonnistui",
    "oauth2DeviceVerificationFailedMessage":
        "Voit sulkea tämän ikkunan, mennä takaisin laitteellesi ja yrittää kirjautumista uudelleen.",
    ...
    "emailVerifyInstruction1":
        "Sähköpostin vahvistamisohjeet sisältävä viesti on lähetetty sähköpostiisi.",
    ...
    "emailInstructionUsername":
        "Syötä käyttäjänimesi niin lähetämme sinulle ohjeet uuden salasanan luomiseksi.",
    ...
    "federatedIdentityExistsMessage":
        "Käyttäjä {0} {1} on jo olemassa. Kirjaudu tilihallintaan linkittääksesi tilin.",
    ...
    "federatedIdentityConfirmLinkMessage":
        "Käyttäjätunnus, jolla {0} on {1} on jo olemassa. Kuinka haluat jatkaa?",
    ...
    "linkIdpMessage":
        "Sinun tulee vahvistaa sähköpostiosoitteesi linkittääksesi tilin palvelun {0} kanssa.",
    ...
    "delegationFailedMessage":
        "Voit sulkea tämän selaimen, siirtyä takaisin konsolisovellukseen ja yrittää kirjautumista uudelleen.",
    ...
    "invalidPasswordMinDigitsMessage":
        "Virheellinen salasana: salasanassa tulee olla vähintään {0} numeroa.",
    "invalidPasswordMinLowerCaseCharsMessage":
        "Virheellinen salasana: salasanassa tulee olla vähintään {0} pientä kirjainta.",
    "invalidPasswordMinUpperCaseCharsMessage":
        "Virheellinen salasana: salasanassa tulee olla vähintään {0} isoa kirjainta.",
    "invalidPasswordMinSpecialCharsMessage":
        "Virheellinen salasana: salasanassa tulee olla vähintään {0} erikoismerkkiä.",
    "invalidPasswordNotUsernameMessage":
        "Virheellinen salasana: salasana ei saa olla sama kuin käyttäjätunnus.",
    ...
    "invalidPasswordHistoryMessage":
        "Virheellinen salasana: salasana ei saa olla sama kuin {0} edellistä salasanaasi.",
    "invalidPasswordGenericMessage":
        "Virheellinen salasana: uusi salasana ei täytä salasanavaatimuksia.",
    ...
    "couldNotProceedWithAuthenticationRequestMessage":
        "Tunnistuspyyntöä henkilöllisyyden tarjoajalle ei voitu jatkaa.",
    "couldNotObtainTokenMessage": "Ei voitu saada tokenia henkilöllisyyden tarjoajalta.",
    "unexpectedErrorRetrievingTokenMessage":
        "Odottamaton virhe hankkiessa tokenia henkilöllisyyden tarjoajalta.",
    "unexpectedErrorHandlingResponseMessage":
        "Odottamaton virhe käsiteltäessä vastausta henkilöllisyyden tarjoajalta.",
    "identityProviderAuthenticationFailedMessage":
        "Tunnistautuminen epäonnistui. Ei voitu tunnistautua henkilöllisyyden tarjoajan kautta.",
    ...
    "couldNotSendAuthenticationRequestMessage":
        "Ei voitu lähettää tunnistautumispyyntö henkilöllisyyden tarjoajalle.",
    "unexpectedErrorHandlingRequestMessage":
        "Odottamaton virhe käsiteltäessä tunnistautumispyyntö henkilöllisyyden tarjoajalle.",
    ...
    "identityProviderUnexpectedErrorMessage":
        "Tunnistautumisen yhteydessä tapahtui virhe tunnistetietojen tarjoajan kanssa.",
    "identityProviderNotFoundMessage": "Tunnisteella ei löytynyt henkilöllisyyden tarjoajaa.",
    "identityProviderLinkSuccess":
        "Sähköpostin vahvistus onnistui Ole hyvä ja palaa alkuperäiseen selainikkunaan jatkaaksesi kirjautumista.",
    "staleCodeMessage":
    ...
    "staleEmailVerificationLink":
        "Klikkaamasi linkki on vanhentunut eikä enää toimi. Oletko jo vahvistanut sähköpostisi?",
    "identityProviderAlreadyLinkedMessage":
        "Yhdistetty henkilöllisyys, minkä {0} palautti, on jo linkitetty toiseen käyttäjään.",
    ...
    "finalDeletionConfirmation":
        "Jos poistat tilisi, sitä ei voida enää palauttaa. Säilyttääksesi tilisi, paina Peruuta.",
    ...
    "accountUnusable":
        "Tämän sovelluksen käyttö ei myöhemmin enää ole mahdollista tällä käyttäjätilillä",
