...
const messages = {
    ...
    deletingAccountForbidden:
        "Nimate dovolj pravic za izbris svojega računa, kontaktirajte administratorja.",
    kerberosNotConfigured: "Kerberos ni konfiguriran",
    kerberosNotConfiguredTitle: "Kerberos ni konfiguriran",
    bypassKerberosDetail:
        "Ali niste prijavljeni preko Kerberosa ali pa vaš brskalnik ni nastavljen za prijavo preko Kerberosa. Prosimo, kliknite nadaljuj za prijavo na drug način",
    ...
    oauthGrantInformation:
        "Prepričajte se, da zaupate {0}, tako da izveste, kako bo {0} ravnal z vašimi podatki.",
    ...
    emailUpdateConfirmationSent:
        "Potrditveno sporočilo je bilo poslano na {0}. Za dokončanje posodobitve e-poštnega naslova morate slediti navodilom v sporočilu.",
    ...
    loginTotpStep3:
        "Vnesite enkratno kodo, ki jo je ustvarila aplikacija, in kliknite Potrdi za dokončanje nastavitve.",
    ...
    loginTotpManualStep3:
        "Če aplikacija omogoča nastavitev, uporabite naslednje konfiguracijske vrednosti:",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Koda je potekla. Prosimo, vrnite se na svojo napravo in poskusite ponovno vzpostaviti povezavo.",
    oauth2DeviceVerificationCompleteHeader: "Prijava naprave uspešna",
    oauth2DeviceVerificationCompleteMessage:
        "Lahko zaprete to okno brskalnika in se vrnete na svojo napravo.",
    oauth2DeviceVerificationFailedHeader: "Prijava naprave ni uspela",
    oauth2DeviceVerificationFailedMessage:
        "Lahko zaprete to okno brskalnika, se vrnete na svojo napravo in poskusite ponovno vzpostaviti povezavo.",
    oauth2DeviceConsentDeniedMessage: "Soglasje za povezavo naprave je zavrnjeno.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Odjemalcu ni dovoljeno začeti OAuth 2.0 pooblastila za napravo. Ta funkcija je onemogočena za odjemalca.",
    emailVerifyInstruction1:
        "E-pošta z navodili za potrditev vašega e-poštnega naslova je bila poslana na naslov {0}.",
    ...
    emailLinkIdp1:
        "E-pošta z navodili za povezavo računa {0} {1} z vašim računom {2} vam je bila poslana.",
    ...
    emailInstruction:
        "Vnesite svoje uporabniško ime ali e-poštni naslov in poslali vam bomo navodila za ustvarjanje novega gesla.",
    emailInstructionUsername:
        "Vnesite svoje uporabniško ime in poslali vam bomo navodila za ustvarjanje novega gesla.",
    ...
    federatedIdentityExistsMessage:
        "Uporabnik s {0} {1} že obstaja. Prosimo, prijavite se v upravitelja računa za povezavo računa.",
    federatedIdentityUnavailableMessage:
        "Uporabnik {0}, avtenticiran s ponudnikom identitete {1}, ne obstaja. Prosimo, kontaktirajte administratorja.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "ID žeton, ki ga je izdal ponudnik identitete, se ne ujema z bistvenim konfiguriranim zahtevkom. Prosimo, obrnite se na administratorja.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Poskušate povezati svoj račun {0} z računom {1} {2}. Vendar je vaš račun že povezan z drugim računom {3} {4}. Ali želite zamenjati obstoječo povezavo z novim računom?",
    ...
    delegationFailedMessage:
        "To okno brskalnika lahko zaprete in se vrnete v aplikacijo konzole ter poskusite znova.",
    ...
    standardFlowDisabledMessage:
        "Odjemalcu ni dovoljeno sprožiti prijave v brskalniku z danim odzivnim tipom. Standardni tok je onemogočen za odjemalca.",
    implicitFlowDisabledMessage:
        "Odjemalcu ni dovoljeno sprožiti prijave v brskalniku z danim odzivnim tipom. Implicitni tok je onemogočen za odjemalca.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Ni bilo mogoče nadaljevati z zahtevo za avtentikacijo do ponudnika identitete.",
    couldNotObtainTokenMessage: "Ni bilo mogoče pridobiti žetona od ponudnika identitete.",
    unexpectedErrorRetrievingTokenMessage:
        "Nepričakovana napaka pri pridobivanju žetona od ponudnika identitete.",
    unexpectedErrorHandlingResponseMessage:
        "Nepričakovana napaka pri obdelavi odziva od ponudnika identitete.",
    identityProviderAuthenticationFailedMessage:
        "Avtentikacija ni uspela. Ni bilo mogoče avtenticirati s ponudnikom identitete.",
    couldNotSendAuthenticationRequestMessage:
        "Ni bilo mogoče poslati zahteve za avtentikacijo do ponudnika identitete.",
    unexpectedErrorHandlingRequestMessage:
        "Nepričakovana napaka pri obdelavi zahteve za avtentikacijo do ponudnika identitete.",
    ...
    cookieNotFoundMessage:
        "Piškotek ni bil najden. Prepričajte se, da imate v brskalniku omogočene piškotke.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Manjkajoč parameter code ali error v odzivu od ponudnika identitete.",
    ...
    identityProviderLinkSuccess:
        "Uspešno ste potrdili svoj e-poštni naslov. Prosimo, vrnite se v svoj izvirni brskalnik in nadaljujte s prijavo.",
    staleCodeMessage:
        "Ta stran ni več veljavna, prosimo, vrnite se v vašo aplikacijo in se prijavite ponovno",
    ...
    identityProviderNotUniqueMessage:
        "Področje podpira več ponudnikov identitete. Ni bilo mogoče določiti, s katerim ponudnikom identitete bi se morala izvesti avtentikacija.",
    ...
    staleEmailVerificationLink:
        "Povezava, ki ste jo kliknili, je zastarela in ni več veljavna. Morda ste že potrdili svoj e-poštni naslov?",
    identityProviderAlreadyLinkedMessage:
        "Federirana identiteta, ki jo je vrnil {0}, je že povezana z drugim uporabnikom.",
    ...
    differentUserAuthenticated:
        "V tej seji ste že avtenticirani kot drug uporabnik '{0}'. Prosimo, najprej se odjavite.",
    brokerLinkingSessionExpired:
        "Zahtevana je povezava posredniškega računa, vendar trenutna seja ni več veljavna.",
    ...
    "console-verify-email":
        "Potrditi morate svoj e-poštni naslov. Poslali smo e-pošto na naslov {0}, ki vsebuje potrditveno kodo. Prosimo, vnesite to kodo v spodnje polje.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript je onemogočen. Močno priporočamo, da ga omogočite. Kliknite spodnji gumb za nadaljevanje.",
    ...
    "recovery-authn-codes-help-text":
        "Vnesite obnovitveno avtentikacijsko kodo iz poprej ustvarjenega seznama.",
    ...
    "recovery-code-config-warning-title":
        "Te obnovitvene kode ne bodo več prikazane po zapustitvi te strani",
    "recovery-code-config-warning-message":
        "Poskrbite, da jih natisnete, prenesete ali kopirate v upravitelja gesel in jih varno shranite. Preklic te nastavitve bo odstranil te obnovitvene kode iz vašega računa.",
    ...
    "recovery-codes-download-file-description":
        "Obnovitvene kode so enkratna gesla, ki vam omogočajo prijavo v vaš račun, če nimate dostopa do svojega avtentikatorja.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn ni podprt v tem brskalniku. Poskusite z drugim ali se obrnite na administratorja.",
    ...
    "webauthn-registration-init-label-prompt":
        "Prosimo, vnesite oznako za vaš registriran ključ za dostop",
    ...
    "webauthn-error-different-user":
        "Prvi avtenticirani uporabnik ni enak uporabniku, avtenticiranemu s ključem za dostop.",
    ...
    "passkey-unsupported-browser-text":
        "Ključ za dostop ni podprt v tem brskalniku. Poskusite z drugim ali se obrnite na administratorja.",
    ...
    finalDeletionConfirmation:
        "Če izbrišete vaš račun, ga ne boste mogli obnoviti. Če želite obdržati vaš račun, pritisnite Prekliči.",
    ...
    "organization.confirm-membership":
        "S klikom na spodnjo povezavo boste postali član organizacije {0}:",
    ...
    codeSuccess: "Koda uspešna",
    linkIdpActionMessage: "Ali želite povezati svoj račun z {0}?",
    emailVerifyInstruction4:
        "Za potrditev vašega e-poštnega naslova vam bomo poslali potrditveno e-pošto na naslov {0}.",
    emailVerifyResend: "Ponovno pošlji potrditveno e-pošto",
    emailVerifySend: "Pošlji potrditveno e-pošto",
    emailVerifySendCooldown:
        "Pred ponovnim pošiljanjem potrditvenega e-sporočila morate počakati {0} sekund.",
    "error-non-ascii-local-part-email": "Lokalni del naslova mora vsebovati samo ASCII znake.",
    emailVerifiedMessageHeader: "Preverjen e-poštni naslov",
    confirmAccountLinkingBody:
        "Če povežete račun, se boste lahko prijavili tudi z računom {0} ponudnika identitete {1}. Ne nadaljujte, če niste začeli tega postopka ali če ne želite povezati računa.",
    confirmEmailAddressVerificationHeader: "Preverjanje veljavnosti e-poštnega naslova",
    "requiredAction.delete_account": "Izbriši račun",
    "requiredAction.UPDATE_EMAIL": "Posodobi e-poštni naslov",
    "requiredAction.idp_link": "Povezovanje ponudnika identitete",
    "code-copy-label": "Kopiraj v odložišče",
    "code-copy-success": "Koda kopirana v odložišče",
    "code-copy-failure": "Koda ni bila uspešno kopirana v odložišče",
    emailVerificationPending:
        "Potrditveno e-poštno sporočilo je bilo poslano na {0}. Lahko ga brez sprememb ponovno pošljete, da ponovno prejmete potrditveno e-poštno sporočilo, ali vnesete drug e-poštni naslov.",
