...
const messages = {
    ...
    "auth-recovery-authn-code-form-help-text":
        "Vnesite obnovitveno avtentikacijsko kodo iz predhodno ustvarjenega seznama.",
    ...
    "webauthn-error-auth-verification":
        "Rezultat avtentikacije s ključem za dostop ni veljaven.<br /> {0}",
    "webauthn-error-register-verification":
        "Rezultat registracije ključa za dostop ni veljaven.<br /> {0}",
