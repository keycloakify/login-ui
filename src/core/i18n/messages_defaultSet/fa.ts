...
const messages = {
    ...
    doAccept: "پذیرفتن",
    doDecline: "رد کردن",
    doForgotPassword: "گذرواژه خود را فراموش کرده اید؟",
    ...
    bypassKerberosDetail:
        "یا توسط Kerberos وارد نشده اید یا مرورگر شما برای ورود به Kerberos تنظیم نشده است. لطفاً روی ادامه کلیک کنید تا از راه های دیگر وارد شوید",
    ...
    oauthGrantInformation:
        "با یادگیری نحوه مدیریت {0} با داده های شما، مطمئن شوید که به {0} اعتماد دارید.",
    ...
    emailForgotTitle: "گذرواژه خود را فراموش کرده اید؟",
    updateEmailTitle: "ایمیل را به روز کنید",
    emailUpdateConfirmationSentTitle: "ایمیل تأیید فرستاده شد",
    emailUpdateConfirmationSent:
        "یک ایمیل تأیید به {0} ارسال شده است. برای تکمیل به‌روزرسانی ایمیل، باید دستورالعمل‌های قبلی را دنبال کنید.",
    emailUpdatedTitle: "ایمیل به روز شد",
    emailUpdated: "ایمیل حساب با موفقیت به {0} به روز شد.",
    updatePasswordTitle: "گذرواژه را به روز کنید",
    ...
    email: "ایمیل",
    password: "گذرواژه",
    passwordConfirm: "تأیید گذرواژه",
    passwordNew: "گذرواژه جدید",
    passwordNewConfirm: "تأیید گذرواژه جدید",
    ...
    postal_code: "کد پستی",
    country: "کشور",
    emailVerified: "ایمیل تأیید شده است",
    website: "صفحه وب",
    phoneNumber: "شماره تلفن",
    phoneNumberVerified: "شماره تلفن تأیید شد",
    gender: "جنسیت",
    birthday: "تاریخ تولد",
    ...
    loginTotpStep3:
        "کد یکبار مصرف ارائه شده توسط برنامه را وارد کنید و برای تکمیل تنظیمات روی ارسال کلیک کنید.",
    ...
    oauth2DeviceInvalidUserCodeMessage: ".کد نامعتبر است، لطفاً دوباره امتحان کنید",
    oauth2DeviceExpiredUserCodeMessage:
        "کد منقضی شده است. لطفاً به دستگاه خود برگردید و دوباره سعی کنید وصل شوید.",
    oauth2DeviceVerificationCompleteHeader: "ورود دستگاه با موفقیت انجام شد",
    oauth2DeviceVerificationCompleteMessage:
        "می توانید این پنجره مرورگر را ببندید و به دستگاه خود بازگردید.",
    oauth2DeviceVerificationFailedHeader: "ورود دستگاه ناموفق بود",
    oauth2DeviceVerificationFailedMessage:
        "می توانید این پنجره مرورگر را ببندید و به دستگاه خود بازگردید و دوباره سعی کنید وصل شوید.",
    oauth2DeviceConsentDeniedMessage: "رضایت برای اتصال دستگاه رد شد.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "مشتری مجاز به شروع OAuth 2.0 Device Authorization Grant نیست. جریان برای مشتری غیرفعال است.",
    emailVerifyInstruction1:
        "یک ایمیل حاوی دستورالعمل هایی برای تأیید آدرس ایمیل شما به آدرس شما {0} ارسال شده است.",
    ...
    emailInstruction:
        "نام کاربری یا آدرس ایمیل خود را وارد کنید و ما دستورالعمل هایی در مورد نحوه ایجاد گذرواژه جدید برای شما ارسال خواهیم کرد.",
    emailInstructionUsername:
        "نام کاربری خود را وارد کنید و ما دستورالعمل هایی در مورد نحوه ایجاد گذرواژه جدید برای شما ارسال خواهیم کرد.",
    copyCodeInstruction: "لطفاً این کد را کپی کرده و در برنامه خود قرار دهید:",
    ...
    invalidUserMessage: "نام کاربری یا گذرواژه نامعتبر است.",
    invalidUsernameMessage: "نام کاربری نامعتبر است.",
    invalidUsernameOrEmailMessage: "نام کاربری یا ایمیل نامعتبر است.",
    invalidPasswordMessage: "گذرواژه نامعتبر است.",
    invalidEmailMessage: "آدرس ایمیل نامعتبر است.",
    accountDisabledMessage: "حساب غیرفعال است، با سرپرست خود تماس بگیرید.",
    accountTemporarilyDisabledMessage: "نام کاربری یا گذرواژه نامعتبر است.",
    accountPermanentlyDisabledMessage: "نام کاربری یا گذرواژه نامعتبر است.",
    ...
    expiredActionMessage: "اقدام منقضی شده است. لطفاً همین الان با ورود به سیستم ادامه دهید.",
    expiredActionTokenNoSessionMessage: "اقدام منقضی شده است.",
    expiredActionTokenSessionExistsMessage: "اقدام منقضی شده است. لطفاً دوباره شروع کنید.",
    sessionLimitExceeded: "تعداد جلسات بسیار زیاد است",
    missingFirstNameMessage: "لطفاً نام را مشخص کنید.",
    missingLastNameMessage: "لطفاً نام خانوادگی را مشخص کنید.",
    missingEmailMessage: "لطفاً ایمیل را مشخص کنید.",
    missingUsernameMessage: "لطفاً نام کاربری را مشخص کنید.",
    missingPasswordMessage: "لطفاً گذرواژه را مشخص کنید.",
    missingTotpMessage: "لطفاً کد احراز هویت را مشخص کنید.",
    missingTotpDeviceNameMessage: "لطفاً نام دستگاه را مشخص کنید.",
    notMatchPasswordMessage: "گذرواژه ها مطابقت ندارند.",
    "error-invalid-value": "مقدار نامعتبر است.",
    "error-invalid-blank": "لطفاً مقدار را مشخص کنید.",
    "error-empty": "لطفاً مقدار را مشخص کنید.",
    ...
    "error-user-attribute-required": "لطفاً این فیلد را مشخص کنید.",
    ...
    invalidPasswordExistingMessage: "گذرواژه موجود نامعتبر است.",
    invalidPasswordBlacklistedMessage: "گذرواژه نامعتبر: گذرواژه در لیست سیاه قرار گرفته است.",
    invalidPasswordConfirmMessage: "تأیید گذرواژه مطابقت ندارد.",
    ...
    federatedIdentityExistsMessage:
        "کاربر با {0} {1} از قبل وجود دارد. لطفاً برای پیوند دادن حساب به مدیریت حساب وارد شوید.",
    federatedIdentityUnavailableMessage:
        "کاربر {0} احراز هویت شده با ارائه دهنده هویت {1} وجود ندارد. لطفاً با ادمین خود تماس بگیرید.",
    confirmLinkIdpTitle: "حساب از قبل وجود دارد",
    federatedIdentityConfirmLinkMessage:
        "کاربر با {0} {1} از قبل وجود دارد. چگونه می خواهید ادامه دهید؟",
    ...
    updatePasswordMessage: "برای فعال کردن حساب خود باید گذرواژه خود را تغییر دهید.",
    updateEmailMessage: "برای فعال کردن حساب خود باید آدرس ایمیل خود را به روز کنید.",
    resetPasswordMessage: "شما باید گذرواژه خود را تغییر دهید.",
    ...
    accountPasswordUpdatedMessage: "گذرواژه شما به روز شده است.",
    ...
    delegationFailedMessage:
        "می توانید این پنجره مرورگر را ببندید و به برنامه کنسول خود برگردید و دوباره سعی کنید وارد شوید.",
    noAccessMessage: "بدون دسترسی",
    invalidPasswordMinLengthMessage: "گذرواژه نامعتبر: حداقل طول {0}.",
    invalidPasswordMaxLengthMessage: "گذرواژه نامعتبر: حداکثر طول {0}.",
    invalidPasswordMinDigitsMessage: "گذرواژه نامعتبر: باید حداقل دارای {0} رقم عددی باشد.",
    invalidPasswordMinLowerCaseCharsMessage: "گذرواژه نامعتبر: باید حداقل دارای {0} نویسه کوچک باشد.",
    invalidPasswordMinUpperCaseCharsMessage: "گذرواژه نامعتبر: باید حداقل دارای {0} نویسه بزرگ باشد.",
    invalidPasswordMinSpecialCharsMessage: "گذرواژه نامعتبر: باید حداقل دارای {0} کاراکتر خاص باشد.",
    invalidPasswordNotUsernameMessage: "گذرواژه نامعتبر: نباید برابر با نام کاربری باشد.",
    invalidPasswordNotEmailMessage: "گذرواژه نامعتبر: نباید برابر با ایمیل باشد.",
    invalidPasswordRegexPatternMessage: "گذرواژه نامعتبر: با الگو(های) regex مطابقت ندارد.",
    invalidPasswordHistoryMessage:
        "گذرواژه نامعتبر: نباید با هیچ یک از رمزهای عبور اخیر {0} برابر باشد.",
    invalidPasswordGenericMessage: "گذرواژه نامعتبر: گذرواژه جدید با خط مشی های گذرواژه مطابقت ندارد.",
    ...
    standardFlowDisabledMessage:
        "مشتری مجاز به شروع ورود به مرورگر با response_type نیست. جریان استاندارد برای مشتری غیرفعال است.",
    implicitFlowDisabledMessage:
        "مشتری مجاز به شروع ورود به مرورگر با answer_type نیست. جریان ضمنی برای مشتری غیرفعال است.",
    ...
    permissionNotApprovedMessage: "مجوز تأیید نشد",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "نمی‌توان با درخواست احراز هویت به ارائه‌دهنده هویت ادامه داد.",
    ...
    identityProviderAuthenticationFailedMessage:
        "احراز هویت ناموفق بود. با ارائه‌دهنده هویت احراز هویت امکان‌پذیر نیست.",
    ...
    unexpectedErrorHandlingRequestMessage:
        "خطای غیرمنتظره هنگام رسیدگی به درخواست احراز هویت به ارائه‌دهنده هویت.",
    ...
    cookieNotFoundMessage: "کوکی پیدا نشد لطفاً مطمئن شوید که کوکی ها در مرورگر شما فعال هستند.",
    ...
    identityProviderLinkSuccess:
        "شما با موفقیت ایمیل خود را تأیید کردید. لطفاً به مرورگر اصلی خود برگردید و در آنجا با ورود به سیستم ادامه دهید.",
    ...
    identityProviderNotUniqueMessage:
        "قلمرو از چندین ارائه دهنده هویت پشتیبانی می کند. نمی توان تعیین کرد که با کدام ارائه دهنده هویت باید برای احراز هویت استفاده شود.",
    emailVerifiedMessage: "آدرس ایمیل شما تأیید شده است.",
    staleEmailVerificationLink:
        "پیوندی که روی آن کلیک کردید یک پیوند قدیمی است و دیگر معتبر نیست. شاید قبلا ایمیل خود را تأیید کرده باشید.",
    identityProviderAlreadyLinkedMessage:
        "هویت فدرال بازگردانده شده توسط {0} قبلاً به کاربر دیگری پیوند داده شده است.",
    ...
    differentUserAuthenticated:
        "شما قبلاً به عنوان کاربر دیگری '{0}' در این جلسه احراز هویت شده اید. لطفاً ابتدا از سیستم خارج شوید.",
    ...
    "requiredAction.UPDATE_PASSWORD": "گذرواژه را به روز کنید",
    ...
    "requiredAction.webauthn-register-passwordless": "Webauthn ثبت نام بدون گذرواژه",
    ...
    "console-password": "گذرواژه:",
    "console-otp": "گذرواژه یکبار مصرف:",
    "console-new-password": "گذرواژه جدید:",
    "console-confirm-password": "تأیید گذرواژه:",
    "console-update-password": "به روز رسانی گذرواژه شما الزامی است:",
    "console-verify-email":
        "شما باید آدرس ایمیل خود را تأیید کنید. ما یک ایمیل به {0} ارسال کردیم که حاوی کد تأیید است. لطفاً این کد را در ورودی زیر وارد کنید:",
    ...
    "saml.post-form.message": "در حال تغییر مسیر، لطفاً صبر کنید.",
    "saml.post-form.js-disabled":
        "جاوا اسکریپت غیرفعال است. ما قویاً توصیه می کنیم آن را فعال کنید. برای ادامه روی دکمه زیر کلیک کنید.",
    ...
    "password-display-name": "گذرواژه",
    "password-help-text": "با وارد کردن گذرواژه خود وارد شوید.",
    "auth-username-form-display-name": "نام کاربری",
    "auth-username-form-help-text": "با وارد کردن نام کاربری خود وارد سیستم شوید",
    "auth-username-password-form-display-name": "نام کاربری و گذرواژه",
    "auth-username-password-form-help-text": "با وارد کردن نام کاربری و گذرواژه خود وارد شوید.",
    "recovery-authn-codes-display-name": "کد احراز هویت بازیابی",
    "recovery-authn-codes-help-text":
        "یک کد احراز هویت بازیابی را از لیستی که قبلا ایجاد شده است وارد کنید.",
    ...
    "recovery-code-config-warning-message":
        "مطمئن شوید که آنها را چاپ، دانلود یا در یک مدیر گذرواژه کپی کنید و ذخیره کنید. لغو این تنظیم، این کدهای بازیابی را از حساب شما حذف می کند.",
    ...
    "recovery-codes-download-file-description":
        "کدهای بازیابی گذرواژه های یکبار مصرف هستند که به شما امکان می دهند در صورت عدم دسترسی به احراز هویت خود وارد حساب کاربری خود شوید.",
    ...
    "webauthn-passwordless-help-text": "از کلید امنیتی خود برای ورود بدون گذرواژه استفاده کنید.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn توسط این مرورگر پشتیبانی نمی شود. یکی دیگر را امتحان کنید یا با سرپرست خود تماس بگیرید.",
    ...
    "webauthn-error-different-user":
        "اولین کاربر احراز هویت شده کسی نیست که توسط کلید امنیتی احراز هویت شده است.",
