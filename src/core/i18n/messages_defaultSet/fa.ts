...
const messages = {
    ...
    "bypassKerberosDetail":
        "یا توسط Kerberos وارد نشده اید یا مرورگر شما برای ورود به Kerberos تنظیم نشده است. لطفا روی ادامه کلیک کنید تا از راه های دیگر وارد شوید",
    ...
    "loginTotpManualStep3":
        "اگر برنامه اجازه تنظیم آنها را می دهد، از مقادیر پیکربندی زیر استفاده کنید:",
    ...
    "emailInstruction":
        "نام کاربری یا آدرس ایمیل خود را وارد کنید و ما دستورالعمل هایی در مورد نحوه ایجاد رمز عبور جدید برای شما ارسال خواهیم کرد.",
    "emailInstructionUsername":
        "نام کاربری خود را وارد کنید و ما دستورالعمل هایی در مورد نحوه ایجاد رمز عبور جدید برای شما ارسال خواهیم کرد.",
    ...
    "accountTemporarilyDisabledMessage":
        "حساب به طور موقت غیرفعال شده است; با سرپرست خود تماس بگیرید یا بعداً دوباره امتحان کنید.",
    ...
    "federatedIdentityExistsMessage":
        "کاربر با {0} {1} از قبل وجود دارد. لطفا برای پیوند دادن حساب به مدیریت حساب وارد شوید.",
    "federatedIdentityUnavailableMessage":
        "کاربر {0} احراز هویت شده با ارائه دهنده هویت {1} وجود ندارد. لطفا با ادمین خود تماس بگیرید.",
    ...
    "invalidPasswordGenericMessage":
        "رمز عبور نامعتبر: رمز عبور جدید با خط مشی های رمز عبور مطابقت ندارد.",
    ...
    "staleEmailVerificationLink":
        "پیوندی که روی آن کلیک کردید یک پیوند قدیمی است و دیگر معتبر نیست. شاید قبلا ایمیل خود را تایید کرده باشید.",
    ...
    "differentUserAuthenticated":
        "شما قبلاً به عنوان کاربر دیگری '{0}' در این جلسه احراز هویت شده اید. لطفا ابتدا از سیستم خارج شوید.",
    "brokerLinkingSessionExpired":
        "درخواست پیوند حساب کارگزاری داده است، اما جلسه فعلی دیگر معتبر نیست.",
    ...
    "console-verify-email":
        "شما باید آدرس ایمیل خود را تأیید کنید. ما یک ایمیل به {0} ارسال کردیم که حاوی کد تأیید است. لطفا این کد را در ورودی زیر وارد کنید.",
    ...
    "recovery-code-config-warning-message":
        "مطمئن شوید که آنها را چاپ، دانلود یا در یک مدیر رمز عبور کپی کنید و ذخیره کنید. لغو این تنظیم، این کدهای بازیابی را از حساب شما حذف می کند.",
