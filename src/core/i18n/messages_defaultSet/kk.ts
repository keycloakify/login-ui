...
const messages = {
    ...
    deletingAccountForbidden:
        "Сізде есептік жазбаны жоюға жеткілікті құқықтар жоқ, әкімшіге хабарласыңыз.",
    ...
    bypassKerberosDetail:
        "Сіз Kerberos арқылы жүйеге кірмегенсіз немесе браузеріңіз Kerberos жүйесіне кіруге конфигурацияланбаған. Басқа құралдар арқылы кіру үшін 'Жалғастыру' түймесін басыңыз",
    ...
    loginTimeout:
        "Сіз тым ұзақ уақыт бойы әрекетсіз болдыңыз. Аутентификация процесі басынан басталады.",
    ...
    oauthGrantInformation:
        "{0}-ге сенім артатындығыңызға көз жеткізіңіз, {0} сіздің деректеріңізді қалай өңдейтінін біліңіз.",
    ...
    emailUpdateConfirmationSent:
        "Растау хаты {0} мекенжайына жіберілді. Электрондық поштаны жаңартуды аяқтау үшін нұсқауларды орындаңыз.",
    ...
    loginTotpIntro:
        "Бұл есептік жазбаға кіру үшін сізге бір реттік құпия сөз генераторын конфигурациялау қажет",
    ...
    loginTotpStep3:
        "Қолданба берген бір реттік кодты енгізіп, орнатуды аяқтау үшін Растау түймесін басыңыз.",
    loginTotpStep3DeviceName:
        "Құрылғыларыңыздың тізімінде оны табуға көмектесу үшін құрылғы атауын көрсетіңіз.",
    loginTotpManualStep2: "Қолданбаны ашып, кілтті енгізіңіз:",
    loginTotpManualStep3:
        "Егер қолданба оларды орнатуға рұқсат берсе, келесі параметрлерді пайдаланыңыз:",
    ...
    emailVerifyInstruction4:
        "Электрондық пошта мекенжайыңызды тексеру үшін сізге {0} мекенжайына нұсқаулары бар хат жібереміз.",
    emailVerifyResend: "Растау хатын қайта жіберу",
    emailVerifySend: "Растау хатын жіберу",
    emailLinkIdpTitle: "{0} байланыстыру",
    emailLinkIdp1:
        "Сізге {0} {1} есептік жазбасын {2} есептік жазбаңызбен біріктіру үшін нұсқаулары бар хат жіберілді.",
    ...
    emailInstruction:
        "Пайдаланушы атыңызды немесе E-mail-ды енгізіңіз, сонда біз сізге жаңа құпия сөз алу үшін нұсқаулар жібереміз.",
    emailInstructionUsername:
        "Пайдаланушы атыңызды енгізіңіз, сонда біз сізге жаңа құпия сөз жасау үшін нұсқаулар жібереміз.",
    ...
    "role_create-client": "Клиент жасау",
    ...
    federatedIdentityExistsMessage:
        "{0} {1} бар пайдаланушы бұрыннан бар. Бұл есептік жазбаны байланыстыру үшін есептік жазбаларды басқаруға кіріңіз.",
    federatedIdentityUnavailableMessage:
        "{1} тіркелгі провайдерімен аутентификацияланған {0} пайдаланушысы жоқ. Әкімшіге хабарласыңыз.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Тіркелгі провайдері берген сәйкестендіру токены конфигурацияланған essential claim-ге сәйкес келмейді. Әкімшіге хабарласыңыз.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Сіз {0} есептік жазбаңызды {1} {2} есептік жазбасымен байланыстыруға тырысып жатырсыз. Бірақ сіздің есептік жазбаңыз басқа {3} {4} есептік жазбасымен бұрыннан байланыстырылған. Сіз бұрыннан бар сілтемені жаңа есептік жазбамен ауыстырғыңыз келетінін растай аласыз ба?",
    federatedIdentityConfirmReauthenticateMessage:
        "Есептік жазбаңызды {0}-пен байланыстыру үшін аутентификациядан өтіңіз",
    nestedFirstBrokerFlowMessage:
        "{0} {1} пайдаланушысы ешбір белгілі пайдаланушымен байланыстырылмаған.",
    ...
    configureTotpMessage:
        "Есептік жазбаны іске қосу үшін мобильді құрылғыда аутентификаторды конфигурациялау қажет.",
    configureBackupCodesMessage:
        "Есептік жазбаны іске қосу үшін сақтық көшірме кодтарын конфигурациялау қажет.",
    ...
    delegationFailedMessage:
        "Сіз бұл браузер терезесін жауып, консольдік қолданбаға оралып, қайтадан кіруге тырыса аласыз.",
    noAccessMessage: "Қол жеткізу жоқ",
    invalidPasswordMinLengthMessage:
        "Құпия сөз дұрыс емес: құпия сөздің ұзындығы кемінде {0} таңба болуы керек.",
    ...
    invalidPasswordMinLowerCaseCharsMessage:
        "Құпия сөз дұрыс емес: құпия сөз кемінде {0} кіші әріпті қамтуы керек.",
    invalidPasswordMinUpperCaseCharsMessage:
        "Құпия сөз дұрыс емес: құпия сөз кемінде {0} бас әріпті қамтуы керек.",
    invalidPasswordMinSpecialCharsMessage:
        "Құпия сөз дұрыс емес: құпия сөз кемінде {0} арнайы таңбаны қамтуы керек.",
    invalidPasswordNotUsernameMessage:
        "Құпия сөз дұрыс емес: құпия сөз пайдаланушы атымен сәйкес келмеуі керек.",
    invalidPasswordNotContainsUsernameMessage:
        "Құпия сөз дұрыс емес: пайдаланушы атын қамтуы мүмкін емес.",
    invalidPasswordNotEmailMessage:
        "Құпия сөз дұрыс емес: электрондық пошта мекенжайымен сәйкес келмеуі керек.",
    invalidPasswordRegexPatternMessage:
        "Құпия сөз дұрыс емес: құпия сөз тұрақты өрнек бойынша тексеруден өтпеді.",
    invalidPasswordHistoryMessage:
        "Құпия сөз дұрыс емес: құпия сөз соңғы {0} құпия сөзбен сәйкес келмеуі керек.",
    invalidPasswordGenericMessage:
        "Құпия сөз дұрыс емес: жаңа құпия сөз құпия сөз ережелеріне сәйкес келмейді.",
    ...
    standardFlowDisabledMessage:
        "Клиентке берілген response_type арқылы браузер арқылы кіруді бастауға рұқсат етілмейді. Standard flow бұл клиент үшін өшірілген.",
    implicitFlowDisabledMessage:
        "Клиентке берілген response_type арқылы браузер арқылы кіруді бастауға рұқсат етілмейді. Implicit flow бұл клиент үшін өшірілген.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Тіркелгі провайдерінде аутентификация сұрауын өңдеу мүмкін емес.",
    ...
    unexpectedErrorHandlingResponseMessage:
        "Тіркелгі провайдерінен келген жауапты өңдеу кезінде күтпеген қате.",
    identityProviderAuthenticationFailedMessage:
        "Аутентификация сәтсіз аяқталды. Тіркелгі провайдерімен аутентификациядан өту мүмкін емес.",
    couldNotSendAuthenticationRequestMessage:
        "Тіркелгі провайдеріне аутентификация сұрауын орындау мүмкін емес.",
    unexpectedErrorHandlingRequestMessage:
        "Тіркелгі провайдерінің аутентификация сұрауын өңдеу кезінде күтпеген қате.",
    ...
    cookieNotFoundMessage:
        "Кіруді қайта бастау cookie-і табылмады. Оның мерзімі өтіп кетуі мүмкін; ол жойылды немесе браузеріңізде cookie файлдары өшірілген. Егер cookie файлдары өшірілген болса, оларды қосыңыз. Қайта кіру үшін Қолданбаға оралу түймесін басыңыз.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Тіркелгі провайдерінен келген жауапта код немесе қате параметрі жоқ.",
    ...
    identityProviderNotFoundMessage:
        "Берілген идентификаторы бар тіркелгі провайдерін табу мүмкін болмады.",
    identityProviderLinkSuccess:
        "Сіздің есептік жазбаңыз {0} {1} есептік жазбасымен сәтті байланыстырылды.",
    ...
    identityProviderNotUniqueMessage:
        "Realm бірнеше тіркелгі провайдерлерін қолдайды. Аутентификация үшін қай провайдерді пайдалану керектігін анықтау мүмкін болмады.",
    ...
    staleEmailVerificationLink:
        "Сіз өткен сілтеменің мерзімі өтіп, енді жарамсыз. Мүмкін сіз E-mail-ыңызды бұрыннан растаған боларсыз.",
    identityProviderAlreadyLinkedMessage:
        "{0} қайтарған федеративті идентификация басқа пайдаланушымен бұрыннан байланыстырылған.",
    confirmAccountLinking:
        "Есептік жазбаңызды {1} тіркелгі провайдерінің {0} есептік жазбасына байланыстыруды растаңыз.",
    ...
    differentUserAuthenticated:
        "Сіз осы сеанста '{0}' басқа пайдаланушы ретінде аутентификациядан өткенсіз. Алдымен шығыңыз.",
    brokerLinkingSessionExpired:
        "Брокерлік шотты байланыстыру сұралды, бірақ ағымдағы сеанс енді жарамды емес.",
    proceedWithAction: "» Жалғастыру үшін осы жерді басыңыз",
    acrNotFulfilled: "Аутентификация талаптары орындалмады",
    "requiredAction.CONFIGURE_TOTP": "Бір реттік құпия сөзді конфигурациялау",
    "requiredAction.TERMS_AND_CONDITIONS": "Шарттар мен ережелер",
    "requiredAction.UPDATE_PASSWORD": "Құпия сөзді жаңарту",
    "requiredAction.UPDATE_PROFILE": "Профильді жаңарту",
    "requiredAction.VERIFY_EMAIL": "Электрондық пошта мекенжайын растау",
    "requiredAction.CONFIGURE_RECOVERY_AUTHN_CODES": "Қалпына келтіру кодтарын жасау",
    ...
    "console-verify-email":
        "Электрондық пошта мекенжайыңызды растауыңыз қажет. Біз сізге {0} мекенжайына растау коды бар хат жібердік. Бұл кодты төмендегі өріске енгізіңіз.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript өшірілген. Оны қосуды қатаң ұсынамыз. Жалғастыру үшін төмендегі түймені басыңыз.",
    ...
    "auth-username-password-form-help-text":
        "Пайдаланушы атыңыз бен құпия сөзіңізді енгізу арқылы кіріңіз.",
    ...
    "recovery-authn-codes-display-name": "Аутентификация қалпына келтіру коды",
    "recovery-authn-codes-help-text":
        "Бұрын жасалған тізімнен аутентификация қалпына келтіру кодын енгізіңіз.",
    ...
    "recovery-code-config-warning-title":
        "Бұл қалпына келтіру кодтарын осы беттен шыққаннан кейін қайта көру мүмкін болмайды",
    "recovery-code-config-warning-message":
        "Оларды басып шығуды, жүктеп алуды немесе құпия сөз менеджеріне көшіруді және сақтауды ұмытпаңыз. Бұл параметрді болдырмау бұл қалпына келтіру кодтарын есептік жазбаңыздан жояды.",
    ...
    "recovery-codes-download-file-description":
        "Қалпына келтіру кодтары — бұл екі факторлы аутентификаторға қол жеткізе алмасаңыз, есептік жазбаңызға кіруге мүмкіндік беретін бір реттік кодтар.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn бұл браузерде қолдау көрсетілмейді. Басқасын қолданып көріңіз немесе әкімшіге хабарласыңыз.",
    ...
    "webauthn-error-different-user":
        "Бірінші аутентификацияланған пайдаланушы қатынасу кілтімен аутентификацияланған пайдаланушы емес.",
    ...
    "passkey-unsupported-browser-text":
        "Passkey бұл браузерде қолдау көрсетілмейді. Басқасын қолданып көріңіз немесе әкімшіге хабарласыңыз.",
    ...
    "idp-email-verification-help-text":
        "Электрондық пошта мекенжайын растау арқылы есептік жазбаңызды байланыстырыңыз.",
    ...
    finalDeletionConfirmation:
        "Егер сіз есептік жазбаңызды жойсаңыз, оны қалпына келтіру мүмкін болмайды. Есептік жазбаңызды сақтау үшін «Болдырмау» түймесін басыңыз.",
    ...
    "access-denied-when-idp-auth":
        "{0} арқылы аутентификациядан өту кезінде қол жеткізуден бас тартылды",
    ...
    "error-invalid-multivalued-size":
        "{0} атрибутының кемінде {1} және ең көбі {2} {2,choice,0#мәндері|1#мәні|1<мәні} болуы керек.",
    "organization.confirm-membership.title": "Сіз ${kc.org.name} ұйымына қосылғалы жатырсыз",
    "organization.confirm-membership":
        "Төмендегі сілтемені басу арқылы сіз {0} ұйымының мүшесі боласыз:",
    ...
    confirmAccountLinkingBody:
        "Егер сіз есептік жазбаны байланыстырсаңыз, сіз {1} тіркелгі провайдерінің {0} есептік жазбасын пайдаланып кіре аласыз. Егер сіз бұл процесті бастамасаңыз немесе есептік жазбаны байланыстырғыңыз келмесе, жалғастырмаңыз.",
