...
const messages = {
    ...
    "deletingAccountForbidden":
        "У вас недостатньо прав для видалення власного облікового запису, зверніться до адміністратора.",
    "kerberosNotConfigured": "Kerberos не налаштовано",
    "kerberosNotConfiguredTitle": "Kerberos не налаштовано",
    "bypassKerberosDetail":
        "Або ви не ввійшли в систему через Kerberos, або ваш браузер не налаштований для входу через Kerberos. Натисніть «Продовжити», щоб увійти іншим способом",
    ...
    "oauthGrantInformation":
        "Переконайтеся, що Ви довіряєте {0}, дізнавшись, як {0} оброблятиме Ваші дані.",
    ...
    "emailUpdateConfirmationSent":
        "Електронний лист із підтвердженням надіслано на адресу {0}. Слідуйте вказівкам, щоб завершити оновлення адреси електронної пошти.",
    ...
    "loginTotpIntro":
        "Вам потрібно налаштувати генератор одноразових паролів для доступу до цього облікового запису",
    ...
    "loginTotpStep3":
        'Введіть одноразовий код, наданий застосунком, і натисніть "Надіслати", щоб завершити налаштування.',
    ...
    "loginTotpManualStep3":
        "Використовуйте такі значення конфігурації, якщо застосунок дозволяє їх установку:",
    ...
    "oauth2DeviceExpiredUserCodeMessage":
        "Термін дії коду минув. Поверніться до свого пристрою та спробуйте підключитися знову.",
    "oauth2DeviceVerificationCompleteHeader": "Успішний вхід на пристрій",
    "oauth2DeviceVerificationCompleteMessage":
        "Ви можете закрити це вікно браузера та повернутися до свого пристрою.",
    "oauth2DeviceVerificationFailedHeader": "Помилка входу на пристрій",
    "oauth2DeviceVerificationFailedMessage":
        "Ви можете закрити це вікно браузера, повернутися до свого пристрою та спробувати підключитися знову.",
    "oauth2DeviceConsentDeniedMessage": "Згода на підключення пристрою відмовлена.",
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "Клієнту не дозволено ініціювати дозвіл авторизації пристрою OAuth 2.0. Цей процес вимкнено для клієнта.",
    "emailVerifyInstruction1":
        "Електронний лист з інструкціями щодо підтвердження Вашої адреси електронної пошти було надіслано на Вашу адресу {0}.",
    ...
    "emailLinkIdp1":
        "Вам був надісланий електронний лист з інструкціями щодо зв'язування облікового запису {0} {1} з вашим обліковим записом {2}.",
    ...
    "emailInstruction":
        "Введіть своє ім'я користувача або адресу електронної пошти, і ми надішлемо Вам інструкції щодо створення нового пароля.",
    "emailInstructionUsername":
        "Введіть своє ім'я користувача, і ми надішлемо Вам інструкції щодо створення нового пароля.",
    ...
    "accountTemporarilyDisabledMessage":
        "Обліковий запис тимчасово заблоковано; зверніться до адміністратора або повторіть спробу пізніше.",
    ...
    "federatedIdentityExistsMessage":
        "Користувач з {0} {1} вже існує. Будь ласка, увійдіть до системи керування обліковим записом, щоб зв'язати обліковий запис.",
    "federatedIdentityUnavailableMessage":
        "Користувач {0}, автентифікований провайдером облікових записів {1}, не існує. Будь ласка, зверніться до адміністратора.",
    "federatedIdentityUnmatchedEssentialClaimMessage":
        "ID-токен, виданий провайдером облікових записів, не відповідає налаштуванням. Будь ласка, зверніться до свого адміністратора.",
    ...
    "federatedIdentityConfirmReauthenticateMessage":
        "Пройдіть автентифікацію, щоб зв'язати свій обліковий запис із {0}",
    ...
    "configureTotpMessage":
        "Вам потрібно налаштувати Mobile Authenticator, щоб активувати обліковий запис.",
    "configureBackupCodesMessage":
        "Вам потрібно налаштувати резервні коди, щоб активувати обліковий запис.",
    "updateProfileMessage":
        "Вам потрібно оновити свій профіль користувача, щоб активувати обліковий запис.",
    "updatePasswordMessage": "Вам потрібно змінити пароль, щоб активувати обліковий запис.",
    "updateEmailMessage":
        "Вам потрібно оновити адресу електронної пошти, щоб активувати обліковий запис.",
    "resetPasswordMessage": "Вам потрібно змінити пароль.",
    "verifyEmailMessage":
        "Вам потрібно підтвердити адресу електронної пошти, щоб активувати обліковий запис.",
    "linkIdpMessage":
        "Вам потрібно підтвердити свою адресу електронної пошти, щоб зв'язати обліковий запис із {0}.",
    ...
    "delegationCompleteMessage":
        "Ви можете закрити це вікно браузера та повернутися до вашої консольної програми.",
    "delegationFailedHeader": "Помилка входу",
    "delegationFailedMessage":
        "Ви можете закрити це вікно браузера, повернутися до консольної програми та спробувати увійти знову.",
    "noAccessMessage": "Немає доступу",
    "invalidPasswordMinLengthMessage":
        "Невірний пароль: довжина пароля повинна бути не менше {0} символів(а).",
    "invalidPasswordMaxLengthMessage":
        "Невірний пароль: довжина пароля повинна бути не більше {0} символів(а).",
    ...
    "invalidPasswordMinLowerCaseCharsMessage":
        "Невірний пароль: пароль має містити щонайменше {0} символів(а) у нижньому регістру.",
    "invalidPasswordMinUpperCaseCharsMessage":
        "Невірний пароль: пароль має містити щонайменше {0} символів(а) у верхньому регістрі.",
    "invalidPasswordMinSpecialCharsMessage":
        "Невірний пароль: пароль має містити щонайменше {0} спеціальних символів(а).",
    "invalidPasswordNotUsernameMessage":
        "Невірний пароль: пароль не повинен збігатися з іменем користувача.",
    "invalidPasswordNotEmailMessage":
        "Невірний пароль: пароль не повинен збігатися з адресою електронної пошти.",
    "invalidPasswordRegexPatternMessage":
        "Невірний пароль: пароль не відповідає шаблону(ам) регулярного виразу.",
    "invalidPasswordHistoryMessage":
        "Недійсний пароль: пароль не повинен збігатися з жодним з останніх {0} паролів.",
    ...
    "standardFlowDisabledMessage":
        "Клієнту не дозволено ініціювати вхід у браузер із вказаним response_type. Standard flow вимкнено для клієнта.",
    "implicitFlowDisabledMessage":
        "Клієнту не дозволено ініціювати вхід у браузер із вказаним response_type. Implicit flow вимкнено для клієнта.",
    ...
    "noRelayStateInResponseMessage":
        "Немає стану ретрансляції у відповіді від провайдера облікових записів.",
    ...
    "couldNotProceedWithAuthenticationRequestMessage":
        "Не вдалося продовжити запит автентифікації до провайдера облікових записів.",
    ...
    "unexpectedErrorRetrievingTokenMessage":
        "Неочікувана помилка під час отримання токену від провайдера облікових записів.",
    "unexpectedErrorHandlingResponseMessage":
        "Неочікувана помилка під час обробки відповіді від провайдера облікових записів",
    "identityProviderAuthenticationFailedMessage":
        "Помилка автентифікації. Не вдалося автентифікуватися за допомогою провайдера облікових записів.",
    "couldNotSendAuthenticationRequestMessage":
        "Не вдалося надіслати запит автентифікації до провайдера облікових записів.",
    "unexpectedErrorHandlingRequestMessage":
        "Неочікувана помилка під час обробки запиту автентифікації до провайдера облікових записів.",
    ...
    "cookieNotFoundMessage":
        "Файл cookie не знайдено. Переконайтеся, що файли cookie увімкнено у вашому браузері.",
    ...
    "identityProviderUnexpectedErrorMessage":
        "Неочікувана помилка під час автентифікації за допомогою провайдера облікових записів.",
    "identityProviderMissingStateMessage":
        "Відсутній параметр стану у відповіді від провайдера облікових записів.",
    "identityProviderMissingCodeOrErrorMessage":
        "Відсутній код або параметр помилки у відповіді від провайдера облікових записів.",
    ...
    "identityProviderInvalidSignatureMessage":
        "Невірний підпис у відповіді від провайдера облікових записів.",
    "identityProviderNotFoundMessage": "Не вдалося знайти провайдера облікових записів.",
    "identityProviderLinkSuccess":
        "Ви успішно підтвердили свою адресу електронної пошти. Будь ласка, поверніться до свого браузера та продовжте вхід.",
    "staleCodeMessage":
        "Ця сторінка більше не дійсна, будь ласка, поверніться до свого застосунку та увійдіть знову",
    ...
    "identityProviderNotUniqueMessage":
        "Realm підтримує кілька провайдера облікових записів. Не вдалося визначити, якого провайдера облікових записів слід використовувати для автентифікації.",
    ...
    "staleEmailVerificationLink":
        "Посилання, на яке Ви натиснули, є застарілим і більше не працює. Можливо, Ви вже підтвердили свою електронну адресу.",
    "identityProviderAlreadyLinkedMessage":
        "Обліковий запис, повернутий {0}, вже зв'язаний з іншим користувачем.",
    "confirmAccountLinking":
        "Підтвердити зв'язування облікового запису {0} провайдера облікових записів {1} з вашим обліковим записом.",
    ...
    "differentUserAuthenticated":
        "Ви вже аутентифіковані як інший користувач '{0}' у цій сесії. Спочатку вийдіть.",
    "brokerLinkingSessionExpired":
        "Запитано зв'язування облікового запису брокера, але поточна сесія більше недійсна.",
    ...
    "console-verify-email":
        "Вам потрібно підтвердити свою адресу електронної пошти. Ми надіслали електронний лист на адресу {0}, який містить код підтвердження. Введіть цей код у поле нижче.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript вимкнено. Ми наполегливо рекомендуємо ввімкнути його. Щоб продовжити, натисніть кнопку нижче.",
    ...
    "auth-recovery-authn-code-form-help-text":
        "Введіть код відновлення автентифікації з попередньо створеного списку.",
    ...
    "recovery-code-config-warning-title":
        "Коди відновлення більше не можливо буде переглянути після виходу з цієї сторінки",
    "recovery-code-config-warning-message":
        "Обов'язково роздрукуйте, завантажте або скопіюйте їх до менеджера паролів і збережіть. Скасування цього налаштування призведе до видалення цих кодів відновлення з вашого облікового запису.",
    ...
    "recovery-codes-download-file-description":
        "Коди відновлення — це одноразові паролі, які дозволяють Вам увійти до свого облікового запису, якщо у Вас немає доступу до автентифікатора.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn не підтримується цим браузером. Спробуйте інший або зверніться до адміністратора.",
    ...
    "webauthn-error-different-user":
        "Перший автентифікований користувач не є тим, хто автентифікований ключем безпеки.",
    ...
    "idp-email-verification-help-text":
        "Підв'яжіть свій обліковий запис, підтвердивши свою електронну адресу.",
    ...
    "accountUnusable":
        "Будь-яке подальше використання застосунку буде неможливим з цим обліковим записом",
    ...
    "readOnlyUsernameMessage":
        "Ви не можете оновити своє ім'я користувача, оскільки воно доступне лише для читання.",
