...
const messages = {
    ...
    deletingAccountForbidden:
        "Nu ai destule permisiuni pentru a şterge propriu cont, contacteazǎ administratorul.",
    doSubmit: "Trimite",
    registerTitle: "Înregistreazǎ-te",
    bypassKerberosDetail:
        "Ori nu te-ai autentificat în Kerberos, ori Browser-ul nu e configurat pentru autentificarea cu Kerberos. Apasă pe continuǎ pentru autentificarea cu alte metode",
    ...
    emailUpdateConfirmationSent:
        "Un e-mail de confirmare a fost trimis către {0}. Trebuie să urmezi instrucțiunile acestuia pentru a finaliza actualizarea e-mailului.",
    ...
    loginTotpIntro:
        "Trebuie să configurezi un generator de parole de unică folosință pentru a accesa acest cont",
    loginTotpStep3:
        "Introdu codul unic furnizat de aplicație și apasă pe Trimitere pentru a finaliza configurarea.",
    loginTotpStep3DeviceName:
        "Furnizează un nume de dispozitiv pentru a te ajuta să gestionezi dispozitivele OTP.",
    ...
    identityProviderNotUniqueMessage:
        "Domeniul acceptă mai mulți furnizori de identitate. Nu s-a putut determina cu ce furnizor de identitate ar trebui să se facă autentificarea.",
    ...
    "webauthn-registration-init-label-prompt":
        "Te rugăm să completezi eticheta cheii de acces înregistrate",
    ...
    "webauthn-error-different-user":
        "Primul utilizator autentificat nu este cel autentificat prin cheia de acces.",
    ...
    "passkey-unsupported-browser-text":
        "Cheia de acces nu este acceptată de acest browser. Încercă altă cheie de acces sau contactează administratorul.",
    ...
    "idp-username-password-form-help-text":
        "Conectează contul prin intermediul datelor de autentificare.",
    ...
    identityProviderUnexpectedErrorMessage:
        "Eroare neașteptată la autentificarea cu furnizorul de identitate",
    identityProviderInvalidSignatureMessage:
        "Semnătură invalidă în răspunsul de la furnizorul de identitate.",
    ...
    invalidPasswordGenericMessage:
        "Parolă invalidă: noua parolă nu corespunde politicilor privind parolele.",
    noRelayStateInResponseMessage:
        "Nicio stare de retransmitere ca răspuns de la furnizorul de identitate.",
    unexpectedErrorRetrievingTokenMessage:
        "Eroare neașteptată la preluarea token-ului de la furnizorul de identitate.",
    unexpectedErrorHandlingResponseMessage:
        "Eroare neașteptată la gestionarea răspunsului de la furnizorul de identitate.",
    identityProviderAuthenticationFailedMessage:
        "Autentificarea a eșuat. Nu s-a putut realiza autentificarea cu furnizorul de identitate.",
    couldNotSendAuthenticationRequestMessage:
        "Nu s-a putut trimite solicitarea de autentificare către furnizorul de identitate.",
    identityProviderMissingStateMessage:
        "Lipsește parametrul de stare din răspunsul de la furnizorul de identitate.",
    ...
    "organization.member.register.title":
        "Crează un cont pentru a te alătura organizației ${kc.org.name}",
    ...
    invalidPasswordMinSpecialCharsMessage:
        "Parolă invalidă: trebuie să conțină cel puțin {0} caractere speciale.",
    invalidPasswordNotUsernameMessage:
        "Parolă invalidă: nu trebuie să fie egală cu numele de utilizator.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Nu s-a putut continua cu solicitarea de autentificare către furnizorul de identitate.",
    unexpectedErrorHandlingRequestMessage:
        "Eroare neașteptată la gestionarea solicitării de autentificare către furnizorul de identitate.",
    ...
    readOnlyUsernameMessage:
        "Nu îți poți actualiza numele de utilizator deoarece acesta este numai pentru citire.",
    ...
    invalidPasswordMinLowerCaseCharsMessage:
        "Parolă invalidă: trebuie să conțină cel puțin {0} caractere minuscule.",
    invalidPasswordMinUpperCaseCharsMessage:
        "Parolă invalidă: trebuie să conțină cel puțin {0} caractere majuscule.",
    gssDelegationCredential: "Credențial de delegare GSS",
    loginTotpManualStep3:
        "Utilizează următoarele valori de configurare dacă aplicația permite setarea acestora:",
    oauth2DeviceVerificationCompleteMessage:
        "Poți închide această fereastră de browser și să te întorci la dispozitiv.",
    oauth2DeviceVerificationFailedMessage:
        "Poți închide această fereastră de browser, să te întorci la dispozitiv și să încerci să te conectezi din nou.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Clientul nu are permisiunea să inițieze OAuth 2.0 Device Authorization Grant. Fluxul este dezactivat pentru client.",
    emailVerifyInstruction1:
        "Un e-mail cu instrucțiuni pentru verificarea adresei de e-mail a fost trimis la adresa ta {0}.",
    emailVerifyInstruction4:
        "Pentru a verifica adresa ta de e-mail, îți vom trimite un e-mail cu instrucțiuni la adresa {0}.",
    emailVerifySendCooldown:
        "Trebuie să aștepți {0} secunde înainte de a retrimite e-mailul de verificare.",
    emailLinkIdp1:
        "Ți-a fost trimis un e-mail cu instrucțiuni pentru conectarea contului {0} {1} cu contul tău {2}.",
    emailInstruction:
        "Introdu numele de utilizator sau adresa de e-mail și îți vom trimite instrucțiuni despre cum să creezi o parolă nouă.",
    emailInstructionUsername:
        "Introdu numele de utilizator și îți vom trimite instrucțiuni despre cum să creezi o parolă nouă.",
    "error-non-ascii-local-part-email":
        "Partea locală a adresei trebuie să conțină doar caractere ASCII.",
    federatedIdentityExistsMessage:
        "Utilizatorul cu {0} {1} există deja. Te rugăm să te conectezi la administrarea contului pentru a asocia contul.",
    federatedIdentityUnavailableMessage:
        "Utilizatorul {0} autentificat cu furnizorul de identitate {1} nu există. Te rugăm să contactezi administratorul.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Tokenul de identificare emis de furnizorul de identitate nu corespunde cu cerințele de configurare de bază. Te rugăm să contactezi administratorul.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Încerci să conectezi contul tău {0} cu contul {1} {2}, dar contul tău este deja conectat cu un alt cont {3} {4}. Poți confirma dacă dorești să înlocuiești asocierea existentă cu noul cont?",
    ...
    delegationCompleteMessage:
        "Poți închide această fereastră de browser și să te întorci la aplicația consolă.",
    delegationFailedMessage:
        "Poți închide această fereastră de browser, să te întorci la aplicația consolă și să încerci să te autentifici din nou.",
    invalidPasswordHistoryMessage:
        "Parolă invalidă: nu trebuie să fie egală cu niciuna dintre ultimele {0} parole.",
    bearerOnlyMessage:
        "Aplicațiile care utilizează numai token de tip bearer nu au permisiunea să inițieze autentificarea prin browser",
    standardFlowDisabledMessage:
        "Clientului nu i se permite să inițieze autentificarea prin browser cu response_type dat. Fluxul standard este dezactivat pentru client.",
    implicitFlowDisabledMessage:
        "Clientul nu are permisiunea de a iniția autentificarea în browser cu response_type dat. Fluxul implicit este dezactivat pentru client.",
    cookieNotFoundMessage:
        "Cookie-ul de autentificare pentru repornire nu a fost găsit. Este posibil să fi expirat; este posibil să fi fost șters sau cookie-urile sunt dezactivate în browserul tău. Dacă cookie-urile sunt dezactivate, atunci trebuie activate. Faceți clic pe Înapoi la aplicație pentru a te autentifica din nou.",
    identityProviderMissingCodeOrErrorMessage:
        "Lipsește cod sau parametru de eroare în răspunsul de la furnizorul de identitate.",
    identityProviderLinkSuccess:
        "Ți-ai verificat cu succes adresa de e-mail. Te rugăm să te întorci la browserul original și să continui autentificarea acolo.",
    staleCodeMessage:
        "Această pagină nu mai este valabilă, te rugăm să te întorci la aplicație și să te conectezi din nou",
    staleEmailVerificationLink:
        "Legătura pe care ai dat clic este o legătură veche și nu mai este validă. Probabil ți-ai verificat deja adresa de e-mail.",
    identityProviderAlreadyLinkedMessage:
        "Identitatea comună returnată de {0} este deja legată de un alt utilizator.",
    confirmAccountLinking:
        "Confirmă asocierea contului {0} al furnizorului de identitate {1} cu contul tău.",
    confirmAccountLinkingBody:
        "Dacă asociezi contul, vei putea, de asemenea, să te conectezi folosind contul {0} al furnizorului de identitate {1}. Nu continua dacă nu ai inițiat acest proces sau dacă nu dorești să asociezi contul.",
    differentUserAuthenticated:
        "Ești deja autentificat ca utilizator diferit '{0}' în această sesiune. Te rugăm să te deconectezi mai întâi.",
    brokerLinkingSessionExpired:
        "S-a solicitat conectarea contului de către broker, dar sesiunea curentă nu mai este validă.",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Codul a expirat. Te rugăm să te întorci la dispozitiv și să încerci să te conectezi din nou.",
    "requiredAction.webauthn-register-passwordless": "Înregistrare WebAuthn fără parolă",
    "console-verify-email":
        "Trebuie să-ți verifici adresa de e-mail. Am trimis un e-mail către {0} care conține un cod de verificare. Te rugăm să introduci acest cod în câmpul de mai jos.",
    "saml.post-form.js-disabled":
        "JavaScript este dezactivat. Îți recomandăm să-l activezi. Apasă pe butonul de mai jos pentru a continua.",
    "recovery-authn-codes-help-text":
        "Introdu un cod de recuperare pentru autentificare dintr-o listă generată anterior.",
    "recovery-code-config-warning-title":
        "Aceste coduri de recuperare nu vor mai apărea după ce părăsești această pagină",
    "recovery-code-config-warning-message":
        "Asigură-te că le imprimi, le descarci sau le copiezi într-un manager de parole și că le păstrezi. Anularea acestei configurări va elimina aceste coduri de recuperare din contul tău.",
    "recovery-codes-download-file-description":
        "Codurile de recuperare sunt coduri de acces de unică folosință care îți permit să te conectezi la contul tău dacă nu ai acces la instrumentul de autentificare.",
    "webauthn-unsupported-browser-text":
        "WebAuthn nu este acceptat de acest browser. Încearcă altul sau contactează administratorul.",
    "idp-email-verification-help-text": "Asociază-ți contul validând adresa de e-mail.",
    finalDeletionConfirmation:
        "Dacă îți ștergi contul, acesta nu poate fi restaurat. Pentru a păstra contul, apasă pe Anulare.",
    accountUnusable: "Orice utilizare ulterioară a aplicației nu va fi posibilă cu acest cont",
    "error-invalid-multivalued-size":
        "Atributul {0} trebuie să aibă cel puțin {1} și cel mult {2} {2,choice,0#valori|1#valoare|1<valori}.",
    "organization.confirm-membership":
        "Făcând clic pe legătura de mai jos, vei deveni membru al organizației {0}:",
    emailVerificationPending:
        "Un e-mail de verificare a fost trimis la {0}. Poți trimite fără modificări pentru a retrimite e-mailul de verificare sau poți introduce o altă adresă de e-mail.",
    staleInviteOrgLink:
        "Legătura pe care ai dat clic nu mai este validă. Este posibil să fi expirat sau să fi fost deja utilizată.",
