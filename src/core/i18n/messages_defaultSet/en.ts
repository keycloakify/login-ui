...
const messages = {
    ...
    confirmAccountLinkingBody:
        "If you link the account, you will also be able to login using account {0} of the identity provider {1}. Do not proceed if you did not initiate this process or you do not want to link the account.",
    ...
    "error-invalid-multivalued-size":
        "Attribute {0} must have at least {1} and at most {2} {2,choice,0#values|1#value|1<values}.",
    ...
    emailVerificationPending:
        "A verification email was sent to {0}. You can submit without changes to resend the verification email, or enter a different email address.",
    orgMemberAlready: "You are already a member of the {1} organization.",
    staleInviteOrgLink:
        "The link you clicked is no longer valid. It may have expired or already been used.",
