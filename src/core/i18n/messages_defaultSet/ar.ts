...
const messages = {
    ...
    "emailUpdateConfirmationSent":
        "تم إرسال رسالة التحقق عبر البريد الإلكتروني إلى {0}. يجب عليك اتباع التعليمات لإكمال تحديث البريد الإلكتروني.",
    ...
    "loginTotpStep3":
        "أدخل رمز التحقق ذات الاستخدام الواحد والصادر من التطبيق ثم انقر على زر الحفظ لإتمام الإعداد.",
    ...
    "oauth2DeviceExpiredUserCodeMessage":
        "انتهت صلاحية الرمز. يرجى العودة إلى جهازك ثم محاولة الاتصال مرة أخرى.",
    ...
    "oauth2DeviceVerificationFailedMessage":
        "يمكنك إغلاق نافذة المتصفح هذه والعودة إلى جهازك ومحاولة الاتصال مرة أخرى.",
    "oauth2DeviceConsentDeniedMessage": "تم رفض الموافقة على الاتصال بالجهاز.",
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "لا يُسمح للعميل ببدء الإجراء OAuth 2.0 Device Authorization Grant، حيث أنه معطل.",
    "emailVerifyInstruction1":
        "تم إرسال بريد إلكتروني يحتوي على إرشادات للتحقق من عنوان بريدك الإلكتروني إلى عنوانك {0}.",
    ...
    "emailLinkIdp1":
        "تم إرسال رسالة بريد إلكتروني بها إرشادات لربط الحساب {0} ({1}) بالحساب {2} الخاص بك.",
    ...
    "emailInstruction":
        "أدخل اسم المستخدم أو عنوان البريد الإلكتروني الخاص بك وسنرسل لك تعليمات حول كيفية إنشاء كلمة مرور جديدة.",
    "emailInstructionUsername":
        "أدخل اسم المستخدم الخاص بك وسنرسل لك تعليمات حول كيفية إنشاء كلمة مرور جديدة.",
    ...
    "accountTemporarilyDisabledMessage":
        "الحساب معطل مؤقتًا، تواصل مع مسؤول النظام أو حاول مرة أخرى لاحقًا.",
    ...
    "federatedIdentityExistsMessage":
        "المستخدم صاحب ({0}: {1}) موجود مسبقًا. الرجاء تسجيل الدخول إلى صفحة إدارة الحساب لربط الحساب.",
    "federatedIdentityUnavailableMessage":
        "المستخدم {0} المصادق عليه بواسطة مزود الحسابات {1} غير موجود. الرجاء التواصل مع مسؤول النظام.",
    "federatedIdentityUnmatchedEssentialClaimMessage":
        "رمز المصادقة للتعريف الذي تم إصداره من مزود الحسابات لا يتطابق مع القيم التي إعدادها مسبقًا. الرجاء التواصل مع مسؤول النظام.",
    ...
    "delegationCompleteMessage":
        "يمكنك إغلاق نافذة المتصفح هذه والعودة إلى تطبيق وحدة التحكم الخاصة بك.",
    "delegationFailedHeader": "فشل في تسجيل الدخول",
    "delegationFailedMessage":
        "يمكنك إغلاق نافذة المتصفح هذه والعودة إلى تطبيق وحدة التحكم ومحاولة تسجيل الدخول مرة أخرى.",
    ...
    "invalidPasswordMinLowerCaseCharsMessage":
        "كلمة المرور غير صالحة: يجب أن تحتوي على {0} حروف صغيرة على الأقل.",
    "invalidPasswordMinUpperCaseCharsMessage":
        "كلمة المرور غير صالحة: يجب أن تحتوي على {0} حروف كبيرة على الأقل.",
    "invalidPasswordMinSpecialCharsMessage":
        "كلمة المرور غير صالحة: يجب أن تحتوي على {0} رموز على الأقل.",
    ...
    "invalidPasswordHistoryMessage":
        "كلمة المرور غير صالحة: يجب ألا تكون مطابقة لأي من كلمات المرور الـ {0} الأخيرة.",
    "invalidPasswordGenericMessage":
        "كلمة المرور غير صالحة: كلمة المرور الجديدة لا تتطابق مع سياسات كلمة المرور.",
    ...
    "cookieNotFoundMessage":
        "لم يتم العثور على ملف تعريف الارتباط. يرجى التأكد من تمكين ملفات تعريف الارتباط في متصفحك.",
    ...
    "identityProviderLinkSuccess":
        "لقد نجحت في التحقق من بريدك الإلكتروني. يرجى الرجوع إلى متصفحك والمتابعة هناك في عملية تسجيل الدخول.",
    "staleCodeMessage":
        "هذه الصفحة لم تعد صالحة، يرجى الرجوع إلى التطبيق الخاص بك وتسجيل الدخول مرة أخرى",
    ...
    "identityProviderNotUniqueMessage":
        "تدعم المنظومة عدة مزودي حسابات. تعذر تحديد مزود الحسابات الذي يجب استخدامه للمصادقة معه.",
    ...
    "staleEmailVerificationLink":
        "الرابط الذي نقرت عليه هو رابط قديم ولم يعد صالحًا. ربما تكون قد تحققت مسبقًا من بريدك الإلكتروني.",
    ...
    "differentUserAuthenticated":
        "لقد تمت مصادقتك مسبقًا كمستخدم مختلف ' {0} ' في هذه الجلسة. الرجاء تسجيل الخروج أولا.",
    ...
    "saml.post-form.js-disabled":
        "تم تعطيل جافاسكربت. نوصي بشدة لتمكينه. انقر على الزر أدناه للمتابعة. ",
    ...
    "webauthn-unsupported-browser-text":
        "الخاصية WebAuthn غير مدعومة في هذا المتصفح. جرب متصفح آخر أو تواصل مع مسؤول النظام.",
    ...
    "webauthn-error-different-user":
        "أول مستخدم تمت مصادقته ليس هو الشخص الذي تمت مصادقته بواسطة مفتاح الأمان.",
    ...
    "finalDeletionConfirmation":
        "إذا قمت بحذف حسابك، فلا يمكن استعادته. للاحتفاظ بحسابك، انقر فوق إلغاء.",
