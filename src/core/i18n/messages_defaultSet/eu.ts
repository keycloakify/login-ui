...
const messages = {
    ...
    deletingAccountForbidden:
        "Ez duzu nahikoa baimenik zure kontua ezabatzeko, jarri harremanetan administratzailearekin.",
    kerberosNotConfigured: "Kerberos konfiguratu gabe",
    kerberosNotConfiguredTitle: "Kerberos konfiguratu gabe",
    bypassKerberosDetail:
        "Ez zaude Kerberos bidez saioa hasita edo zure nabigatzailea ez dago Kerberos saio hasierarako konfiguratuta. Egin klik jarraitu botoian beste modu baten saioa hasteko",
    ...
    emailUpdateConfirmationSent:
        "Baieztapen eposta bat bidali da {0} helbidera. Bertan agertzen diren jarraibideak jarraitu behar dituzu eposta eguneratzea osatzeko.",
    ...
    loginTotpStep3:
        "Sartu aplikazioak emandako aldi bateko kodea eta egin klik Bidali botoian konfigurazioa amaitzeko.",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Kodea iraungi da. Mesedez itzuli zure gailura eta saiatu berriro konektatzen.",
    oauth2DeviceVerificationCompleteHeader: "Gailuaren saioa ongi hasi da",
    oauth2DeviceVerificationCompleteMessage:
        "Nabigatzaile leiho hau itxi dezakezu eta itzuli zure gailura.",
    oauth2DeviceVerificationFailedHeader: "Gailuaren saioak huts egin du",
    oauth2DeviceVerificationFailedMessage:
        "Nabigatzaile leiho hau itxi dezakezu eta itzuli zure gailura eta saiatu berriro konektatzen.",
    oauth2DeviceConsentDeniedMessage: "Baimena ukatua gailua konektatzeko.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Bezeroak ezin du OAuth 2.0 Device Authorization Grant abiarazi. Fluxua desgaituta dago bezeroaren....",
    emailVerifyInstruction1:
        "Zure eposta helbidea egiaztatzeko jarraibideak dituen eposta bat bidali da {0} helbidera.",
    ...
    emailVerifyInstruction4:
        "Zure eposta helbidea egiaztatzeko, jarraibideak dituen eposta bat bidaltzear gaude {0} helbidera.",
    emailVerifyResend: "Egiaztapen eposta berriro bidali",
    emailVerifySend: "Egiaztapen eposta bidali",
    emailVerifySendCooldown:
        "{0} segundo itxaron behar dituzu egiaztapen eposta berriro bidali aurretik.",
    emailLinkIdpTitle: "Lotu {0}",
    emailLinkIdp1:
        "{0} kontua {1} zure {2} kontuarekin lotzen jarraibideak dituen eposta bat bidali dizugu.",
    ...
    emailInstruction:
        "Sartu zure erabiltzaile izena edo eposta helbidea eta pasahitz berri bat nola sortu jakinaraziko dizugu.",
    emailInstructionUsername:
        "Sartu zure erabiltzaile izena eta pasahitz berri bat nola sortu jakinaraziko dizugu.",
    ...
    "error-non-ascii-local-part-email":
        "Helbidearen toki zatiak ASCII karaktereak soilik izan behar ditu.",
    ...
    federatedIdentityExistsMessage:
        "{0} {1} duen erabiltzailea dagoeneko existitzen da. Mesedez hasi saioa kontu kudeaketan kontua lotzeko.",
    federatedIdentityUnavailableMessage:
        "{0} erabiltzailea {1} identitate hornitzailearekin autentifikatua ez da existitzen. Mesedez jarri harremanetan zure administratzailearekin.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Identitate hornitzaileak emandako ID tokena ez dator bat konfiguratutako ezinbesteko eskaerarekin. Mesedez jarri harremanetan zure administratzailearekin.",
    ...
    federatedIdentityConfirmLinkMessage:
        "{0} {1} duen erabiltzailea dagoeneko existitzen da. Nola jarraitu nahi duzu?",
    federatedIdentityConfirmOverrideMessage:
        "Zure {0} kontua {1} {2} kontuarekin lotzen saiatzen ari zara. Baina zure kontua dagoeneko beste {3} {4} kontuarekin lotuta dago. Baieztatu nahi duzu lehendik dagoen lotura kontu berriarekin ordezkatu?",
    federatedIdentityConfirmReauthenticateMessage: "Autentifikatu zure kontua {0}-(r)ekin lotzeko",
    nestedFirstBrokerFlowMessage:
        "{0} {1} erabiltzailea ez dago ezagutzen den erabiltzailerekin lotuta.",
    ...
    configureTotpMessage:
        "Mugikorrerako autentifikatzailea konfiguratu behar duzu zure kontua aktibatzeko.",
    ...
    delegationCompleteMessage:
        "Nabigatzaile leiho hau itxi dezakezu eta itzuli zure kontsola aplikaziora.",
    delegationFailedHeader: "Saio hasierak huts egin du",
    delegationFailedMessage:
        "Nabigatzaile leiho hau itxi dezakezu eta itzuli zure kontsola aplikaziora eta saiatu berriro saioa hasten.",
    ...
    invalidPasswordMinDigitsMessage:
        "Pasahitz baliogabea: gutxienez {0} zenbakizko digitu izan behar ditu.",
    invalidPasswordMinLowerCaseCharsMessage:
        "Pasahitz baliogabea: gutxienez {0} minuskula karaktere izan behar ditu.",
    invalidPasswordMinUpperCaseCharsMessage:
        "Pasahitz baliogabea: gutxienez {0} maiuskula karaktere izan behar ditu.",
    invalidPasswordMinSpecialCharsMessage:
        "Pasahitz baliogabea: gutxienez {0} karaktere berezi izan behar ditu.",
    ...
    invalidPasswordGenericMessage:
        "Pasahitz baliogabea: pasahitz berriak ez ditu pasahitz politikak betetzen.",
    ...
    standardFlowDisabledMessage:
        "Bezeroak ezin du nabigatzaileko saio hasiera abiarazi emandako response_type-rekin. Fluxu estandarra desgaituta dago bezeroaren.",
    implicitFlowDisabledMessage:
        "Bezeroak ezin du nabigatzaileko saio hasiera abiarazi emandako response_type-rekin. Fluxu inplizitua desgaituta dago bezeroaren.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Ezin izan da identitate hornitzailearentzako autentifikazio eskaerarekin jarraitu.",
    couldNotObtainTokenMessage: "Ezin izan da tokena lortu identitate hornitzailetik.",
    unexpectedErrorRetrievingTokenMessage:
        "Ustekabeko errorea tokena identitate hornitzailetik berreskuratzean.",
    unexpectedErrorHandlingResponseMessage:
        "Ustekabeko errorea identitate hornitzailearen erantzuna kudeatzean.",
    ...
    couldNotSendAuthenticationRequestMessage:
        "Ezin izan da autentifikazio eskaera bidali identitate hornitzailera.",
    unexpectedErrorHandlingRequestMessage:
        "Ustekabeko errorea identitate hornitzailearentzako autentifikazio eskaera kudeatzean.",
    ...
    cookieNotFoundMessage:
        "Saioa berriro hasteko cookie-a ez da aurkitu. Iraungi egin daiteke; ezabatu egin da edo cookieak desgaituta daude zure nabigatzailean. Cookieak desgaituta badaude gaitu itzazu. Egin klik Aplikaziora Itzuli botoian berriro saioa hasteko.",
    insufficientLevelOfAuthentication: "Eskatutako autentifikazio maila ez da bete.",
    identityProviderUnexpectedErrorMessage:
        "Ustekabeko errorea identitate hornitzailearekin autentifikatzean",
    identityProviderMissingStateMessage:
        "State parametroa falta da identitate hornitzailearen erantzunean.",
    ...
    identityProviderInvalidSignatureMessage:
        "Sinadura baliogabea identitate hornitzailearen erantzunean.",
    identityProviderNotFoundMessage:
        "Ezin izan da identitate hornitzaile bat aurkitu identifikatzailearekin.",
    identityProviderLinkSuccess:
        "Zure eposta ongi egiaztatu duzu. Mesedez itzuli zure jatorrizko nabigatzailera eta jarraitu bertan saioa hasten.",
    staleCodeMessage:
        "Orri hau ez da gehiago baliozkoa, mesedez itzuli zure aplikaziora eta hasi saioa berriro",
    ...
    identityProviderNotUniqueMessage:
        "Eremua identitate hornitzaile ugari onartzen ditu. Ezin izan da zehaztu zein identitate hornitzaile erabili behar den autentifikatzeko.",
    ...
    staleEmailVerificationLink:
        "Klikatu duzun esteka zaharkitua dago eta ez da gehiago baliozkoa. Agian zure eposta dagoeneko egiaztatu duzu.",
    ...
    identityProviderAlreadyLinkedMessage:
        "{0}-k itzulitako federatutako identitatea dagoeneko beste erabiltzaile batekin lotuta dago.",
    confirmAccountLinking: "Berretsi {1} identitate hornitzailearen {0} kontua zure kontuarekin lotzen.",
    confirmAccountLinkingBody:
        "Kontua lotzen baduzu, {1} identitate hornitzailearen {0} kontua erabiliz ere saioa hasi ahal izango duzu. Ez jarraitu prozesu hau zu ez bazara hasi edo kontua lotu nahi ez baduzu.",
    ...
    differentUserAuthenticated:
        "Dagoeneko beste erabiltzaile bat gisa '{0}' autentifikatu zara saio honetan. Mesedez amaitu saioa lehenik.",
    brokerLinkingSessionExpired:
        "Bitartekari kontua lotzeko eskaera egin da, baina oraingo saioa ez da gehiago baliozkoa.",
    ...
    "console-verify-email":
        "Zure eposta helbidea egiaztatu behar duzu. Eposta bat bidali dugu {0} helbidera egiaztapen kode bat duena. Mesedez sartu kode hau beheko sarreran.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript desgaituta dago. Gaitzea gomendatzen dugu. Egin klik beheko botoian jarraitzeko.",
    ...
    "recovery-authn-codes-help-text":
        "Sartu aurretik sortutako zerrendako berreskuratze autentifikazio kode bat.",
    ...
    "recovery-code-config-warning-title":
        "Berreskuratze kode hauek ez dira berriro agertuko orri hau utzi ondoren",
    "recovery-code-config-warning-message":
        "Ziurtatu imprimatzen, deskargatzen edo pasahitz kudeatzaile batean kopiatzen dituzula eta seguru gordetzen dituzula. Konfigurazio hau bertan behera uzten baduzu, berreskuratze kode hauek zure kontutik kenduko dira.",
    ...
    "recovery-codes-download-file-description":
        "Berreskuratze kodeak aldi bateko pasahitzak dira zure kontura sartzeko autentifikatzailera sarbiderik ez baduzu.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn ez da onartzen nabigatzaile honetan. Probatu beste bat edo jarri harremanetan zure administratzailearekin.",
    ...
    "webauthn-registration-init-label-prompt":
        "Mesedez sartu zure erregistratutako passkey-aren etiketa",
    ...
    "webauthn-error-different-user":
        "Lehenengo autentifikatutako erabiltzailea ez da Passkey-k autentifikatutakoa.",
    ...
    "passkey-unsupported-browser-text":
        "Passkey ez da onartzen nabigatzaile honetan. Probatu beste bat edo jarri harremanetan zure administratzailearekin.",
    ...
    finalDeletionConfirmation:
        "Zure kontua ezabatzen baduzu, ezin izango da berreskuratu. Zure kontua mantentzeko, egin klik Utzi botoian.",
    ...
    "error-invalid-multivalued-size":
        "{0} atributuak gutxienez {1} eta gehienez {2} {2,choice,0#balio|1#balio|1<balio} izan behar ditu.",
    ...
    emailVerificationPending:
        "Egiaztapen eposta bat bidali da {0} helbidera. Aldaketarik gabe bidali dezakezu egiaztapen eposta berriro bidaltzeko, edo sartu beste eposta helbide bat.",
    orgMemberAlready: "Dagoeneko {1} erakundeko kide zara.",
    staleInviteOrgLink:
        "Klikatu duzun esteka ez da gehiago baliozkoa. Iraungi egin daiteke edo dagoeneko erabili izan da.",
