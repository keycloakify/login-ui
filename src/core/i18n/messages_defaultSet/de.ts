...
const messages = {
    ...
    emailUpdateConfirmationSent:
        "Eine Bestätigungs-E-Mail wurde an {0} versendet. Bitte folgen Sie den Anweisungen, um die Aktualisierung der E-Mail abzuschließen.",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Der Code ist abgelaufen. Bitte versuchen Sie, Ihr Gerät erneut zu verbinden.",
    oauth2DeviceVerificationCompleteHeader: "Geräte-Login erfolgreich",
    oauth2DeviceVerificationCompleteMessage:
        "Sie können dieses Browser-Fenster schließen und auf Ihrem Gerät weiterarbeiten.",
    oauth2DeviceVerificationFailedHeader: "Geräte-Login fehlgeschlagen",
    oauth2DeviceVerificationFailedMessage:
        "Sie können dieses Browser-Fenster schließen und versuchen, Ihr Gerät erneut zu verbinden.",
    ...
    federatedIdentityUnavailableMessage:
        "Der mit dem Identitätsanbieter {1} authentifizierte Benutzer {0} ist nicht vorhanden. Bitte wenden Sie sich an Ihren Administrator.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Dem vom Identitätsanbieter ausgestellten ID-Token fehlen die passenden Claims. Bitte kontaktieren Sie Ihren Administrator.",
    ...
    nestedFirstBrokerFlowMessage: "Der {0} Benutzer {1} ist mit keinem bekannten Benutzer verknüpft.",
    ...
    configureBackupCodesMessage:
        "Sie müssen Backup Codes einrichten, um das Benutzerkonto zu aktivieren.",
    ...
    updateEmailMessage:
        "Sie müssen Ihre E-Mail-Adresse aktualisieren, um das Benutzerkonto zu aktivieren..",
    ...
    emailSendErrorMessage:
        "Die E-Mail konnte nicht versendet werden. Bitte versuchen Sie es später noch einmal.",
    ...
    insufficientLevelOfAuthentication:
        "Die angefragte Stärke des Authentifizierungsverfahrens wurde nicht erfüllt.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Fehlender code- oder error-Parameter in der Antwort vom Identitätsanbieter.",
    ...
    emailVerifiedMessageHeader: "E-Mail-Adresse verifiziert",
    emailVerifiedMessage: "Ihre E-Mail-Adresse wurde erfolgreich verifiziert.",
    emailVerifiedAlreadyMessageHeader: "E-Mail-Adresse verifiziert",
    emailVerifiedAlreadyMessage: "Ihre E-Mail-Adresse wurde bereits verifiziert.",
    staleEmailVerificationLink:
        "Der von Ihnen angeklickte Link ist nicht mehr gültig. Eventuell haben Sie Ihre E-Mail-Adresse bereits verifiziert.",
    ...
    "requiredAction.webauthn-register-passwordless":
        "Kennwortlose Authentifizierung mit WebAuthn einrichten",
    ...
    "recovery-authn-codes-display-name": "Wiederherstellungscode",
    "recovery-authn-codes-help-text":
        "Geben Sie einen Wiederherstellungscode aus einer zuvor erstellten Liste ein.",
    ...
    "recovery-code-config-warning-title":
        "Diese Wiederherstellungscodes werden nach Verlassen dieser Seite nicht mehr angezeigt",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Sie versuchen, Ihr Benutzerkonto {0} mit dem {1} Benutzerkonto {2} zu verknüpfen. Ihr Benutzerkonto ist jedoch bereits mit einem anderen {3} Benutzerkonto {4} verknüpft. Können Sie bestätigen, ob Sie die bestehende Verknüpfung durch das neue Benutzerkonto ersetzen möchten?",
    ...
    "organization.confirm-membership.title":
        "Sie sind dabei, der Organization ${kc.org.name} beizutreten",
    ...
    "requiredAction.webauthn-register": "WebAuthn einrichten",
    ...
    emailVerifySendCooldown:
        "Sie müssen {0} Sekunden warten, bevor Sie die Verifikations-E-Mail erneut senden können.",
    ...
    emailVerificationPending:
        "Eine Verifikations-E-Mail wurde an {0} gesendet. Sie können die E-Mail erneut an die gleiche Adresse senden, oder eine andere E-Mail-Adresse eingeben.",
    ...
    staleInviteOrgLink:
        "Dieser Link ist ungültig. Er ist möglicherweise abgelaufen oder wurde bereits benutzt.",
