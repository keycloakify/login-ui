...
const messages = {
    ...
    errorDeletingAccount: "Ocorreu um erro ao excluir a conta",
    ...
    kerberosNotSetUp: "O Kerberos não está configurado. Você não consegue fazer login.",
    ...
    loginTimeout: "Sua tentativa de login expirou. O processo de login será reiniciado.",
    oauthGrantTitle: "Conceder acesso a {0}",
    oauthGrantTitleHtml: "{0}",
    errorTitle: "Sentimos muito...",
    errorTitleHtml: "<strong>Sentimos</strong> muito ...",
    emailVerifyTitle: "Verificação de email",
    ...
    authenticatorCode: "Código de uso único",
    address: "Endereço",
    street: "Logradouro",
    ...
    loginTotpManualStep3:
        "Use os seguintes valores de configuração caso o aplicativo permita defini-los:",
    ...
    emailVerifyInstruction1:
        "Um email com instruções para verificar seu endereço de email foi enviado para {0}.",
    emailVerifyInstruction2: "Não recebeu um código de verificação em seu email?",
    emailVerifyInstruction3: "para reenviar o email.",
    emailLinkIdpTitle: "Vincular {0}",
    emailLinkIdp1:
        "Um email com instruções para vincular a conta {0} {1} com sua conta {2} foi enviado para você.",
    emailLinkIdp2: "Não recebeu um código de verificação no email?",
    ...
    emailInstruction:
        "Digite seu nome de usuário ou endereço de email e nós lhe enviaremos instruções sobre como criar uma nova senha.",
    ...
    "role_realm-admin": "Admininstrador do Realm",
    "role_create-realm": "Criar realm",
    "role_create-client": "Criar cliente",
    "role_view-realm": "Visualizar realm",
    ...
    "role_manage-realm": "Gerenciar realm",
    ...
    "client_realm-management": "Gerenciamento do Realm",
    ...
    invalidPasswordHistoryMessage:
        "Senha inválida: não pode ser igual a nenhuma da(s) última(s) {0} senha(s).",
    ...
    bearerOnlyMessage:
        "Aplicações do tipo bearer-only não têm permissão para iniciar login via navegador",
    standardFlowDisabledMessage:
        "O cliente não tem permissão para iniciar login via navegador com o response_type informado. O fluxo padrão está desativado para o cliente.",
    implicitFlowDisabledMessage:
        "O cliente não tem permissão para iniciar login via navegador com o response_type informado. O fluxo implícito está desabilitado para o cliente.",
    ...
    identityProviderLinkSuccess:
        "Você verificou seu email com sucesso. Por favor, retorne à aba original e continue com o login.",
    staleCodeMessage:
        "Esta página não é mais válida. Por favor, volte à aplicação e faça login novamente",
    realmSupportsNoCredentialsMessage: "O realm não suporta nenhum tipo de credencial.",
    ...
    identityProviderNotUniqueMessage:
        "O realm suporta múltiplos provedores de identidade. Não foi possível determinar qual o provedor de identidade deve ser usado para autenticação.",
    emailVerifiedMessage: "O seu endereço de email foi confirmado.",
    staleEmailVerificationLink:
        "O link em que você clicou é um link antigo e não é mais válido. Talvez você já tenha confirmado o seu email.",
    identityProviderAlreadyLinkedMessage:
        "A conta federada retornada por {0} já está vinculada a outro usuário.",
    ...
    brokerLinkingSessionExpired:
        "Solicitada vinculação de conta via intermediário, mas a sessão atual não é mais válida.",
    ...
    "console-verify-email":
        "Você precisa verificar seu endereço de email. Enviamos um email para {0} contendo um código de verificação. Por favor, insira esse código no campo abaixo.",
    ...
    "saml.post-form.js-disabled":
        "O JavaScript está desativado. Recomendamos fortemente que o ative. Clique no botão abaixo para continuar.",
    ...
    "webauthn-error-different-user":
        "A primeira pessoa autenticada não é a mesma autenticada pela chave de segurança.",
    "webauthn-error-auth-verification":
        "O resultado da autenticação com chave de segurança é inválido. {0}",
    "webauthn-error-register-verification":
        "O resultado do registro de chave de segurança é inválido. {0}",
    ...
    finalDeletionConfirmation:
        "Se você excluir a sua conta, ela não poderá ser recuperada. Para manter a sua conta, clique em Cancelar.",
    ...
    readOnlyUsernameMessage:
        "Você não pode atualizar o seu nome de usuário, pois ele é somente leitura.",
    ...
    "error-invalid-multivalued-size":
        "O atributo {0} deve ter no mínimo {1} e no máximo {2} {2,choice,0#values|1#value|1<values}.",
    linkIdpActionTitle: "Associando {0}",
    linkIdpActionMessage: "Deseja vincular sua conta ao {0}?",
    showPassword: "Exibir senha",
    oauth2DeviceVerificationTitle: "Login por dispositivo",
    oauth2DeviceInvalidUserCodeMessage: "Código inválido, por favor, tente novamente.",
    oauth2DeviceExpiredUserCodeMessage:
        "O código expirou. Por favor, volte ao seu dispositivo e tente conectar novamente.",
    oauth2DeviceVerificationCompleteMessage:
        "Você pode fechar esta janela do navegador e voltar ao seu dispositivo.",
    oauth2DeviceVerificationFailedHeader: "Falha no login por dispositivo",
    ...
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "O cliente não tem permissão para iniciar o fluxo de concessão de autorização de dispositivo do OAuth 2.0. O fluxo está desabilitado para o cliente.",
    emailVerifySend: "Enviar email de verificação",
    emailInstructionUsername:
        "Digite seu nome de usuário e enviaremos instruções sobre como criar uma nova senha.",
    identityProviderLogoutFailure: "Falha no logout do IdP SAML",
    "error-invalid-length-too-short": "Tamanho mínimo é {1}.",
    "error-invalid-length-too-long": "O tamanho máximo é {2}.",
    "error-number-out-of-range": "O número deve estar entre {1} e {2}.",
    "error-number-out-of-range-too-small": "O número precisa ter um valor mínimo de {1}.",
    "error-number-out-of-range-too-big": "Número precisa ter um valor máximo de {2}.",
    confirmOverrideIdpContinue: "Sim, substituir o vínculo pela conta atual",
    configureBackupCodesMessage: "Você precisa configurar códigos de backup para ativar sua conta.",
    identityProviderMissingCodeOrErrorMessage:
        "Faltando parâmetro de código ou de erro na resposta do provedor de identidade.",
    ...
    identityProviderInvalidSignatureMessage:
        "Assinatura inválida na resposta do provedor de identidade.",
    emailVerifiedAlreadyMessage: "Seu endereço de email já foi verificado.",
    acrNotFulfilled: "Requisitos de autenticação não atendidos",
    "requiredAction.webauthn-register-passwordless": "Registro WebAuthn sem senha",
    "recovery-code-config-header": "Códigos de Autenticação de Recuperação",
    "organization.confirm-membership.title":
        "Você está prestes a se juntar à organização ${kc.org.name}",
    "organization.member.register.title": "Crie uma conta para se juntar à organização ${kc.org.name}",
    authenticateStrong: "Autenticação forte necessária para continuar",
    ...
    emailUpdateConfirmationSent:
        "Um email de confirmação foi enviado para {0}. Você deve seguir as instruções dele para concluir a atualização do email.",
    emailUpdatedTitle: "Email atualizado",
    emailUpdated: "A conta de email foi atualizado com sucesso para {0}.",
    usb: "USB",
    nfc: "NFC",
    bluetooth: "Bluetooth",
    internal: "Interna",
    unknown: "Desconhecido",
    termsAcceptanceRequired: "Você deve concordar com nossos termos e condições.",
    acceptTerms: "Eu concordo com os termos e condições",
    deleteCredentialTitle: "Excluir {0}",
    deleteCredentialMessage: "Você quer excluir {0}?",
    totpAppFreeOTPName: "FreeOTP",
    totpAppGoogleName: "Google Authenticator",
    totpAppMicrosoftAuthenticatorName: "Microsoft Authenticator",
    emailVerifyResend: "Reenviar email de verificação",
    sessionLimitExceeded: "Há sessões demais",
    "error-invalid-length": "Tamanho deve estar entre {1} e {2}.",
    "error-invalid-date": "Data inválida.",
    "error-user-attribute-read-only": "O campo é somente leitura.",
    "error-username-invalid-character": "Valor contém caractere inválido.",
    "error-reset-otp-missing-id": "Por favor, escolha uma configuração de OTP.",
    "error-user-attribute-required": "Por favor, informe este campo.",
    "error-person-name-invalid-character": "Valor contém caractere inválido.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "O token de ID emitido pelo provedor de identidade não corresponde ao claim essencial configurado. Por favor, contate seu administrador.",
    confirmOverrideIdpTitle: "Vínculo com o intermediário já existe",
    federatedIdentityConfirmOverrideMessage:
        "Você está tentando vincular sua conta {0} com a conta {1} {2}. Mas sua conta já está vinculada a uma conta {3} diferente: {4}. Você pode confirmar se deseja substituir o vínculo existente pela nova conta?",
    updateEmailMessage: "Você precisa atualizar o seu endereço de email para ativar sua conta.",
    successLogout: "Você saiu da sessão",
    insufficientLevelOfAuthentication: "O nível de autenticação solicitado não foi atendido.",
    "requiredAction.webauthn-register": "Registro WebAuthn",
    "recovery-codes-download-file-header":
        "Mantenha esses códigos de recuperação em algum lugar seguro.",
    "recovery-codes-download-file-date": "Esses códigos foram gerados em",
    "passkey-doAuthenticate": "Entrar com chave de acesso",
    "passkey-login-title": "Login com Chave de Segurança",
    "passkey-available-authenticators": "Chaves de segurança disponíveis",
    ...
    oauthGrantInformation:
        "Certifique-se de que você confia em {0} aprendendo como {0} irá tratar seus dados.",
    emailVerifyInstruction4:
        "Para verificar seu endereço de email, iremos enviar um email com instruções para o endereço {0}.",
    oauth2DeviceVerificationFailedMessage:
        "Você pode fechar esta janela do navegador, voltar ao seu dispositivo e tentar conectar novamente.",
    oauthGrantReview: "Você pode revisar a",
    oauth2DeviceVerificationCompleteHeader: "Login por dispositivo bem-sucedido",
    emailUpdateConfirmationSentTitle: "Email de confirmação enviado",
    verifyOAuth2DeviceUserCode: "Digite o código fornecido pelo seu dispositivo e clique em Enviar",
    reauthenticate: "Por favor, reautentique-se para continuar",
    hidePassword: "Ocultar senha",
    cookieNotFoundMessage:
        'Cookie de reinício de login não encontrado. Ele pode ter expirado, ter sido excluído ou os cookies podem estar desativados em seu navegador. Se os cookies estiverem desativados, ative-os. Clique em "Voltar para a aplicação" para fazer login novamente.',
    "idp-email-verification-display-name": "Verificação de email",
    "organization.confirm-membership":
        "Ao clicar no link abaixo, você se tornará membro da organização {0}:",
    notMemberOfOrganization: "O usuário não é um membro da organização {0}",
    "recovery-codes-download-file-description":
        "Os códigos de recuperação são códigos de uso único que permitem que você faça login na sua conta caso não tenha acesso ao seu autenticador.",
    "idp-username-password-form-display-name": "Nome de usuário e senha",
    "webauthn-registration-init-label-prompt":
        "Por favor, digite o rótulo da sua chave de segurança registrada",
    notMemberOfAnyOrganization: "O usuário não é membro de nenhuma organização",
    "passkey-autofill-select": "Selecione sua chave de segurança",
    "recovery-codes-label-default": "Códigos de recuperação",
    "webauthn-registration-init-label": "Chave de Segurança (Rótulo Padrão)",
    "passkey-unsupported-browser-text":
        "A chave de segurança não é suportada por este navegador. Tente outra ou contate o seu administrador.",
    "webauthn-doAuthenticate": "Entrar com chave de segurança",
    "idp-email-verification-help-text": "Vincule a sua conta validando o seu email.",
    ...
    "auth-x509-client-username-form-help-text": "Entre com um certificado de cliente X509.",
    "recovery-authn-codes-display-name": "Código de autenticação de recuperação",
    "recovery-authn-codes-help-text":
        "Digite um código de autenticação de recuperação de uma lista gerada anteriormente.",
    "auth-recovery-code-prompt": "Código de recuperação #{0}",
    "auth-recovery-code-header": "Entre com um código de autenticação de recuperação",
    "recovery-codes-error-invalid": "Código de autenticação de recuperação inválido",
    invalidTokenRequiredActions: "As ações obrigatórias incluídas no link não são válidas",
    "otp-reset-description": "Qual configuração de OTP deve ser removida?",
    "auth-recovery-code-info-message": "Informe o código de recuperação especificado.",
    "recovery-code-config-warning-title":
        "Esses códigos de recuperação não serão exibidos novamente após sair desta página",
    "recovery-codes-action-complete": "Completar configuração",
    "recovery-codes-action-cancel": "Cancelar configuração",
    "recovery-codes-confirmation-message": "Salvei esses códigos em um local seguro",
    "recovery-code-config-warning-message":
        "Certifique-se de imprimir, baixar ou copiá-los para um gerenciador de senhas e mantê-los em segurança. Cancelar esta configuração removerá esses códigos de recuperação da sua conta.",
    ...
    emailVerifiedMessageHeader: "Endereço de email verificado",
    emailVerifiedAlreadyMessageHeader: "Endereço de email verificado",
    confirmEmailAddressVerificationHeader: "Validação de email",
    "requiredAction.delete_account": "Excluir conta",
    "requiredAction.UPDATE_EMAIL": "Atualizar email",
    "requiredAction.VERIFY_PROFILE": "Verificar Perfil",
    "requiredAction.delete_credential": "Excluir Credencial",
    "requiredAction.update_user_locale": "Atualizar localidade do usuário",
    "code-clipboard-label": "Mostrar conteúdo",
    "code-copy-label": "Copiar para a área de transferência",
    "code-copy-success": "Código copiado para a área de transferência",
    "code-copy-failure": "Falha ao copiar o código para a área de transferência",
    confirmAccountLinkingBody:
        "Se você vincular a conta, também poderá fazer login usando a conta {0} do provedor de identidade {1}. Não prossiga se você não iniciou este processo ou se você não deseja vincular a conta.",
    "requiredAction.idp_link": "Vinculando Provedor de Identidade",
    emailVerificationPending:
        "Um email de verificação foi enviado para {0}. Você pode reenviar o email de verificação ou inserir um endereço de email diferente.",
