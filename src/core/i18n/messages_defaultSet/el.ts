...
const messages = {
    ...
    "deletingAccountForbidden":
        "Δεν έχετε το δικαίωμα να διαγράψετε τον λογαριασμό σας, επικοινωνήστε με τον διαχειριστή.",
    ...
    "bypassKerberosDetail":
        "Είτε δεν έχετε συνδεθεί μέσω Kerberos ή ο περιηγητής σας δεν έχει ρυθμιστεί για είσοδο με Kerberos.  Πατήστε για να συνεχίσετε την είσοδο με άλλες μεθόδους",
    ...
    "oauthGrantInformation":
        "Βεβαιωθείτε ότι εμπιστεύεστε το {0} μαθαίνοντας πως το {0} θα χειρίζεται τα δεδομένα σας.",
    ...
    "emailUpdateConfirmationSent":
        "Ένα email επιβεβαίωσης στάλθηκε στο {0}. Ακολουθήστε τις οδηγίες εκεί, ώστε να ολοκληρώσετε την ενημέρωση του email.",
    ...
    "loginTotpIntro":
        "Πρέπει να ορίσετε μια γεννήτρια Κωδικών Μίας Χρήσης για να έχετε πρόσβαση στο λογαριασμό",
    ...
    "loginTotpStep3":
        "Εισάγετε το κωδικό μίας-χρήσης όπως παρέχεται από την εφαρμογή και πατήστε το Υποβολή για να ολοκληρώσετε.",
    ...
    "verifyOAuth2DeviceUserCode":
        "Εισάγετε τον κωδικό που παρέχεται από την συσκευή και πατήστε Υποβολή",
    "oauth2DeviceInvalidUserCodeMessage": "Άκυρος κωδικός, παρακαλώ προσπαθήστε ξανά.",
    "oauth2DeviceExpiredUserCodeMessage":
        "Ο κωδικός έχει λήξει. Παρακαλώ πηγαίνετε πίσω στη συσκευή σας και προσπαθήστε να συνδεθείτε ξανά.",
    "oauth2DeviceVerificationCompleteHeader": "Επιτυχής σύνδεση συσκευής",
    "oauth2DeviceVerificationCompleteMessage":
        "Μπορείτε να κλείσετε το παράθυρο του browser και να επιστρέψετε στη συσκευή σας.",
    "oauth2DeviceVerificationFailedHeader": "Η σύνδεση της συσκευής απέτυχε",
    "oauth2DeviceVerificationFailedMessage":
        "Μπορείτε να κλείσετε αυτόν τον περιηγητή και να πάτε πίσω στη συσκευή σας και να πρσπαθήσετε να συνδεθείτε ξανά.",
    ...
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "Ο πελάτης δεν επιτρέπεται να ξεκινήσει το OAuth 2.0 για τη χορήγηση εξουσιοδότησης της συσκευής. Αυτή η ροή είναι απενεργοποιημένη για τον πελάτη.",
    "emailVerifyInstruction1":
        "Σας στάλθηκε ένα email με οδηγίες για το πως να επιβεβαιώσετε τη διεύθυνση σας {0}.",
    ...
    "emailLinkIdp1":
        "Στάλθηκε ένα email με οδηγίες για να συνδέσετε το {0} λογαριασμό {1} με το {2} λογαριασμό.",
    ...
    "emailInstruction":
        "Εισάγετε το όνομα χρήστη ή τη διεύθυνση email και θα σας σταλούν οδηγίες για το πως να δημιουργήσετε ένα νέο κωδικό.",
    "emailInstructionUsername":
        "Εισάγετε το όνομα χρήστη και θα σας σταλούν οδηγίες για το πως να δημιουργήσετε ένα νέο κωδικό.",
    ...
    "accountTemporarilyDisabledMessage":
        "Ο λογαριασμός έχει απενεργοποιηθεί προσωρινά, επικοινωνήστε με το διαχειριστή ή δοκιμάστε αργότερα.",
    ...
    "federatedIdentityExistsMessage":
        "Ο χρήστης με {0} {1} υπάρχει ήδη. Παρακαλώ συνδεθείτε στη διαχείριση λογαριασμού για να συνδέσετε το λογαριασμό.",
    "federatedIdentityUnavailableMessage":
        "Δεν υπάρχει ο χρήστης {0} που συνδέθηκε με το πάροχο ταυτότητας {1} . Επικοινωνήστε με το διαχειριστή.",
    ...
    "federatedIdentityConfirmReauthenticateMessage":
        "Αυθεντικοποίηση για σύνδεση του λογαριασμού σας με το {0}",
    ...
    "configureTotpMessage":
        "Ρυθμίστε μια Εφαρμογή Ταυτοποίησης στο κινητό σας για να ενεργοποιήσετε το λογαριασμό.",
    "configureBackupCodesMessage":
        "Πρέπει να ορίσετε Κωδικούς Ασφαλείας για να ενεργοποιήσετε το λογαριασμό σας.",
    "updateProfileMessage":
        "Πρέπει να ενημερώσετε το προφίλ χρήστη σας για να ενεργοποιήσετε το λογαριασμό σας.",
    "updatePasswordMessage":
        "Πρέπει να αλλάξετε το κωδικό πρόσβασης για να ενεργοποιήσετε το λογαριασμό σας.",
    ...
    "verifyEmailMessage":
        "Πρέπει να επιβεβαιώσετε το email σας για να ενεργοποιήσετε το λογαριασμό σας.",
    "linkIdpMessage":
        "Πρέπει να επιβεβαιώσετε το email σας για να συνδέσετε το λογαριασμό σας με το {0}.",
    ...
    "delegationCompleteMessage":
        "Μπορείτε να κλείστε αυτό το παράθυρο του browser και να επιστρέψετε στην εφαρμογή κονσόλας.",
    "delegationFailedHeader": "Αποτυχία Εισόδου",
    "delegationFailedMessage":
        "Μπορείτε να κλείσετε αυτό το παράθυρο και να επιστρέψετε στην εφαρμογή κονσόλας σας και να δοκιμάσετε να μπείτε ξανά.",
    ...
    "invalidPasswordMinDigitsMessage":
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να περιέχει τουλάχιστον {0} ψηφία.",
    ...
    "invalidPasswordMinUpperCaseCharsMessage":
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να περιέχει τουλάχιστον {0} κεφαλαίους χαρακτήρες.",
    "invalidPasswordMinSpecialCharsMessage":
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να περιέχει τουλάχιστον {0} ειδικούς χαρακτήρες.",
    "invalidPasswordNotUsernameMessage":
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να μην είναι ίσο με το όνομα χρήστη.",
    "invalidPasswordNotEmailMessage":
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να μην είναι ίσο με το email.",
    "invalidPasswordRegexPatternMessage":
        "Μη έγκυρος κωδικός πρόσβασης: δε ταιριάζει με τα μοτίβα regex.",
    "invalidPasswordHistoryMessage":
        "Μη έγκυρος κωδικός πρόσβασης: δε πρέπει να είναι το ίδιο με τους τελευταίους {0} κωδικούς.",
    "invalidPasswordGenericMessage":
        "Μη έγκυρος κωδικός πρόσβασης: ο νέος κωδικός δε συμφωνεί με τις πολιτικές κωδικών.",
    ...
    "bearerOnlyMessage":
        "Εφαρμογές τύπου Bearer-only δεν επιτρέπονται να εκκινήσουν είσοδο μέσω browser",
    "standardFlowDisabledMessage":
        "Ο πελάτης δεν επιτρέπεται να ξεκινά είσοδο μέσω browser με το δοθέν response_type. Η πρότυπη ροή έχει απενεργοποιηθεί για αυτό το πελάτη.",
    "implicitFlowDisabledMessage":
        "Ο πελάτης δεν επιτρέπεται να ξεκινά είσοδο μέσω browser με το δοθέν response_type. Η έμμεση ροή έχει απενεργοποιηθεί για αυτό το πελάτη.",
    ...
    "noRelayStateInResponseMessage":
        "Δεν υπάρχει κατάσταση μεταβίβασης στην απάντηση από το πάροχο ταυτότητας.",
    ...
    "couldNotProceedWithAuthenticationRequestMessage":
        "Αδυναμία ολοκλήρωσης του ελέγχου ταυτότητας στο πάροχο ταυτότητας.",
    "couldNotObtainTokenMessage": "Αδυναμία απόκτησης διακριτικού από το πάροχο ταυτότητας.",
    "unexpectedErrorRetrievingTokenMessage":
        "Απρόσμενο σφάλμα κατά την απόκτηση διακριτικού από το πάροχο ταυτότητας.",
    "unexpectedErrorHandlingResponseMessage":
        "Απρόσμενο σφάλμα κατά το χειρισμό της απάντησης από το πάροχο ταυτότητας.",
    "identityProviderAuthenticationFailedMessage":
        "Η ταυτοποίηση απέτυχε. Αδυναμία ελέγχου της ταυτότητας με το πάροχο ταυτότητας.",
    "couldNotSendAuthenticationRequestMessage":
        "Αδυναμία αποστολής του αιτήματος ελέγχου ταυτότητας στο πάροχο ταυτότητας.",
    "unexpectedErrorHandlingRequestMessage":
        "Απρόσμενο σφάλμα κατά το χειρισμό του αιτήματος ταυτοποποίησης στο πάροχο ταυτότητας.",
    ...
    "cookieNotFoundMessage":
        "Δε βρέθηκε το cookie. Παρακαλώ βεβαιωθείτε ότι τα cookies είναι ενεργά στο browser σας.",
    ...
    "identityProviderUnexpectedErrorMessage":
        "Απρόσμενο σφάλμα κατά τη ταυτοποίηση με το πάροχο ταυτότητας",
    "identityProviderMissingStateMessage":
        "Λείπει η παράμετρος state από την απάντηση του παρόχου ταυτότητας.",
    ...
    "identityProviderInvalidSignatureMessage":
        "Μη έγκυρη υπογραφή στην απάντηση από το πάροχο ταυτότητας.",
    "identityProviderNotFoundMessage": "Αδυναμία εύρεσης ενός παρόχου ταυτότητας με το αναγνωριστικό.",
    "identityProviderLinkSuccess":
        "Επιβεβαιώσατε το email σας επιτυχώς. Παρακαλώ επιστρέψτε στο αρχικό browser και συνεχίστε εκεί την είσοδο.",
    "staleCodeMessage":
        "Αυτή η σελίδα δεν είναι πια έγκυρη, παρακαλώ επιστρέψτε στην εφαρμογή σας και συνδεθείτε ξανά",
    ...
    "identityProviderNotUniqueMessage":
        "Ο τομέας υποστηρίζει πολλαπλούς παρόχους ταυτότητας. Αδυναμία επιλογής του παρόχου ταυτότητας που θα χρησιμοποιηθεί για τη ταυτοποίηση.",
    "emailVerifiedMessage": "Η διεύθυνση email σας έχει επιβεβαιωθεί.",
    "staleEmailVerificationLink":
        "Ο σύνδεσμός που πατήσατε είναι παλιός και δεν είναι έγκυρος πια. Ίσως έχετε ήδη επιβεβαιώσει το email σας.",
    "identityProviderAlreadyLinkedMessage":
        "Η ομόσπονδη ταυτότητα που επιστρέφει το {0} είναι ήδη συνδεδεμένη με ένα άλλο χρήστη.",
    "confirmAccountLinking":
        "Επιβεβαιώστε τη σύνδεση του λογαριασμού {0} στο πάροχο ταυτότητας {1} με το λογαριασμό σας.",
    ...
    "differentUserAuthenticated":
        "Έχετε ήδη ταυτοποιηθεί σε αυτή τη συνεδρία ως ο άλλος χρήστης '{0}'. Παρακαλώ πρώτα να αποσυνδεθείτε.",
    "brokerLinkingSessionExpired":
        "Αιτήθηκε σύνδεση με λογαριασμό μεσολαβητή, αλλά η τρέχουσα συνεδρία δεν είναι πια έγκυρη.",
    ...
    "invalidTokenRequiredActions":
        "Οι απαιτούμενες ενέργειες που περιλαμβάνονται σε αυτό το σύνδεσμο δεν είναι έγκυρες",
    ...
    "console-verify-email":
        "Πρέπει να επιβεβαιώσετε την διεύθυνση email σας.  Στάλθηκε ένα email στο {0} το οποίο περιέχει ένα κωδικό επιβεβαίωσης.  Παρακαλώ εισάγετε το κωδικό στο παρακάτω πεδίο.",
    ...
    "saml.post-form.js-disabled":
        "Έχει απενεργοποιηθεί η JavaScript. Συνιστούμε να την ενεργοποιήσετε. Πατήστε το κουμπί παρακάτω για να συνεχίσετε. ",
    ...
    "auth-username-password-form-help-text":
        "Συνδεθείτε με το όνομα χρήστη και το κωδικό πρόσβασης σας.",
    "auth-recovery-authn-code-form-display-name": "Κωδικός Ανάκτησης Ταυτοποίησης",
    "auth-recovery-authn-code-form-help-text":
        "Δώστε ένα κωδικό ανάκτησης ταυτοποίησης από μια προϋπάρχουσα λίστα.",
    ...
    "recovery-code-config-warning-title":
        "Αυτοί οι κωδικοί ανάκτησης δεν θα είναι πια ορατή μετά που θα βγείτε από τη σελίδα",
    "recovery-code-config-warning-message":
        "Βεβαιωθείτε ότι τους εκτυπώσατε, κατεβάσατε ή αντιγράψατε στο διαχειριστή κωδικών σας με ασφάλεια. Η ακύρωση αυτής της διαδικασίας θα αφαιρέσει αυτούς του κωδικούς ανάκτησης από το λογαριασμό σας.",
    ...
    "recovery-codes-download-file-description":
        "Οι κωδικοί ανάκτησης είναι μυστικά μίας χρήσης που επιτρέπουν να συνδεθείτε στο λογαριασμό αν δεν έχετε πρόσβαση στην εφαρμογή ταυτοποίησης.",
    ...
    "webauthn-passwordless-help-text":
        "Χρήση του κλειδιού ασφαλείας για σύνδεση χωρίς κωδικό πρόσβασης.",
    ...
    "webauthn-unsupported-browser-text":
        "Το WebAuthn δεν υποστηρίζεται από αυτό το browser. Δοκιμάστε κάποιον άλλο ή επικοινωνήστε με το διαχειριστή.",
    ...
    "webauthn-error-different-user":
        "Ο αρχικός ταυτοποιημένος χρήστης δεν είναι ο ίδιος με αυτό που ταυτοποιήθηκε με το Κλειδί ασφαλείας.",
    "webauthn-error-auth-verification":
        "Μη έγκυρο αποτέλεσμα ταυτοποίησης του Κλειδιού ασφαλείας.<br/> {0}",
    "webauthn-error-register-verification":
        "Μη έγκυρο αποτέλεσμα εγγραφής του Κλειδιού ασφαλείας.<br/> {0}",
    ...
    "finalDeletionConfirmation":
        "Αν διαγράψετε το λογαριασμό σας, η ανάκτηση θα είναι αδύνατη. Για να παραμείνει, πατήστε Ακύρωση.",
    ...
    "accountUnusable":
        "Κάθε μεταγενέστερη χρήση αυτής της εφαρμογής δεν θα είναι δυνατή με αυτό το λογαριασμό",
    ...
    "readOnlyUsernameMessage":
        "Δε μπορείτε να ενημερώσετε το όνομα χρήστη σας καθώς είναι μόνο-για-ανάγνωση.",
