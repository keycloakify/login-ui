...
const messages = {
    ...
    termsAcceptanceRequired: "Πρέπει να αποδεχτείτε τους όρους και τις προϋποθέσεις μας.",
    acceptTerms: "Συμφωνώ με τους όρους και τις προϋποθέσεις",
    ...
    loginTotpIntro:
        "Πρέπει να ορίσετε μια γεννήτρια Κωδικών Μίας Χρήσης για να έχετε πρόσβαση στον λογαριασμό",
    ...
    loginTotpStep3:
        "Εισάγετε τον κωδικό μίας-χρήσης όπως παρέχεται από την εφαρμογή και πατήστε το Υποβολή για να ολοκληρώσετε.",
    ...
    federatedIdentityExistsMessage:
        "Ο χρήστης με {0} {1} υπάρχει ήδη. Παρακαλώ συνδεθείτε στη διαχείριση λογαριασμού για να συνδέσετε τον λογαριασμό.",
    federatedIdentityUnavailableMessage:
        "Δεν υπάρχει ο χρήστης {0} που συνδέθηκε με τον πάροχο ταυτότητας {1} . Επικοινωνήστε με τον διαχειριστή.",
    ...
    configureTotpMessage:
        "Ρυθμίστε μια Εφαρμογή Ταυτοποίησης στο κινητό σας για να ενεργοποιήσετε τον λογαριασμό.",
    configureBackupCodesMessage:
        "Πρέπει να ορίσετε Κωδικούς Ασφαλείας για να ενεργοποιήσετε τον λογαριασμό σας.",
    updateProfileMessage:
        "Πρέπει να ενημερώσετε το προφίλ χρήστη σας για να ενεργοποιήσετε τον λογαριασμό σας.",
    updatePasswordMessage:
        "Πρέπει να αλλάξετε τον κωδικό πρόσβασης για να ενεργοποιήσετε τον λογαριασμό σας.",
    ...
    linkIdpMessage:
        "Πρέπει να επιβεβαιώσετε το email σας για να συνδέσετε τον λογαριασμό σας με το {0}.",
    ...
    invalidPasswordNotUsernameMessage:
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να μην είναι ίδιος με το όνομα χρήστη.",
    invalidPasswordNotEmailMessage:
        "Μη έγκυρος κωδικός πρόσβασης: πρέπει να μην είναι ίδιος με το email.",
    invalidPasswordRegexPatternMessage:
        "Μη έγκυρος κωδικός πρόσβασης: δεν ταιριάζει με τα μοτίβα regex.",
    invalidPasswordHistoryMessage:
        "Μη έγκυρος κωδικός πρόσβασης: δεν πρέπει να είναι ο ίδιος με τους τελευταίους {0} κωδικούς.",
    ...
    standardFlowDisabledMessage:
        "Ο πελάτης δεν επιτρέπεται να ξεκινά είσοδο μέσω browser με το δοθέν response_type. Η πρότυπη ροή έχει απενεργοποιηθεί για αυτόν τον πελάτη.",
    implicitFlowDisabledMessage:
        "Ο πελάτης δεν επιτρέπεται να ξεκινά είσοδο μέσω browser με το δοθέν response_type. Η έμμεση ροή έχει απενεργοποιηθεί για αυτόν τον πελάτη.",
    ...
    noRelayStateInResponseMessage:
        "Δεν υπάρχει κατάσταση μεταβίβασης στην απάντηση από τον πάροχο ταυτότητας.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Αδυναμία ολοκλήρωσης του ελέγχου ταυτότητας στον πάροχο ταυτότητας.",
    couldNotObtainTokenMessage: "Αδυναμία απόκτησης διακριτικού από τον πάροχο ταυτότητας.",
    unexpectedErrorRetrievingTokenMessage:
        "Απρόσμενο σφάλμα κατά την απόκτηση διακριτικού από τον πάροχο ταυτότητας.",
    unexpectedErrorHandlingResponseMessage:
        "Απρόσμενο σφάλμα κατά τον χειρισμό της απάντησης από τον πάροχο ταυτότητας.",
    identityProviderAuthenticationFailedMessage:
        "Η ταυτοποίηση απέτυχε. Αδυναμία ελέγχου της ταυτότητας με τον πάροχο ταυτότητας.",
    couldNotSendAuthenticationRequestMessage:
        "Αδυναμία αποστολής του αιτήματος ελέγχου ταυτότητας στον πάροχο ταυτότητας.",
    unexpectedErrorHandlingRequestMessage:
        "Απρόσμενο σφάλμα κατά τον χειρισμό του αιτήματος ταυτοποποίησης στον πάροχο ταυτότητας.",
    ...
    cookieNotFoundMessage:
        "Δε βρέθηκε το cookie. Παρακαλώ βεβαιωθείτε ότι τα cookies είναι ενεργά στον browser σας.",
    ...
    identityProviderUnexpectedErrorMessage:
        "Απρόσμενο σφάλμα κατά την ταυτοποίηση με τον πάροχο ταυτότητας",
    ...
    identityProviderInvalidSignatureMessage:
        "Μη έγκυρη υπογραφή στην απάντηση από τον πάροχο ταυτότητας.",
    identityProviderNotFoundMessage: "Αδυναμία εύρεσης ενός παρόχου ταυτότητας με το αναγνωριστικό.",
    identityProviderLinkSuccess:
        "Επιβεβαιώσατε το email σας επιτυχώς. Παρακαλώ επιστρέψτε στον αρχικό browser και συνεχίστε εκεί την είσοδο.",
    staleCodeMessage:
    ...
    identityProviderNotUniqueMessage:
        "Ο τομέας υποστηρίζει πολλαπλούς παρόχους ταυτότητας. Αδυναμία επιλογής του παρόχου ταυτότητας που θα χρησιμοποιηθεί για την ταυτοποίηση.",
    emailVerifiedMessage: "Η διεύθυνση email σας έχει επιβεβαιωθεί.",
    staleEmailVerificationLink:
        "Ο σύνδεσμος που πατήσατε είναι παλιός και δεν είναι έγκυρος πια. Ίσως έχετε ήδη επιβεβαιώσει το email σας.",
    identityProviderAlreadyLinkedMessage:
        "Η ομόσπονδη ταυτότητα που επιστρέφει το {0} είναι ήδη συνδεδεμένη με έναν άλλον χρήστη.",
    confirmAccountLinking:
        "Επιβεβαιώστε τη σύνδεση του λογαριασμού {0} στον πάροχο ταυτότητας {1} με τον λογαριασμό σας.",
    ...
    invalidTokenRequiredActions:
        "Οι απαιτούμενες ενέργειες που περιλαμβάνονται σε αυτόν τον σύνδεσμο δεν είναι έγκυρες",
    ...
    "console-verify-email":
        "Πρέπει να επιβεβαιώσετε τη διεύθυνση email σας.  Στάλθηκε ένα email στο {0} το οποίο περιέχει έναν κωδικό επιβεβαίωσης.  Παρακαλώ εισάγετε τον κωδικό στο παρακάτω πεδίο.",
    ...
    "auth-username-password-form-help-text":
        "Συνδεθείτε με το όνομα χρήστη και τον κωδικό πρόσβασής σας.",
    "recovery-authn-codes-display-name": "Κωδικός Ανάκτησης Ταυτοποίησης",
    "recovery-authn-codes-help-text":
        "Δώστε έναν κωδικό ανάκτησης ταυτοποίησης από μια προϋπάρχουσα λίστα.",
    ...
    "recovery-code-config-warning-title":
        "Αυτοί οι κωδικοί ανάκτησης δε θα είναι πια ορατοί αφότου βγείτε από τη σελίδα",
    "recovery-code-config-warning-message":
        "Βεβαιωθείτε ότι τους εκτυπώσατε, κατεβάσατε ή αντιγράψατε στον διαχειριστή κωδικών σας με ασφάλεια. Η ακύρωση αυτής της διαδικασίας θα αφαιρέσει αυτούς του κωδικούς ανάκτησης από τον λογαριασμό σας.",
    ...
    "recovery-codes-download-file-description":
        "Οι κωδικοί ανάκτησης είναι μυστικά μίας χρήσης που επιτρέπουν να συνδεθείτε στον λογαριασμό αν δεν έχετε πρόσβαση στην εφαρμογή ταυτοποίησης.",
    ...
    "webauthn-unsupported-browser-text":
        "Το WebAuthn δεν υποστηρίζεται από αυτόν τον browser. Δοκιμάστε κάποιον άλλον ή επικοινωνήστε με τον διαχειριστή.",
    ...
    "webauthn-error-different-user":
        "Ο αρχικός ταυτοποιημένος χρήστης δεν είναι ο ίδιος με αυτόν που ταυτοποιήθηκε με το Κλειδί ασφαλείας.",
    ...
    finalDeletionConfirmation:
        "Αν διαγράψετε τον λογαριασμό σας, η ανάκτηση θα είναι αδύνατη. Για να παραμείνει, πατήστε Ακύρωση.",
    ...
    accountUnusable:
        "Κάθε μεταγενέστερη χρήση αυτής της εφαρμογής δε θα είναι δυνατή με αυτόν τον λογαριασμό",
    ...
    readOnlyUsernameMessage:
        "Δεν μπορείτε να ενημερώσετε το όνομα χρήστη σας καθώς είναι μόνο-για-ανάγνωση.",
