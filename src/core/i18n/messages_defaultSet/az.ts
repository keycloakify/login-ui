...
const messages = {
    ...
    deletingAccountForbidden:
        "Öz hesabınızı silmək üçün kifayət qədər icazəniz yoxdur, administrator ilə əlaqə saxlayın.",
    ...
    bypassKerberosDetail:
        "Ya Kerberos ilə daxil olmamısınız, ya da brauzeriniz Kerberos ilə daxil olmağa uyğun deyil. Zəhmət olmasa, digər yollardan daxil olmaq üçün davam et düyməsini klikləyin.",
    ...
    oauthGrantInformation:
        "Əmin olun ki, {0}-a güvəndiyinizə əmin olun, onun məlumatlarınızla necə işləyəcəyini öyrənərək.",
    ...
    emailUpdateConfirmationSent:
        "Təstiqləmə e-poçtu {0}-a göndərilib. E-poçtun yenilənməsini tamamlaymaq üçün əvvəlki təlimatlara əməl etməlisiniz.",
    ...
    loginTotpStep3:
        "Tətbiq tərəfindən təqdim olunan birdəfəlik kodu daxil edin və quraşdırmanı tamamladıqda Göndər düyməsinə klikləyin.",
    loginTotpStep3DeviceName:
        "OTP cihazlarınızı idarə etməyə kömək etmək üçün bir cihaz adı təqdim edin.",
    loginTotpManualStep2: "Proqramı açın və açarı daxil edin:",
    loginTotpManualStep3:
        "Əgər tətbiq onları təyin etməyə imkan verirsə, aşağıdakı konfiqurasiya dəyərlərindən istifadə edin:",
    ...
    verifyOAuth2DeviceUserCode:
        "Cihazınız tərəfindən təqdim olunan kodu daxil edin və Göndər düyməsini klikləyin.",
    oauth2DeviceInvalidUserCodeMessage: "Etibarsız kod, zəhmət olmasa yenidən cəhd edin.",
    oauth2DeviceExpiredUserCodeMessage:
        "Kod vaxtı bitmişdir. Zəhmət olmasa, cihazınıza geri dönün və yenidən qoşulmağa cəhd edin.",
    oauth2DeviceVerificationCompleteHeader: "Avadanlıq Girişi Uğurlu",
    oauth2DeviceVerificationCompleteMessage:
        "Bu brauzer pəncərəsini bağlaya və cihazınıza qayıda bilərsiniz.",
    oauth2DeviceVerificationFailedHeader: "Cihaz Girişi Uğursuz Oldu",
    oauth2DeviceVerificationFailedMessage:
        "Bu brauzer pəncərəsini bağlaya bilərsiniz və cihazınıza qayıdıb yenidən qoşulmağa cəhd edə bilərsiniz.",
    oauth2DeviceConsentDeniedMessage: "Cihaza qoşulma üzrə razılıq rədd edildi.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Müştərinin OAuth 2.0 Cihaz Təsdiqləmə Qrantını başlatmaq icazəsi yoxdur. Axın müştəri üçün deaktivdir.",
    emailVerifyInstruction1:
        "E-poçt ünvanınızı yoxlamaq üçün təlimatların olduğu e-poçt {0} ünvanınıza göndərilmişdir.",
    ...
    emailVerifyInstruction4:
        "E-poçt ünvanınızı təsdiqləmək üçün sizə {0} ünvanına təlimatlı e-poçt göndərəcəyik.",
    emailVerifyResend: "Təsdiqləmə emailini yenidən göndər",
    emailVerifySend: "Doğrulama emaili göndər",
    emailLinkIdpTitle: "Link {0}",
    emailLinkIdp1:
        "Sizə {2} hesabınızla {1} hesabınızı əlaqələndirmək üçün təlimatları olan bir e-poçt göndərilib.",
    ...
    emailInstruction:
        "İstifadəçi adınızı və ya e-poçt ünvanınızı daxil edin və sizə yeni şifrə yaratmaq üçün təlimatlar göndərəcəyik.",
    emailInstructionUsername:
        "İstifadəçi adınızı daxil edin və sizə yeni şifrə yaratmaq üçün təlimat göndərəcəyik.",
    ...
    federatedIdentityExistsMessage:
        "İstifadəçi {0} {1} artıq mövcuddur. Zəhmət olmasa, hesabı əlaqələndirmək üçün hesab idarəetməsinə daxil olun.",
    federatedIdentityUnavailableMessage:
        "İstifadəçi {0} identifikasiya provayderi {1} ilə doğrulandı, lakin mövcud deyil. Zəhmət olmasa, administratorunuza müraciət edin.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Kimlik təminatçısı tərəfindən verilən ID nişanı, konfiqurasiya edilmiş vacib iddiaya uyğun deyil. Zəhmət olmasa, administratorunuzla əlaqə saxlayın.",
    ...
    federatedIdentityConfirmLinkMessage:
        "İstifadəçi {0} {1} artıq mövcuddur. Davam etmək üçün necə istəyirsiniz?",
    federatedIdentityConfirmOverrideMessage:
        "Hesabınızı {0} ilə {1} hesabı {2} ilə əlaqələndirməyə çalışırsınız. Amma hesabınız artıq başqa {3} hesabı {4} ilə əlaqələndirilmişdir. Mövcud əlaqəni yeni hesabla əvəz etmək istədiyinizi təsdiqləyə bilərsinizmi?",
    ...
    delegationFailedMessage:
        "Bu brauzer pəncərəsini bağlaya və konsol tətbiqinizə geri dönərək yenidən daxil olmağa cəhd edə bilərsiniz.",
    ...
    invalidPasswordMinUpperCaseCharsMessage:
        "Etibarsız şifrə: ən az {0} böyük hərflərdən ibarət olmalıdır.",
    ...
    invalidPasswordHistoryMessage:
        "Etibarsız parol: son {0} paroladan heç biri ilə eyniliyi olmamalıdır.",
    ...
    standardFlowDisabledMessage:
        "Müştəriyə təqdim olunan cavab növü ilə brauzer girişi başlatmaq icazəsi verilmir. Standart axın müştəri üçün deaktiv edilib.",
    implicitFlowDisabledMessage:
        "Müştəriyə verilən cavab növü ilə brauzer daxil olmağı başlatmağa icazə verilmir. Qapalı axın müştəri üçün deaktiv edilib.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Kimlik təminatçısına autentifikasiya sorğusu ilə davam edə bilmədi.",
    couldNotObtainTokenMessage: "Kimlik təminatçısından token alınamadı.",
    unexpectedErrorRetrievingTokenMessage:
        "Identifikasi provayderindən token alınarkən gözlənilməz xəta baş verdi.",
    unexpectedErrorHandlingResponseMessage:
        "Kimlik təminatçısından cavab alınarkən gözlənilməz xəta baş verdi.",
    identityProviderAuthenticationFailedMessage:
        "İstifadəçi doğrulaması uğursuz oldu. Şəxsiyyət təminatçı ilə doğrulaya bilmədi.",
    couldNotSendAuthenticationRequestMessage:
        "İstifadəçi təminatçıya autentifikasiya sorğusu göndərilə bilmədi.",
    unexpectedErrorHandlingRequestMessage:
        "Şəxsiyyət təsdiqi təminatçısına autentifikasiya sorğusunu işləyərkən gözlənilməz xəta baş verdi.",
    ...
    cookieNotFoundMessage:
        "Giriş cookiesi yenidən başlatmaq üçün tapılmadı. Bu vaxtı keçmiş ola bilər, silinmiş ola bilər və ya brauzerinizdə kuklalar deaktiv olub. Əgər kuklalar deaktivdirsə, onları aktivləşdirin. Yenidən daxil olmaq üçün Tətbiqə geri qayıt düyməsinə klikləyin.",
    insufficientLevelOfAuthentication: "Tələb olunan doğrulama səviyyəsi təmin edilməyib.",
    identityProviderUnexpectedErrorMessage:
        "İdentifikasiya təminatı ilə autentifikasiya zamanı gözlənilməz xəta",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "İdentifikasiya təminatçisindən cavabda kod və ya səhv parametri itkin.",
    ...
    identityProviderNotFoundMessage:
        "İdentifikasiya təminatçı ilə tanış olmayan identifikasiya təminatçısı tapa bilmədi.",
    identityProviderLinkSuccess:
        "E-poçtunuzu uğurla təsdiqlədiniz. Zəhmət olmasa, orijinal brauzerinizə qayıdın və orada girişə davam edin.",
    staleCodeMessage:
        "Bu səhifə artıq etibarlı deyil, zəhmət olmasa tətbiqinizə geri dönün və yenidən daxil olun.",
    ...
    identityProviderNotUniqueMessage:
        "Realm bir neçə identifikasiya provayderini dəstəkləyir. Kimlik provayderinin hansı istifadə ediləcəyini müəyyən edə bilmədi.",
    ...
    staleEmailVerificationLink:
        "Klik etdiyiniz link köhnə və keçərsizdir. Bəlkə də artıq emailinizi təsdiqləmisiniz.",
    identityProviderAlreadyLinkedMessage:
        "{0} tərəfindən qaytarılan Federated identitet artıq başqa bir istifadəçi ilə əlaqələndirilmişdir.",
    confirmAccountLinking:
        "Hesabınızla identifikasiya təminatçı {1}ın hesabı {0} bağlamasını təsdiqləyin.",
    confirmAccountLinkingBody:
        "Əgər hesabı əlaqələndirsəniz, eyni zamanda identifikasiya təminatçisinin {1} hesabı {0} ilə daxil ola biləcəksiniz. Bu prosesi başlatmadıysanız və ya hesabı əlaqələndirmək istəmirsinizsə, davam etməyin.",
    ...
    differentUserAuthenticated:
        "Bu sessiyada artıq başqa bir istifadəçi '{0}' kimi doğrulanmısınız. Xahiş edirəm əvvəl çıxış edin.",
    brokerLinkingSessionExpired:
        "İstənilən broker hesabının bağlantısı tələb olundu, lakin hazırki sessiya artıq etibarlı deyil.",
    ...
    "console-verify-email":
        "E-poçt ünvanınızı təsdiqləməlisiniz. {0} ünvanına təsdiq kodu olan bir e-poçt göndərdik. Zəhmət olmasa, bu kodu aşağıdakı daxil edilən sahəyə daxil edin.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript deaktivdir. Güclü tövsiyə edirik ki, onu aktivləşdirin. Davam etmək üçün aşağıdakı düyməni vurun.",
    ...
    "recovery-authn-codes-display-name": "Qurtarma Doğrulama Kodu",
    "recovery-authn-codes-help-text": "Əvvəlcədən yaradılmış siyahıdan bərpa təsdiq kodunu daxil edin.",
    ...
    "recovery-code-config-warning-title":
        "Bu bərpa kodları bu səhifədən çıxış etdikdən sonra yenidən görünməyəcək.",
    "recovery-code-config-warning-message":
        "Bunları çap, yüklə və ya şifrə menecerinə kopyala və onları təhlükəsiz saxla. Bu quruluşu ləğv etmək, bu bərpa kodlarını hesabınızdan siləcək.",
    ...
    "recovery-codes-download-file-description":
        "Bərpa kodları, təsdiqedicinizə çıxışınız olmadığı halda hesabınıza daxil olmağa imkan verən bir dəfəlik keçid kodlarıdır.",
    ...
    "webauthn-unsupported-browser-text":
        "Bu brauzer WebAuthn-u dəstəkləmir. Başqa birini sınayın və ya administratorunuza müraciət edin.",
    ...
    "webauthn-registration-init-label-prompt":
        "Zəhmət olmasa, qeydiyyatdan keçmiş şifrə açarınızın etiketini daxil edin",
    ...
    "webauthn-error-different-user":
        "İlk doğrulanmış istifadəçi Passkey ilə doğrulanmış istifadəçi deyil.",
    ...
    "passkey-unsupported-browser-text":
        "Bu brauzer tərəfindən Passkey dəstəklənmir. Başqa birini sınayın və ya administratorunuza müraciət edin.",
    ...
    finalDeletionConfirmation:
        "Hesabınızı silsəniz, bərpa edilə bilməz. Hesabınızı saxlamaq üçün Ləğv et düyməsini vurun.",
    ...
    readOnlyUsernameMessage:
        "İstifadəçi adınızı yeniləyə bilməzsiniz, çünki bu yalnız oxunan rejimindədir.",
    "error-invalid-multivalued-size":
        "Xüsusiyyət {0} ən azı {1} və ən çox {2} {2,choice,0#dəyər|1#dəyər|1<dəyər} olmalıdır.",
