...
const messages = {
    ...
    deletingAccountForbidden:
        "Nemáte dostatočné oprávnenie na vymazanie vlastného účtu, kontaktujte administrátora.",
    ...
    reauthenticate: "Na pokračovanie sa prosím prihláste znova",
    authenticateStrong: "Na pokračovanie je potrebné silné overenie",
    oauthGrantTitle: "Poskytnúť prístup {0}",
    oauthGrantTitleHtml: "{0}",
    oauthGrantInformation:
        "Uistite sa, že dôverujete {0}. Zistite, ako bude {0} narábať s Vašimi údajmi. ",
    ...
    emailUpdateConfirmationSent:
        "Na adresu {0} bol odoslaný potvrdzujúci e-mail. Na dokončenie aktualizácie e-mailu postupujte podľa pokynov.",
    ...
    browserRequired: "Na prihlásenie je potrebný prehliadač",
    browserContinue: "Na dokončenie prihlásenia je potrebný prehliadač",
    ...
    deleteCredentialMessage: "Chcete odstrániť {0}?",
    ...
    organizationScopeConsentText: "Organizácia",
    restartLoginTooltip: "Znovu spustiť prihlásenie",
    loginTotpIntro: "Na prístup k tomuto účtu je potrebné nastaviť generátor jednorazových kódov",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Kód stratil platnosť. Vráťte sa prosím k svojmu zariadeniu a skúste sa pripojiť znova.",
    oauth2DeviceVerificationCompleteHeader: "Úspešné prihlásenie zariadenia",
    oauth2DeviceVerificationCompleteMessage:
        "Môžete zavrieť toto okno prehliadača a vrátiť sa k svojmu zariadeniu.",
    oauth2DeviceVerificationFailedHeader: "Prihlásenie zariadenia zlyhalo",
    oauth2DeviceVerificationFailedMessage:
        "Môžete zavrieť toto okno prehliadača, vrátiť sa k svojmu zariadeniu a skúsiť sa pripojiť znova.",
    oauth2DeviceConsentDeniedMessage: "Súhlas s pripojením zariadenia zamietnutý.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Klientovi nie je povolené iniciovať OAuth 2.0 Device Authorization Grant. Tento flow je pre klienta zakázaný.",
    ...
    emailVerifyInstruction4:
        "Na overenie Vašej e-mailovej adresy Vám pošleme e-mail s pokynmi na adresu {0}.",
    emailVerifyResend: "Opätovné odoslanie overovacieho e-mailu",
    emailVerifySend: "Odoslať overovací e-mail",
    ...
    emailInstructionUsername:
        "Zadajte svoje používateľské meno a my Vám zašleme pokyny na vytvorenie nového hesla.",
    copyCodeInstruction: "Prosím skopírujte tento kód a vložte ho do Vašej aplikácie:",
    pageExpiredTitle: "Platnosť stránky vypršala",
    pageExpiredMsg1: "Na reštartovanie prihlasovacieho procesu",
    ...
    identityProviderLogoutFailure: "Zlyhanie odhlásenia zo SAML IdP",
    ...
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Identifikačný token vydaný poskytovateľom identity sa nezhoduje s nakonfigurovaným essential claim. Obráťte sa na svojho správcu.",
    confirmLinkIdpTitle: "Účet už existuje",
    confirmOverrideIdpTitle: "Prepojenie so sprostredkovateľom už existuje",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Snažíte sa prepojiť svoj účet {0} s {1} účtom {2}. Váš účet je však už prepojený s iným {3} účtom {4}. Môžete potvrdiť, či chcete nahradiť existujúce prepojenie novým účtom?",
    ...
    confirmOverrideIdpContinue: "Áno, prepíšte prepojenie so súčasným účtom",
    configureTotpMessage: "Na aktiváciu Vášho účtu musíte nastaviť aplikáciu Mobile Authenticator.",
    configureBackupCodesMessage: "Na aktiváciu Vášho účtu musíte nastaviť záložné kódy.",
    ...
    updateEmailMessage: "Na aktiváciu účtu musíte aktualizovať svoju e-mailovú adresu.",
    ...
    delegationCompleteMessage:
        "Môžete zavrieť toto okno prehliadača a vrátiť sa do konzolovej aplikácie.",
    delegationFailedHeader: "Prihlásenie zlyhalo",
    delegationFailedMessage:
        "Môžete zavrieť toto okno prehliadača, vrátiť sa do konzolovej aplikácie a skúsiť sa prihlásiť znova.",
    ...
    invalidPasswordNotContainsUsernameMessage: "Nesprávne heslo: Nemôže obsahovať používateľské meno.",
    ...
    cookieNotFoundMessage:
        "Súbor cookie nebol nájdený. Uistite sa, že sú vo Vašom prehliadači povolené súbory cookie.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "V odpovedi poskytovateľa identity chýba parameter code alebo error.",
    ...
    staleEmailVerificationLink:
        "Odkaz, na ktorý ste klikli, je starý odkaz a už nie je platný. Možno ste už overili svoj e-mail?",
    ...
    "requiredAction.webauthn-register": "Registrácia Webauthn",
    ...
    "console-verify-email":
        "Potrebujete overiť svoju e-mailovú adresu. Odoslali sme e-mail na adresu {0}, ktorý obsahuje overovací kód. Zadajte tento kód do poľa nižšie.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript je vypnutý. Dôrazne odporúčame ho zapnúť. Ak chcete pokračovať, kliknite na tlačidlo nižšie. ",
    ...
    "auth-x509-client-username-form-display-name": "X509 Certifikát",
    "auth-x509-client-username-form-help-text": "Prihláste sa pomocou klientského certifikátu X509.",
    "recovery-authn-codes-display-name": "Overovací kód na obnovenie",
    "recovery-authn-codes-help-text": "Zadajte overovací kód obnovy z vopred vygenerovaného zoznamu.",
    ...
    "recovery-code-config-warning-title":
        "Tieto kódy obnovenia sa po opustení tejto stránky už nezobrazia",
    "recovery-code-config-warning-message":
        "Uistite sa, že ste si ich vytlačili, stiahli alebo skopírovali do správcu hesiel a uložili. Zrušenie tohto nastavenia odstráni tieto kódy na obnovenie z Vášho účtu.",
    ...
    "recovery-codes-download-file-description":
        "Kódy na obnovenie sú jednorázové prístupové kódy, ktoré Vám umožnia prihlásiť sa do Vášho účtu, ak nemáte prístup k autentifikátoru.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn nie je podporovaný týmto prehliadačom. Skúste iný alebo kontaktujte svojho administrátora.",
    "webauthn-doAuthenticate": "Prihlásenie pomocou prihlasovacieho kľúča",
    "webauthn-createdAt-label": "Vytvorené",
    "webauthn-registration-init-label": "Prihlasovací kľúč (predvolený štítok)",
    "webauthn-registration-init-label-prompt":
        "Zadajte prosím štítok Vášho registrovaného prístupového kľúča",
    ...
    "webauthn-error-different-user":
        "Prvý overený používateľ nie je ten, ktorý bol overený prihlasovacím kľúčom.",
    ...
    "webauthn-error-register-verification":
        "Výsledok registrácie prihlasovacieho kľúča je neplatný. {0}",
    "webauthn-error-user-not-found": "Neznámy používateľ overený prihlasovacím kľúčom.",
    "passkey-login-title": "Prihlásenie pomocou prihlasovacieho kľúča",
    "passkey-available-authenticators": "Dostupné prihlasovacie kľúče",
    "passkey-unsupported-browser-text":
        "Prihlasovací kľúč nie je v tomto prehliadači podporovaný. Skúste iný, alebo sa obráťte na správcu.",
    "passkey-doAuthenticate": "Prihlásiť sa pomocou prístupového kľúča",
    "passkey-createdAt-label": "Vytvorené",
    "passkey-autofill-select": "Vyberte svoj prihlasovací kľúč",
    ...
    finalDeletionConfirmation:
        "Ak vymažete svoj účet, nebude možné ho obnoviť. Ak si chcete účet ponechať, kliknite na tlačidlo Zrušiť.",
    ...
    "error-invalid-multivalued-size":
        "Atribút {0} musí mať najmenej {1} {1,choice,0#hodnôt|1#hodnotu|1<hodnoty|4<hodnôt} a najviac {2} {2,choice,0#hodnôt|1#hodnotu|1<hodnoty|4<hodnôt}.",
    "organization.confirm-membership.title": "Chystáte sa vstúpiť do organizácie ${kc.org.name}",
    "organization.confirm-membership": "Kliknutím na odkaz nižšie sa stanete členom organizácie {0}:",
    "organization.member.register.title": "Vytvorenie účtu na vstup do organizácie ${kc.org.name}",
    "organization.select": "Vyberte organizáciu, aby ste pokračovali:",
    notMemberOfOrganization: "Používateľ nie je členom organizácie {0}",
    notMemberOfAnyOrganization: "Používateľ nie je členom žiadnej organizácie",
