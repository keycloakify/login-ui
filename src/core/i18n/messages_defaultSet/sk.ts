...
const messages = {
    ...
    "verifyOAuth2DeviceUserCode":
        "Zadajte kód poskytnutý vaším zariadením a kliknite na tlačidlo Odoslať",
    ...
    "credentialSetupRequired":
        "Nie je môžné sa prihlásiť, vyžaduje sa nastavenie prihlasovacích údajov.",
    ...
    "auth-recovery-authn-code-form-help-text":
        "Zadajte overovací kód obnovy z vopred vygenerovaného zoznamu.",
    ...
    "webauthn-error-register-verification":
        "Výsledok registrácie prihlasovacieho kľúča je neplatný.<br/> {0}",
    ...
    "error-invalid-multivalued-size":
        "Atribút {0} musí mať najmenej {1} {1,choice,0#hodnôt|1#hodnotu|1<hodnoty|4<hodnôt} a najviac {2} {1,choice,0#hodnôt|1#hodnotu|1<hodnoty|4<hodnôt}.",
