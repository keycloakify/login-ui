...
const messages = {
    ...
    "accountTemporarilyDisabledMessage":
        "ანგარიში დროებით გათიშულია. დაუკავშირდით თქვენს ადმინისტრატორს ან მოგვიანებით სცადეთ.",
    ...
    "error-invalid-multivalued-size":
        "ატრიბუტი {0} მინიმუმ {1} და მაქსიმუმ {2} მნიშვნელობას უნდა შეიცავდეს.",
    "doLogIn": "შესვლა",
    ...
    "updateProfileMessage":
        "თქვენი ანგარიშის გასააქტიურებლად თქვენი მომხმარებლის პროფილი უნდა განაახლოთ.",
