...
const messages = {
    ...
    emailUpdateConfirmationSent:
        "დადასტურების ელფოსტა გაიგზავნა მისამართზე {0}. ელფოსტის განახლებისთვის ელფოსტაზე გამოგზავნის ინსტრუქციებს მიჰყევით.",
    ...
    loginTotpStep3DeviceName:
        "შეიყვანეთ მოწყობილობის სახელი, რომ თქვენი OTP მოწყობილობების მართვაში დაგეხმაროთ.",
    loginTotpManualStep3:
        "გამოიყენეთ შემდეგი კონფიგურაციის მნიშვნელობები, თუ აპლიკაცია საშუალებას გაძლევთ, დააყენოთ ისინი:",
    oauth2DeviceExpiredUserCodeMessage:
        "კოდის ვადა ამოიწურა. დაბრუნდით თქვენს მოწყობილობაზე და დაკავშირება თავიდან სცადეთ.",
    oauth2DeviceVerificationFailedMessage:
        "შეგიძლიათ დახუროთ ეს ბრაუზერის ფანჯარა, დაბრუნდეთ თქვენს მოწყობილობაზე და მიერთება თავიდან სცადოთ.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "კლიენტს OAuth 2.0 მოწყობილობის ავტორიზაციის დაწყების უფლება არ აქვს. ეს დინება გათიშულია კლიენტისთვის.",
    oauth2DeviceVerificationCompleteMessage:
        "შეგიძლიათ დახუროთ ეს ბრაუზერის ფანჯარა და დაბრუნდეთ თქვენს მოწყობილობაზე.",
    ...
    unexpectedErrorHandlingRequestMessage:
        "მოულოდნელი შეცდომა იდენტიფიკატორის მომწოდებელთან გასაგზავნი ავთენტიკაციის მოთხოვნის დამუშავებისას.",
    ...
    linkIdpMessage:
        "იმისათვის, რომ თქვენი ანგარიში {0}-ზე მიაბათ, თქვენი ელფოსტის მისამართის გადამოწმებაა საჭირო.",
    ...
    bearerOnlyMessage:
        "მხოლოდ-მატარებლის ტიპის აპლიკაციებს ბრაუზერით შესვლის დაწყების უფლება არ გააჩნიათ",
    standardFlowDisabledMessage:
        "კლიენტს უფლება, რომ დაიწყოს ბრაუზერით შესვლა მითითებული პასუხის ტიპით, არ აქვს. კლიენტისთვის სტანდარტული დინება გათიშულია.",
    emailInstruction:
        "შეიყვანეთ თქვენ მომხმარებლის სახელი ან ელფოსტის მისამართი და გამოგიგზავნით ინსტრუქციებს, როგორ შექმნათ ახალი პაროლი.",
    "role_view-clients": "კლიენტების ნახვა",
    invalidUserMessage: "არასწორი მომხმარებელი ან პაროლი.",
    emailLinkIdp1:
        "გამოგეგზავნათ ელფოსტა ინსტრუქციებით, როგორ მიაბათ {0} ანგარიში {1} თქვენი {2}-ის ანგარიშს.",
    ...
    emailInstructionUsername:
        "შეიყვანეთ თქვენ მომხმარებლის სახელი და გამოგიგზავნით ინსტრუქციებს, როგორ შექმნათ ახალი პაროლი.",
    ...
    identityProviderNotUniqueMessage:
        "რეალმს ერთზე მეტი იდენტიფიკატორის მომწოდებლის მხარდაჭერა გააჩნია. შეუძლებელია დადგენა, რომელი იდენტიფიკატორის მომწოდებელი უნდა იქნეს გამოყენებული ავთენტიკაციისთვის.",
    realmSupportsNoCredentialsMessage:
        "რეალმს ავტორიზაციის დეტალების არც ერთი ტიპის მხარდაჭერა გააჩნია.",
    ...
    staleEmailVerificationLink:
        "ბმული, რომელზეც დააწკაპუნეთ, ძველი, უმოქმედო ბმულია და აღარ მუშაობს. შეიძლება, ელფოსტა უკვე გადაამოწმეთ.",
    identityProviderAlreadyLinkedMessage:
        "ფედერაციული იდენტიფიკატორი, რომელიც {0}-მა დააბრუნა, უკვე მიბმულია სხვა მომხმარებელზე.",
    confirmAccountLinking:
        "დაადასტურეთ ანგარიშის {0} იდენტიფიკატორის მომწოდებლიდან {1} მიბმა თქვენს ანგარიშზე.",
    ...
    brokerLinkingSessionExpired:
        "მოთხოვნილია ბროკერის ანგარიშის მიბმა, მაგრამ მიმდინარე სესია უკვე არასწორია.",
    differentUserAuthenticated:
        'ავთენტიკაცია უკვე გაიარეთ სხვა მომხმარებლით "{0}" ამ სესიაში. ჯერ უნდა გახვიდეთ.',
    ...
    "console-verify-email":
        "საჭიროა, გადაამოწმოთ თქვენი ელფოსტის მისამართი. გამოგიგზავნეთ ელფოსტა {0}-ზე, რომელიც გადამოწმების კოდს შეიცავს. შეიყვანეთ ეს კოდი ქვემოთ ველში.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript გათიშულია. გირჩევთ, ჩართოთ ის. გასაგრძელებლად დააწექით ღილაკს ქვემოთ.",
    ...
    "recovery-authn-codes-help-text":
        "შეიყვანეთ აღდგენის ავთენტიკაციის სიიდან, რომელიც ადრე გადმოგეცათ.",
    "recovery-code-config-warning-title":
        "ეს ავთენტიკაციის კოდები აღარასდროს გამოჩნდება, როცა ამ გვერდიდან გახვალთ",
    "recovery-authn-codes-display-name": "აღდგენის ავთენტიკაციის კოდი",
    ...
    "recovery-codes-download-file-description":
        "აღდგენის კოდები ერთჯერადი საკვანძო კოდებია, რომელიც საშუალებას გაძლევთ, შეხვიდეთ თქვენს ანგარიშში, თუ ავთენტიკატორთან წვდომა დაკარგეთ.",
    ...
    "webauthn-unsupported-browser-text":
        "ამ ბრაუზერს WebAuthn-ის მხარდაჭერა არ გააჩნია. სცადეთ სხვა ბრაუზერი ან დაუკავშირდით თქვენს სისტემურ ადმინისტრატორს.",
    ...
    "passkey-unsupported-browser-text":
        "Passkey-ის მხარდაჭერა ამ ბრაუზერს არ აქვს. სცადეთ სხვა ან დაუკავშირდით თქვენს ადმინისტრატორს.",
    ...
    "webauthn-error-different-user":
        "პირველი მომხმარებელი, ვინც ავთენტიკაცია გაიარა, Passkey-ით ავთენტიკაციის მომხმარებელს არ ემთხვევა.",
    ...
    finalDeletionConfirmation:
        "თუ თქვენს ანგარიშს წაშლით, მას ვეღარ აღადგენთ. ანგარიშის შესანარჩუნებლად დააწკაპუნეთ ღილაკზე 'გაუქმება'.",
    ...
    readOnlyUsernameMessage:
        "თქვენ ვერ განაახლებთ თქვენს მომხმარებლის სახელს, რადგან ის მხოლოდ-წაკითხვადია.",
    doLogout: "გასვლა",
    "error-invalid-multivalued-size":
        "ატრიბუტს {0} უნდა ჰქონდეს მინიმუმ {1} და მაქსიმუმt {2} {2,choice,0#მნიშვნელობა,0<მნიშვნელობა}.",
    doLogIn: "შესვლა",
    ...
    oauthGrantInformation:
        "დარწმუნდით, რომ ენდობით {0}-ს ნახვით, როგორ დაამუშავებს {0} თქვენს მონაცემებს.",
    ...
    loginTotpStep3:
        "შეიყვანეთ აპლიკაციის მიერ მოწოდებული ერთჯერადი კოდი და დააწკაპუნეთ გადაცემაზე, რომ მორგება დაასრულოთ.",
    ...
    verifyOAuth2DeviceUserCode:
        "შეიყვანეთ კოდი, რომელიც თქვენმა მოწყობილობამ მოგაწოდათ და დააწკაპუნეთ ღილაკზე 'გადაცემა'",
    ...
    emailVerifyInstruction1:
        "ელფოსტა ინსტრუქციებით, რომ გადავამოწმოთ თქვენი ელფოსტის მისამართი, გაიგზავნა მისამართზე {0}.",
    ...
    federatedIdentityExistsMessage:
        "მომხმარებელი {0}-ით {1} უკვე არსებობს. შედით ანგარიშების მართვაში, რომ ანგარიში მიაბათ.",
    federatedIdentityUnavailableMessage:
        "მომხმარებელმა {0} ავთენტიკაცია იდენტიფიკატორის მომწოდებლით {1} გაიარა და არ არსებობს. დაუკავშირდით თქვენს ადმინისტრატორ.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "ID-ის კოდი, რომელიც იდენტიფიკატორის მომწოდებელმა გამოსცა, არ ემთხვევა მორგებულ ძირითად მოთხოვნას. დაუკავშირდით თქვენს ადმინისტრატორს.",
    federatedIdentityConfirmLinkMessage:
        "მომხმარებელი {0}-ით {1} უკვე არსებობს. როგორ გნებავთ გაგრძელება?",
    federatedIdentityConfirmOverrideMessage:
        "ცდილობთ, თქვენი ანგარიში {0} {1}-ით ანგარიშს {2}. მაგრამ თქვენი ანგარიში უკვე მიბმულია სხვა {3} ანგარიშს {4}. ადასტურებთ, რომ გნებავთ, არსებული ბმული ახალი ანგარიშით ჩაანაცვლოთ?",
    federatedIdentityConfirmReauthenticateMessage:
        "გაიარეთ ავთენტიკაცია, რომ მიაბათ თქვენი ანგარიში {0}-ს",
    ...
    verifyEmailMessage:
        "საჭიროა, გადაამოწმოთ თქვენი ელფოსტის მისამართი, რომ გაააქტიუროთ თქვენი ანგარიში.",
    ...
    delegationCompleteMessage:
        "შეგიძლიათ დახუროთ ეს ბრაუზერის ფანჯარა და თქვენი კონსოლის აპლიკაციაზე დაბრუნდეთ.",
    delegationFailedHeader: "შესვლა ჩავარდა",
    delegationFailedMessage:
        "შეგიძლიათ, დახუროთ ეს ბრაუზერის ფანჯარა და თქვენი კონსოლის აპლიკაციაზე დაბრუნდეთ და შესვლა თავიდან სცადოთ.",
    ...
    invalidPasswordMinLowerCaseCharsMessage:
        "არასწორი პაროლი: უნდა შეიცავდეს, სულ ცოტა {0} პატარა ასოს.",
    invalidPasswordMinUpperCaseCharsMessage: "არასწორი პაროლი: უნდა შეიცავდეს, სულ ცოტა {0} დიდ ასოს.",
    invalidPasswordMinSpecialCharsMessage:
        "არასწორი პაროლი: უნდა შეიცავდეს, სულ ცოტა {0} სპეციალურ სიმბოლოს.",
    ...
    invalidPasswordNotContainsUsernameMessage:
        "არასწორი პაროლი: არ შეიძლება, მომხმარებლის სახელს შეიცავდეს.",
    ...
    implicitFlowDisabledMessage:
        "კლიენტს უფლება, რომ დაიწყოს ბრაუზერით შესვლა მითითებული პასუხის ტიპით, არ აქვს. კლიენტისთვის პირდაპირი დინება გათიშულია.",
    ...
    noRelayStateInResponseMessage:
        "იდენტიფიკატორის მომწოდებლის პასუხში რელეს მდგომარეობა აღმოჩენილი არაა.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "იდენტიფიკატორის მომწოდებელთან ავთენტიკაციის მოთხოვნის გაგრძელება შეუძლებელია.",
    couldNotObtainTokenMessage: "იდენტიფიკატორის მომწოდებლიდან კოდის მიღება შეუძლებელია.",
    unexpectedErrorRetrievingTokenMessage:
        "მოულოდნელი შეცდომა იდენტიფიკატორის მომწოდებლიდან კოდის მიღებისას.",
    unexpectedErrorHandlingResponseMessage:
        "მოულოდნელი შეცდომა იდენტიფიკატორის მომწოდებლის პასუხის დამუშავებისას.",
    identityProviderAuthenticationFailedMessage:
        "ავთენტიკაცია ჩავარდა. იდენტიფიკატორის მომწოდებელთან ავთენტიკაცია ჩავარდა.",
    couldNotSendAuthenticationRequestMessage:
        "ვერ გავაგზავნე ავთენტიკაციის მოთხოვნა იდენტიფიკატორის მომწოდებელთან.",
    ...
    cookieNotFoundMessage:
        "გადატვირთვის შესვლის ქუქი აღმოჩენილი არაა. შეიძლება, მისი ვადა ამოიწურა. ასევე, შეიძლება, ის წაშალეს, ან ბრაუზერში ქუქიები გათიშულია. თუ ქუქიები გათიშულია, ჩართეთ ისინი. დააწკაპუნეთ 'აპლიკაციაზე დაბრუნებაზე', რომ თავიდან შეხვიდეთ.",
    insufficientLevelOfAuthentication: "ავთენტიკაციის მოთხოვნილი დონე არ დაკმაყოფილებულა.",
    identityProviderUnexpectedErrorMessage:
        "მოულოდნელი შეცდომა იდენტიფიკატორის მომწოდებლით ავთენტიკაციისას",
    identityProviderMissingStateMessage:
        "იდენტიფიკატორის მომწოდებლის პასუხში მდგომარეობის პარამეტრი მითითებული არაა.",
    identityProviderMissingCodeOrErrorMessage:
        "ნაკლული კოდი ან შეცდომის პარამეტრი იდენტიფიკატორის მომწოდებლის პასუხში.",
    identityProviderLinkSuccess:
        "თქვენ წარმატებით გადაამოწმეთ თქვენი ელფოსტა. დაბრუნდით საწყის ბრაუზერში და გააგრძელეთ შესვლა.",
    ...
    "recovery-code-config-warning-message":
        "დარწმუნდით, რომ დაბეჭდოთ, გადმოწეროთ ან შეინახოთ ისინი პაროლების მმართველში და იქონიეთ ისინი უსაფრთხოდ. ამ პარამეტრების გაუქმება თქვენი ანგარიშიდან ამ კოდებს წაშლის.",
    ...
    deletingAccountForbidden:
        "თქვენ არ გაქვთ საკმარისი წვდომები, რომ საკუთარი ანგარიში წაშალოთ. დაუკავშირდით ადმინისტრატორს.",
    bypassKerberosDetail:
        "ან შესული არ ბრძანდებით Kerberos-ით, ან თქვენი ბრაუზერი Kerberos-ით შესვლაზე არაა მორგებული. გააგრძელეთ შესვლა, ოღონდ სხვა საშუალებებით",
    ...
    emailVerifySend: "გადამოწმების ელფოსტის გაგზავნა",
    emailVerifyInstruction4:
        "თქვენი ელფოსტის მისამართის გადასამოწმებლად ჩვენ ვაპირებთ, გამოგგიზავნოთ ელფოსტა ინსტრუქციებით მისამართზე {0}.",
    linkIdpActionTitle: "კავშირის დამყარება {0}",
    linkIdpActionMessage: "გსურთ თქვენი ანგარიშის {0}-თან დაკავშირება?",
    "requiredAction.delete_account": "ანგარიშის წაშლა",
