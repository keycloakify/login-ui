...
const messages = {
    ...
    deletingAccountForbidden:
        "Өзүңүздүн аккаунтуңузду өчүрүүгө уруксат жетишсиз, администраторго кайрылыңыз.",
    kerberosNotConfigured: "Kerberos орнотулган эмес",
    kerberosNotConfiguredTitle: "Kerberos орнотулган эмес",
    bypassKerberosDetail:
        "Сиз Kerberos менен кирген жоксуз же браузериңиз Kerberos үчүн туура жөндөөлбөгөн. Башка жол менен кирүү үчүн “Улантуу” баскычын басыңыз.",
    ...
    oauthGrantInformation:
        "{0} сиздин маалыматыңызды кантип пайдалана турганын билип, ага ишенсеңиз болорун текшериңиз.",
    ...
    emailUpdateConfirmationSent:
        "{0} дарегине тастыктоо кат жөнөтүлдү. Электрондук почтаны жаңылоо үчүн көрсөтмөлөрдү аткарыңыз.",
    ...
    loginTotpStep3:
        "Колдонмо берген бир жолку кодду киргизип, орнотууну бүтүрүү үчүн Жөнөтүү баскычын басыңыз.",
    loginTotpStep3DeviceName:
        "OTP түзмөктөрүңүздү башкарууга жардам берүү үчүн түзмөктүн атын киргизиңиз.",
    loginTotpManualStep2: "Колдонмону ачыңыз жана ачкычты киргизиңиз:",
    loginTotpManualStep3:
        "Эгер колдонмо орнотууларды колдосо, төмөнкү конфигурация маанилерин пайдаланыңыз:",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Коддун мөөнөтү өттү. Түзмөгүңүзгө кайтып барып, кайра туташтырууга аракет кылыңыз.",
    ...
    oauth2DeviceVerificationFailedMessage:
        "Бул браузер терезесин жаап, түзмөгүңүзгө кайтып барып кайра туташтырууга аракет кылыңыз.",
    ...
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Клиентке OAuth 2.0 Түзмөк Авторизациясын баштоо уруксат берилген эмес. Бул агым клиент үчүн өчүрүлгөн.",
    emailVerifyInstruction1:
        "{0} дарегине электрондук почтаңызды тастыктоо боюнча көрсөтмөлөрдү камтыган кат жөнөтүлдү.",
    ...
    emailVerifyInstruction4:
        "{0} дарегине электрондук почтаңызды тастыктоо үчүн көрсөтмөлөрдү камтыган кат жөнөтүлөт.",
    emailVerifyResend: "Тастыктоо катын кайра жөнөтүү",
    emailVerifySend: "Тастыктоо катын жөнөтүү",
    emailLinkIdpTitle: "{0} туташтыруу",
    emailLinkIdp1:
        "{0} аккаунтун {1} сиздин {2} аккаунтуңузга туташтыруу боюнча көрсөтмөлөрдү камтыган кат сизге жөнөтүлдү.",
    ...
    emailInstruction:
        "Колдонуучу атыңызды же электрондук почта дарегиңизди киргизиңиз, биз сизге жаңы сырсөз түзүү боюнча көрсөтмөлөрдү жөнөтөбүз.",
    emailInstructionUsername:
        "Колдонуучу атыңызды киргизиңиз, биз сизге жаңы сырсөз түзүү боюнча көрсөтмөлөрдү жөнөтөбүз.",
    ...
    federatedIdentityExistsMessage:
        "{0} {1} менен колдонуучу мурунтан бар. Аккаунтту туташтыруу үчүн аккаунт башкарууга кириңиз.",
    federatedIdentityUnavailableMessage:
        "{0} колдонуучу {1} аутентификация провайдери менен жок. Администраторго кайрылыңыз.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Аутентификация провайдери тарабынан берилген ID токен конфигурацияланган негизги талабы менен дал келбейт. Администраторго кайрылыңыз.",
    ...
    federatedIdentityConfirmLinkMessage:
        "{0} {1} менен колдонуучу мурунтан бар. Кантип улантасыңыз келет?",
    federatedIdentityConfirmOverrideMessage:
        "Сиз аккаунтуңузду {0} менен {1} аккаунту {2} туташтырыгыңыз келет. Бирок аккаунтуңуз башка {3} аккаунту {4} менен мурунтан туташтырылган. Мурунку шилтемени жаңы аккаунт менен алмаштырууну тастыктайсызбы?",
    federatedIdentityConfirmReauthenticateMessage:
        "Аккаунтуңузду {0} менен туташтыруу үчүн аутентификациялаңыз",
    ...
    linkIdpMessage:
        "Аккаунтуңузду {0} менен туташтыруу үчүн электрондук почтаңызды тастыкташыңыз керек.",
    ...
    delegationFailedMessage:
        "Бул браузерди жаап, консолдук колдонмоңузга кайтып, кайрадан кирүүгө аракет кылыңыз.",
    ...
    invalidPasswordMinLowerCaseCharsMessage:
        "Сырсөз жараксыз: жок дегенде {0} кичинекей тамганы камтышы керек.",
    invalidPasswordMinUpperCaseCharsMessage:
        "Сырсөз жараксыз: жок дегенде {0} чоң тамганы камтышы керек.",
    invalidPasswordMinSpecialCharsMessage:
        "Сырсөз жараксыз: жок дегенде {0} атайын белгини камтышы керек.",
    ...
    standardFlowDisabledMessage:
        "Клиент берилген response_type менен браузер кирүүсүн баштай албайт. Стандарттык процесс өчүрүлгөн.",
    implicitFlowDisabledMessage:
        "Клиент берилген response_type менен браузер кирүүсүн баштай албайт. Имплициттик процесс өчүрүлгөн.",
    ...
    couldNotProceedWithAuthenticationRequestMessage:
        "Identity providerге аутентификация сурамын жибере алган жок.",
    ...
    identityProviderAuthenticationFailedMessage:
        "Аутентификация өтпөдү. Identity provider менен байланышуу мүмкүн болгон жок.",
    couldNotSendAuthenticationRequestMessage:
        "Identity providerге аутентификация сурамын жибере алган жок.",
    unexpectedErrorHandlingRequestMessage:
        "Identity providerге аутентификация сурамын иштетүүдө күтүлбөгөн ката.",
    ...
    cookieNotFoundMessage:
        "Кайра кирүү cookie табылган жок. Мүмкүн, мөөнөтү бүткөн; өчүрүлгөн же браузердеги cookie өчүрүлгөн. Эгерде cookie өчүрүлгөн болсо, аны күйгүзүңүз. Кирүү үчүн колдонмоңузга кайтуу баскычын басыңыз.",
    insufficientLevelOfAuthentication: "Суралган аутентификация деңгээли жетишсиз.",
    identityProviderUnexpectedErrorMessage:
        "Identity provider менен аутентификациялоодо күтүлбөгөн ката",
    ...
    identityProviderLinkSuccess:
        "Электрондук почтаңыз ийгиликтүү тастыкталды. Баштапкы браузериңизге кайтып, андан ары кирүүнү улантыңыз.",
    ...
    identityProviderNotUniqueMessage:
        "Realm бир нече identity providerлерди колдойт. Кайсы identity provider аутентификация үчүн колдонуларын аныктоо мүмкүн болбой жатат.",
    ...
    staleEmailVerificationLink:
        "Сиз баскан шилтеме эски, жараксыз болуп калды. Балким, сиз почтаңызды мурунтан тастыктагансыз.",
    identityProviderAlreadyLinkedMessage:
        "{0} аркылуу келген федерацияланган идентификация мурунтан башка колдонуучу менен байланышкан.",
    ...
    differentUserAuthenticated:
        "Бул сессияда сиз башка колдонуучу '{0}' катары аутентификациядан өттүңүз. Сураныч, биринчи чыгып кетиңиз.",
    brokerLinkingSessionExpired:
        "Каржылоочу эсепти байланыштыруу суралып, бирок учурдагы сессия жараксыз болду.",
    ...
    "console-verify-email":
        "Сиздин электрондук почтаңызды текшерүү керек. Биз {0} дарегине текшерүү коду бар кат жөнөттүк. Төмөнкү талаага ошол кодду киргизиңиз.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript өчүрүлгөн. Аны күйгүзүүнү сунуштайбыз. Улантуу үчүн төмөнкү баскычты чыкылдатыңыз.",
    ...
    "auth-username-password-form-help-text":
        "Колдонуучу атыңызды жана сырсөзүңүздү киргизүү менен кириңиз.",
    ...
    "auth-recovery-authn-code-form-help-text":
        "Мурда түзүлгөн тизмеден калыбына келтирүү аутентификация кодун киргизиңиз.",
    ...
    "recovery-code-config-warning-title":
        "Бул калыбына келтирүү коддору баракты таштап кеткенден кийин кайра көрүнбөйт",
    "recovery-code-config-warning-message":
        "Аларды басып чыгаруу, жүктөп алуу же сырсөз менеджерине көчүрүү жана коопсуз жерде сактоо маанилүү. Бул орнотууну жокко чыгаруу аккаунтуңуздан бул коддорду алып салат.",
    ...
    "recovery-codes-download-file-description":
        "Калыбына келтирүү коддору бир жолу колдонулуучу сырсөздөр болуп, эгер аутентификаторго кире албасаңыз, аккаунтуңузга кирүүгө мүмкүндүк берет.",
    ...
    "webauthn-unsupported-browser-text":
        "Бул браузер WebAuthn колдобойт. Башка браузерди колдонуп көрүңүз же администратор менен байланышыңыз.",
    ...
    "webauthn-error-api-get":
        "Парольсуз ачкыч менен аутентификациядан өтүү мүмкүн болгон жок.<br /> {0}",
    "webauthn-error-different-user":
        "Биринчи аутентификацияланган колдонуучу парольсуз ачкыч менен аутентификацияланган эмес.",
    "webauthn-error-auth-verification":
        "Парольсуз ачкыч менен аутентификация жыйынтыгы жараксыз.<br /> {0}",
    ...
    "passkey-unsupported-browser-text":
        "Бул браузер Парольсуз ачкычты колдобойт. Башка браузерди колдонуп көрүңүз же администратор менен байланышыңыз.",
    ...
    finalDeletionConfirmation:
        "Эгер аккаунтуңузду өчүрсөңүз, аны калыбына келтирүүгө болбойт. Аккаунтуңузду сактап калуу үчүн Жокко чыгарууну басыңыз.",
    ...
    "error-invalid-multivalued-size":
        "Атрибут {0} төмөнкүдөй болушу керек: к минимуму {1} жана максимум {2} {2,choice,0#маанилер|1#маани|1<маанилер}.",
