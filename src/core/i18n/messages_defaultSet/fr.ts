...
const messages = {
    ...
    deletingAccountForbidden:
        "Permissions insuffisantes pour supprimer votre propre compte, contactez un administrateur.",
    ...
    emailVerifyInstruction1:
        "Un courriel avec des instructions à suivre a été envoyé à votre adresse {0}.",
    ...
    delegationCompleteMessage:
        "Vous pouvez fermer cette fenêtre de navigateur et retourner sur votre application console.",
    ...
    brokerLinkingSessionExpired:
        "La liaison entre comptes broker a été demandée, mais la session n'est plus valide.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn n'est pas supporté par ce navigateur. Essayez une autre méthode ou contactez votre administrateur.",
