...
const messages = {
    ...
    "deletingAccountForbidden":
        "Nincs jogosultsága a felhasználói fiókjának törléséhez. Kérem, vegye fel a kapcsolatot az alkalmazás adminisztrátorával.",
    ...
    "oauthGrantInformation":
        "Győződjön meg arról, hogy megbízik a(z) {0} alkalmazásban azáltal, hogy megismeri, hogyan kezeli az adatait.",
    ...
    "emailUpdateConfirmationSent":
        "Egy megerősítő e-mail került elküldésre a(z) {0} címre. Kövesse az abban található utasításokat a változtatások véglegesítéséhez.",
    ...
    "verifyOAuth2DeviceUserCode":
        "Írja be az eszköz által generált kódot, majd kattintson az Elküld gombra",
    "oauth2DeviceInvalidUserCodeMessage": "Érvénytelen kód, kérem, próbálja újra.",
    "oauth2DeviceExpiredUserCodeMessage":
        "A kód érvényessége lejárt. Kérem, térjen vissza az eszközhöz és próbálja újra.",
    ...
    "oauth2DeviceVerificationFailedMessage":
        "Bezárhatja ezt az oldalt. Kérem, térjen vissza az eszközhöz és próbáljon meg csatlakozni újra.",
    ...
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "Az alkalmazás nem indíthat OAuth 2.0 Eszköz Hitelesítést. Ez a folyamat nincsen engedélyezve ezen alkalmazás számára.",
    "emailVerifyInstruction1":
        "A megadott e-mail címre elküldtük az e-mail cím megerősítéséhez szükséges lépéseket tartalmazó üzenetet.",
    ...
    "emailLinkIdp1":
        "A(z) {1} {0} fiók és a(z) {2} fiókjának összekötéséhez szükséges tudnivalókat e-mail üzenetben elküldtük Önnek.",
    ...
    "emailInstructionUsername":
        "Adja meg a felhasználónevét, hogy az új jelszó beállításához szükséges tudnivalókat elküldhessük Önnek.",
    ...
    "federatedIdentityUnavailableMessage":
        "A(z) {1} személyazonosság-kezelő által hitelesített felhasználó, {0} nem létezik. Kérem, vegye fel a kapcsolatot az alkalmazás adminisztrátorával.",
    "federatedIdentityUnmatchedEssentialClaimMessage":
        "A személyazonosság-kezelő által kiállított ID token nem egyezik az alapvető beállítással. Kérem, vegye fel a kapcsolatot az alkalmazás adminisztrátorával.",
    ...
    "federatedIdentityConfirmReauthenticateMessage":
        "Azonosítsa magát, hogy összeköthesse a felhasználói fiókját a következővel: {0}",
    "nestedFirstBrokerFlowMessage":
        "A(z) {0} {1} felhasználó nincs összekötve egyetlen ismert felhasználóval sem.",
    ...
    "cookieNotFoundMessage":
        "Süti nem található. Kérem, ellenőrizze, hogy a böngészőjében engedélyezve vannak-e a sütik.",
    ...
    "identityProviderInvalidSignatureMessage":
        "Érvénytelen aláírás a személyazonosság-kezelő válaszüzenetében.",
    "identityProviderNotFoundMessage": "A megadott azonosítóval személyazonosság-kezelő nem található.",
    "identityProviderLinkSuccess":
        "Sikeresen megerősítette e-mail címét. Kérem, térjen vissza az eredeti böngészőjébe, és onnan folytassa a belépési eljárást.",
    "staleCodeMessage":
    ...
    "staleEmailVerificationLink":
        "Az a hivatkozás, amelyikre rákattintott elévült és érvényét vesztette. Talán már korábban megerősítette az e-mail címét?",
    ...
    "console-verify-email":
        "Meg kell erősítenie az e-mail címét. Egy e-mail üzenetet küldtünk a(z) {0} e-mail címre amely egy megerősítő kódot tartalmaz. Kérem, írja be a kapott kódot a lenti beviteli mezőbe.",
    ...
    "recovery-code-config-warning-title":
        "Ezen kódok megtekintésére nincs lehetőség az oldal elhagyása után",
    "recovery-code-config-warning-message":
        "Nyomtassa ki, töltse le vagy mentse el a kódokat egy biztonságos helyre. A beállítás megszakítása törli ezeket a kódokat a felhasználói fiókjából.",
    ...
    "recovery-codes-download-file-description":
        "A biztonsági kódok egyszer használatos jelkódok, melyek segítségével bejelentkezhet a fiókjába, ha nem fér hozzá a hitelesítő alkalmazáshoz.",
    ...
    "webauthn-unsupported-browser-text":
        "A WebAuthn protokoll a böngésző által nem támogatott. Próbálja egy másikkal, vagy vegye fel a kapcsolatot az alkalmazás adminisztrátorával.",
    ...
    "idp-email-verification-help-text":
        "Felhasználói fiók összekapcsolása az e-mail cím megerősítésével.",
    ...
    "finalDeletionConfirmation":
        "A felhasználói fiók törlése után annak visszaállítására nincs mód. A fiókja megtartásához kattintson a Mégse gombra.",
    ...
    "accountUnusable":
        "Az alkalmazás további használata nem lesz lehetséges ezzel a felhasználói fiókkal",
