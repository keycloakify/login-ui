...
const messages = {
    ...
    loginTimeout: "Giriş denemeniz zaman aşımına uğradı. Giriş işlemi baştan başlayacaktır.",
    ...
    oauthGrantInformation:
        "{0} ın verilerinizi nasıl işleyeceğini öğrenerek {0} a güvendiğinizden emin olun.",
    ...
    emailUpdateConfirmationSent:
        "Doğrulama e-postası {0} kişisine gönderildi. E-posta güncellemesini tamamlamak için önceki talimatları izlemelisiniz.",
    ...
    loginTotpIntro:
        "Bu hesaba erişmek için Tek Seferlik Şifre (One Time Password) oluşturucusu kurmanız gerekiyor",
    loginTotpStep1: "Mobil cihazınıza aşağıdaki uygulamalardan birini yükleyin:",
    loginTotpStep2: "Uygulamayı açın ve barkodu taratın:",
    loginTotpStep3:
        "Uygulama tarafından sağlanan tek seferlik kodu girin ve kurulumu tamamlamak için Gönder'i tıklayın.",
    loginTotpStep3DeviceName: "OTP cihazlarınızı yönetmenize yardımcı olması için bir Cihaz Adı girin.",
    loginTotpManualStep2: "Uygulamayı açın ve anahtarı girin:",
    loginTotpManualStep3:
        "Uygulama bu ayarların yapılmasına izin veriyorsa, aşağıdaki yapılandırma değerlerini kullanın:",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Kod zaman aşımına uğradı. Lütfen cihazınıza gidiniz ve tekrardan bağlanmayı deneyin.",
    oauth2DeviceVerificationCompleteHeader: "Cihaz Girişi Başarılı",
    oauth2DeviceVerificationCompleteMessage:
        "Bu tarayıcı penceresini kapatıp cihazınıza geri dönebilirsiniz.",
    oauth2DeviceVerificationFailedHeader: "Cihaz Girişi Başarısız",
    oauth2DeviceVerificationFailedMessage:
        "Bu tarayıcı penceresini kapatabilir ve cihazınıza geri dönüp yeniden bağlanmayı deneyebilirsiniz.",
    oauth2DeviceConsentDeniedMessage: "Cihazı bağlamak için izin reddedildi.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Müşterinin OAuth 2.0 Cihaz Yetkilendirme İzni başlatmasına izin verilmiyor. Bu akış müşteri için devre dışı bırakılmıştır.",
    emailVerifyInstruction1:
        "E-posta adresinizi doğrulamak için talimatlar içeren bir e-posta, {0} adresinize gönderildi.",
    ...
    emailLinkIdp1:
        "{0} hesabı {1} ile {2} hesabınızı bağlamaya yönelik talimatları içeren bir e-posta size gönderildi.",
    ...
    emailInstructionUsername:
        "Kullanıcı adınızı girin, size yeni şifreyi nasıl oluşturacağınızla ilgili talimatları göndereceğiz.",
    ...
    "client_admin-cli": "Yönetici Komut Arayüzü",
    ...
    federatedIdentityConfirmOverrideMessage:
        "{0} hesabınızı {1} {2} hesabı ile bağlamaya çalışıyorsunuz. Ancak hesabınız farklı {3} {4} hesabı ile zaten bağlı. Mevcut bağlantıyı yeni hesapla değiştirmek istediğinizi onaylayabilir misiniz?",
    ...
    updateEmailMessage:
        "Hesabınızı aktif hale getirmek için e-posta adresinizi güncellemeniz gerekmektedir.",
    ...
    invalidPasswordGenericMessage: "Geçersiz Şifre: Yeni şifre, parola politikalarıyla eşleşmiyor.",
    ...
    standardFlowDisabledMessage:
        "İstemcinin verilen yanıt türüyle tarayıcıda oturum açmasına izin verilmiyor. İstemci için standart akış devre dışı bırakıldı.",
    implicitFlowDisabledMessage:
        "İstemcinin verilen yanıt türüyle tarayıcıda oturum açmasına izin verilmiyor. İstemci için örtülü akış devre dışı bırakıldı.",
    ...
    cookieNotFoundMessage:
        "Çerezler bulunamadı. Lütfen tarayıcınızdan çerezlere izin verdiğinizden emin olun.",
    ...
    identityProviderMissingCodeOrErrorMessage:
        "Kimlik sağlayıcısından gelen yanıtta eksik kod veya hata parametresi.",
    ...
    identityProviderAlreadyLinkedMessage:
        "{0} tarafından sağlanan Federe kimlik başka bir kullanıcıya bağlı.",
    ...
    "saml.post-form.js-disabled":
        "JavaScript devre dışı. Etkinleştirmenizi şiddetle tavsiye ederiz. Devam etmek için aşağıdaki düğmeye tıklayın.",
    ...
    "recovery-authn-codes-help-text":
        "Önceden oluşturulmuş listedeki bir kurtarma doğrulama kodunu girin.",
    ...
    "recovery-code-config-warning-title":
        "Bu sayfadan ayrıldıktan sonra kurtarma kodlarını tekrardan görüntüleyemeyeceksiniz.,",
    "recovery-code-config-warning-message":
        "Kodları yazdırdığınızdan, indirdiğinizden veya bir parola yöneticisine kopyaladığınızdan ve güvenli bir şekilde sakladığınızdan emin olun. Bu kurulumu iptal etmek, bu kurtarma kodlarını hesabınızdan kaldıracaktır.",
    ...
    "recovery-codes-download-file-header": "Bu kurtarma kodlarını güvenli bir yerde saklayın.",
    "recovery-codes-download-file-description":
        "Kurtarma kodları, kimlik doğrulayıcınıza erişiminiz olmadığında hesabınıza giriş yapmanızı sağlayan tek kullanımlık şifrelerdir.",
    ...
    "webauthn-unsupported-browser-text":
        "Bu tarayıcı WebAuthn’i desteklemiyor. Başka bir tarayıcı deneyin veya sistem yöneticinizle iletişime geçin.",
    ...
    "webauthn-error-different-user":
        "İlk doğrulanan kullanıcı, Geçiş Anahtarı ile doğrulanan kullanıcı değil.",
    ...
    finalDeletionConfirmation:
        "Hesabınızı silerseniz, geri getirilemez. Hesabınızı korumak için İptal'e tıklayın.",
    ...
    "error-invalid-multivalued-size":
        "{0} özniteliği en az {1} ve en fazla {2} {2,choice,0#değer|1#değer|1<değer} içermelidir.",
    ...
    "passkey-unsupported-browser-text":
        "Bu tarayıcı geçiş anahtarını desteklemiyor. Başka bir tarayıcı deneyin veya yöneticinizle iletişime geçin.",
    ...
    "organization.confirm-membership":
        "Aşağıdaki bağlantıya tıklayarak {0} organizasyonuna üye olacaksınız:",
    "organization.member.register.title":
        "${kc.org.name} organizasyonuna katılmak için bir hesap oluşturun",
    ...
    emailVerificationPending:
        "{0} adresine bir doğrulama e-postası gönderildi. Doğrulama e-postasını tekrar göndermek için değişiklik yapmadan devam edebilir veya farklı bir e-posta adresi girebilirsiniz.",
    ...
    emailVerifyInstruction4:
        "E-posta adresinizi doğrulamak için {0} adresine talimatları içeren bir e-posta göndereceğiz.",
    ...
    "error-non-ascii-local-part-email":
        "E-posta adresinin yerel kısmı yalnızca ASCII karakterler içermelidir.",
    federatedIdentityUnavailableMessage:
        "{0} kullanıcısı, {1} kimlik sağlayıcısıyla doğrulandı ancak mevcut değil. Lütfen yöneticinizle iletişime geçin.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Kimlik sağlayıcısı tarafından verilen ID belirteci, yapılandırılmış zorunlu alan ile eşleşmiyor. Lütfen sistem yöneticinizle iletişime geçin.",
    ...
    confirmAccountLinkingBody:
        "Hesabı bağlarsanız, {1} kimlik sağlayıcısındaki {0} hesabını da kullanarak giriş yapabileceksiniz. Bu işlemi siz başlatmadıysanız veya hesabı bağlamak istemiyorsanız devam etmeyin.",
    ...
    staleInviteOrgLink:
        "Tıkladığınız bağlantı artık geçerli değil. Süresi dolmuş veya zaten kullanılmış olabilir.",
