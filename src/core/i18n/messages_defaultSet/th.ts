...
const messages = {
    ...
    "recovery-authn-codes-display-name": "รหัสพิสูจน์ตัวจริงเพื่อการกู้คืน",
    "recovery-authn-codes-help-text": "ระบุรหัสพิสูจน์ตัวจริงเพื่อการกู้คืนจากรายการที่สร้างไว้ก่อนหน้า",
