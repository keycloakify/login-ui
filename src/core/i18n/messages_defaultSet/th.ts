...
const messages = {
    ...
    "bypassKerberosDetail":
        'คุณไม่ได้เข้าสู่ระบบด้วย Kerberos หรือเบราว์เซอร์ของคุณไม่ได้ถูกตั้งค่าให้เข้าสู่ระบบด้วย Kerberos กรุณาคลิกที่ "ดำเนินการต่อ" เพื่อเข้าสู่ระบบโดยวิธีอื่น',
    ...
    "oauthGrantInformation":
        "ตรวจสอบว่าคุณไว้วางใจ {0} โดยการทำความเข้าใจว่า {0} จะจัดการข้อมูลของคุณอย่างไร",
    ...
    "emailUpdateConfirmationSent":
        "อีเมลยืนยันถูกส่งไปยัง {0} คุณต้องปฏิบัติตามคำแนะนำในอีเมลเพื่อสิ้นสุดการปรับปรุงอีเมล",
    ...
    "oauth2DeviceExpiredUserCodeMessage":
        "รหัสหมดอายุแล้ว โปรดกลับไปที่อุปกรณ์ของคุณและลองเชื่อมต่ออีกครั้ง",
    ...
    "oauth2DeviceVerificationFailedMessage":
        "คุณสามารถปิดหน้าต่างเบราว์เซอร์นี้และกลับไปที่อุปกรณ์ของคุณและลองเชื่อมต่ออีกครั้ง",
    ...
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "ไคลเอนต์ไม่ได้รับการยินยอมให้เริ่ม OAuth 2.0 Device Authorization Grant การทำงานนี้ถูกปิดใช้งานสำหรับไคลเอนต์",
    "emailVerifyInstruction1":
        "ได้ส่งอีเมลที่มีคำแนะนำในการยืนยันที่อยู่อีเมลของคุณไปยังที่อยู่อีเมลของคุณ {0}",
    ...
    "emailInstruction":
        "ระบุชื่อผู้ใช้งานหรือที่อยู่อีเมลของคุณ เราจะส่งคำแนะนำในการสร้างรหัสผ่านใหม่ให้คุณ",
    ...
    "accountTemporarilyDisabledMessage":
        "บัญชีถูกปิดใช้งานชั่วคราว ติดต่อผู้ดูแลระบบของคุณหรือลองใหม่ในภายหลัง",
    ...
    "federatedIdentityExistsMessage":
        "ผู้ใช้งานที่มี {0} {1} มีอยู่แล้ว กรุณาเข้าสู่ระบบจัดการบัญชีเพื่อเชื่อมโยงบัญชี",
    "federatedIdentityUnavailableMessage":
        "ผู้ใช้งาน {0} ที่ได้รับการตรวจสอบจากผู้ให้บริการตัวตน {1} ไม่มีอยู่ กรุณาติดต่อผู้ดูแลระบบของคุณ",
    "federatedIdentityUnmatchedEssentialClaimMessage":
        "ไอดีโทเค็นที่ออกโดยผู้ให้บริการตัวตนไม่ตรงกับการอ้างสิทธิ์ที่จำเป็นที่กำหนดไว้ กรุณาติดต่อผู้ดูแลระบบของคุณ",
    "confirmLinkIdpTitle": "มีบัญชีอยู่แล้ว",
    "federatedIdentityConfirmLinkMessage":
        "ผู้ใช้งานที่มี {0} {1} มีอยู่แล้ว คุณต้องการดำเนินการอย่างไรต่อ?",
    ...
    "delegationCompleteMessage":
        "คุณสามารถปิดหน้าต่างเบราว์เซอร์นี้และกลับไปที่แอปพลิเคชันคอนโซลของคุณ.",
    "delegationFailedHeader": "เข้าสู่ระบบล้มเหลว",
    "delegationFailedMessage":
        "คุณสามารถปิดหน้าต่างเบราว์เซอร์นี้และกลับไปที่แอปพลิเคชันคอนโซลของคุณและลองเข้าสู่ระบบอีกครั้ง.",
    ...
    "invalidPasswordMinLowerCaseCharsMessage":
        "รหัสผ่านไม่ถูกต้อง: ต้องมีตัวอักษรพิมพ์เล็กอย่างน้อย {0} อักษร",
    "invalidPasswordMinUpperCaseCharsMessage":
        "รหัสผ่านไม่ถูกต้อง: ต้องมีตัวอักษรพิมพ์ใหญ่อย่างน้อย {0} อักษร",
    ...
    "bearerOnlyMessage":
        "แอปพลิเคชันที่ใช้ Bearer-only ไม่ได้รับอนุญาตให้เริ่มการเข้าสู่ระบบผ่านเบราว์เซอร์",
    "standardFlowDisabledMessage":
        "ไคลเอนต์ไม่ได้รับอนุญาตให้เริ่มการเข้าสู่ระบบผ่านเบราว์เซอร์ด้วย response_type ที่ระบุ Standard flow ถูกระงับสำหรับไคลเอนต์",
    "implicitFlowDisabledMessage":
        "ไคลเอนต์ไม่ได้รับอนุญาตให้เริ่มการเข้าสู่ระบบผ่านเบราว์เซอร์ด้วย response_type ที่ระบุ Implicit flow ถูกระงับสำหรับไคลเอนต์",
    ...
    "couldNotProceedWithAuthenticationRequestMessage":
        "ไม่สามารถดำเนินการต่อเพื่อส่งคำขอพิสูจน์ตัวจริงไปยังผู้ให้บริการตัวตน",
    "couldNotObtainTokenMessage": "ไม่สามารถรับโทเค็นจากผู้ให้บริการตัวตน",
    "unexpectedErrorRetrievingTokenMessage":
        "เกิดข้อผิดพลาดที่ไม่คาดคิดขณะรับโทเค็นจากผู้ให้บริการตัวตน",
    "unexpectedErrorHandlingResponseMessage":
        "เกิดข้อผิดพลาดที่ไม่คาดคิดขณะจัดการการตอบสนองจากผู้ให้บริการตัวตน",
    "identityProviderAuthenticationFailedMessage":
        "การตรวจสอบล้มเหลว ไม่สามารถตรวจสอบกับผู้ให้บริการตัวตน",
    ...
    "identityProviderUnexpectedErrorMessage":
        "เกิดข้อผิดพลาดที่ไม่คาดคิดขณะพิสูจน์ตัวจริงกับผู้ให้บริการตัวตน",
    ...
    "identityProviderLinkSuccess":
        "คุณได้ยืนยันที่อยู่อีเมลของคุณเรียบร้อยแล้ว กรุณากลับไปที่เบราว์เซอร์เดิมของคุณและดำเนินการเข้าสู่ระบบที่นั่น",
    "staleCodeMessage":
        "หน้านี้ไม่ถูกต้องอีกต่อไป กรุณากลับไปที่แอปพลิเคชันของคุณและเข้าสู่ระบบอีกครั้ง",
    ...
    "identityProviderNotUniqueMessage":
        "realm สนับสนุนผู้ให้บริการตัวตนหลายแหล่ง ไม่สามารถระบุได้ว่าควรพิสูจน์ตัวจริงผ่านผู้ให้บริการตัวตนใด",
    "emailVerifiedMessage": "ยืนยันที่อยู่อีเมลของคุณแล้ว",
    "staleEmailVerificationLink":
        "ลิงก์ที่คุณคลิกเป็นลิงก์ที่เก่าและไม่ถูกต้อง บางทีคุณอาจจะยืนยันอีเมลของคุณแล้ว",
    "identityProviderAlreadyLinkedMessage":
        "Federated identity ที่ส่งคืนมาจากผู้ให้บริการ {0} มีการเชื่อมโยงกับผู้ใช้งานอื่นแล้ว",
    ...
    "differentUserAuthenticated":
        "คุณได้พิสูจน์ตัวจริงเป็นผู้ใช้งานอื่น '{0}' ในเซสชันนี้แล้ว กรุณาออกจากระบบก่อน",
    ...
    "console-verify-email":
        "คุณจำเป็นต้องยืนยันที่อยู่อีเมลของคุณ เราได้ส่งอีเมลพร้อมรหัสยืนยันไปที่ {0} กรุณาระบุรหัสที่ได้รับลงในช่องว่างด้านล่าง",
    ...
    "saml.post-form.js-disabled":
        "JavaScript ถูกปิดใช้งาน เราขอแนะนำให้คุณเปิดใช้งาน คลิกที่ปุ่มด้านล่างเพื่อดำเนินการต่อ",
    ...
    "auth-recovery-authn-code-form-help-text":
        "ระบุรหัสพิสูจน์ตัวจริงเพื่อการกู้คืนจากรายการที่สร้างไว้ก่อนหน้า",
    ...
    "recovery-code-config-warning-title":
        "รหัสกู้คืนเหล่านี้จะไม่ปรากฏอีกหลังจากที่คุณออกจากหน้านี้ไปแล้ว",
    "recovery-code-config-warning-message":
        "ตรวจสอบให้แน่ใจว่าคุณได้พิมพ์ ดาวน์โหลด หรือคัดลอกรหัส เก็บไว้ในที่ที่ปลอดภัย หากคุณยกเลิกการตั้งค่า รหัสกู้คืนเหล่านี้จะถูกลบออกจากบัญชีของคุณ",
    ...
    "recovery-codes-download-file-description":
        "รหัสกู้คืนคือรหัสผ่านที่ใช้ได้เพียงครั้งเดียวที่จะช่วยให้คุณสามารถเข้าสู่ระบบได้หากคุณไม่สามารถเข้าถึง authenticator ของคุณ",
    ...
    "webauthn-passwordless-help-text":
        "ใช้คีย์รักษาความปลอดภัยสำหรับการเข้าสู่ระบบโดยไม่ต้องใช้รหัสผ่าน",
    ...
    "webauthn-unsupported-browser-text":
        "เว็บเบราว์เซอร์นี้ไม่สนับสนุน WebAuthn ลองใช้เบราว์เซอร์อื่นหรือติดต่อผู้ดูแลระบบของคุณ",
    ...
    "webauthn-error-different-user":
        "ผู้ใช้งานที่พิสูจน์ตัวจริงรายแรกไม่ใช่รายที่ได้รับการพิสูจน์ตัวจริงจากคีย์รักษาความปลอดภัย",
    ...
    "webauthn-error-user-not-found":
        "ผู้ใช้งานที่ไม่รู้จักได้รับการพิสูจน์ตัวจริงจากคีย์รักษาความปลอดภัย",
    ...
    "finalDeletionConfirmation":
        "หากคุณลบบัญชีของคุณ จะไม่สามารถกู้คืนได้ หากต้องการเก็บบัญชีของคุณ ให้คลิกยกเลิก",
    ...
    "readOnlyUsernameMessage":
        "คุณไม่สามารถปรับปรุงชื่อผู้ใช้งานของคุณเนื่องจากเป็นข้อมูลแบบอ่านอย่างเดียว",
