...
const messages = {
    ...
    "deletingAccountForbidden":
        "No teniu permisos suficients per a eliminar el vostre compte, contacteu amb l'administrador.",
    ...
    "accountTemporarilyDisabledMessage":
        "El compte està temporalment inhabilitat, contacteu amb l'administrador o intenteu-ho de nou més tard.",
    ...
    "configureTotpMessage":
        "Heu de configurar l'aplicació mòbil d'autenticació per a activar el compte.",
    ...
    "invalidPasswordNotUsernameMessage":
        "La contrasenya no és vàlida: no pot ser igual al nom d'usuari.",
    ...
    "cookieNotFoundMessage":
        "No s'ha trobat la galeta. Assegureu-vos que les galetes estan habilitades al vostre navegador.",
    ...
    "webauthn-passwordless-help-text":
        "Utilitzeu la vostra clau de seguretat per a entrar sense contrasenya.",
    ...
    "webauthn-error-auth-verification":
        "El resultat de l'autenticació amb clau de seguretat no és vàlid.<br/>{0}",
    "webauthn-error-register-verification":
        "El resultat del registre amb clau de seguretat no és vàlid.<br/>{0}",
