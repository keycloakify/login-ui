...
const messages = {
    ...
    doAccept: "Accepta",
    doDecline: "Rebutja",
    doForgotPassword: "Heu oblidat la contrasenya?",
    ...
    deletingAccountForbidden:
        "No teniu prou permisos per a eliminar el vostre compte, contacteu amb l’administrador.",
    kerberosNotConfigured: "Kerberos no està configurat",
    kerberosNotConfiguredTitle: "Kerberos no està configurat",
    bypassKerberosDetail:
        "O bé no esteu identificat mitjançant Kerberos o el vostre navegador no està configurat per a identificar-se mitjançant Kerberos. Feu clic per a identificar-vos per un altre mitjà",
    ...
    loginTimeout:
        "S’ha excedit el temps per a realitzar una entrada. L’entrada començarà des del principi.",
    reauthenticate: "Torneu a identificar-vos per a continuar",
    oauthGrantTitle: "Concedeix l'accés a {0}",
    oauthGrantTitleHtml: "{0}",
    oauthGrantInformation:
        "Assegureu-vos que confieu en {0} assabentant-vos de com {0} gestionarà les vostres dades.",
    ...
    emailUpdateConfirmationSent:
        "S'ha enviat un correu electrònic de confirmació a {0}. Seguiu les instruccions per a completar l'actualització del correu electrònic.",
    ...
    loginTotpIntro:
        "Heu de configurar un generador de contrasenyes d'un sol ús per a accedir a aquest compte",
    ...
    loginTotpStep3:
        "Introduïu el codi d'un sol ús proveït per l'aplicació i feu clic a Envia per a finalitzar la configuració.",
    loginTotpStep3DeviceName:
        "Introduïu un nom de dispositiu per a ajudar-vos a gestionar els vostres dispositius OTP.",
    loginTotpManualStep2: "Obriu l'aplicació i introduïu la clau:",
    loginTotpManualStep3:
        "Utilitzeu els valors de configuració següents si l'aplicació permet establir-los:",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "El codi ha caducat. Torneu al vostre dispositiu i intenteu-ho de nou.",
    oauth2DeviceVerificationCompleteHeader: "Inici de sessió per dispositiu correcte",
    oauth2DeviceVerificationCompleteMessage:
        "Podeu tancar aquesta finestra del navegador i tornar al vostre dispositiu.",
    oauth2DeviceVerificationFailedHeader: "Ha fallat l'inici de sessió per dispositiu",
    oauth2DeviceVerificationFailedMessage:
        "Podeu tancar aquesta finestra del navegador i tornar al vostre dispositiu per a tornar a connectar.",
    ...
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "El client no està autoritzat a iniciar una concessió d'autorització de dispositiu OAuth 2.0. El flux és inhabilitat per al client.",
    emailVerifyInstruction1:
        "S'ha enviat un correu electrònic a la vostra adreça de correu electrònic {0} amb instruccions per a verificar-la.",
    ...
    emailLinkIdp1:
        "S'ha enviat un correu electrònic amb instruccions per a enllaçar el compte {0} {1} amb el vostre compte {2}.",
    ...
    emailInstruction:
        "Introduïu el vostre nom d'usuari o adreça de correu electrònic i us enviarem instruccions per a establir una contrasenya nova.",
    emailInstructionUsername:
        "Introduïu el vostre nom d'usuari i us enviarem instruccions per a establir una contrasenya nova.",
    ...
    accountTemporarilyDisabledMessage: "El nom d'usuari o contrasenya no són vàlids.",
    accountPermanentlyDisabledMessage: "El nom d'usuari o contrasenya no són vàlids.",
    accountTemporarilyDisabledMessageTotp: "El codi d'autenticació no és vàlid.",
    accountPermanentlyDisabledMessageTotp: "El codi d'autenticació no és vàlid.",
    ...
    "error-invalid-length-too-short": "La llargària mínima és {1}.",
    "error-invalid-length-too-long": "La llargària màxima és, {2}.",
    ...
    "error-number-out-of-range-too-small": "El nombre ha de tenir un valor de, com a mínim, {1}.",
    "error-number-out-of-range-too-big": "El nombre ha de tenir un valor de, com a màxim, {2}.",
    ...
    federatedIdentityExistsMessage:
        "Ja existeix un usuari amb {0} {1}. Entreu al gestor de comptes per a enllaçar el compte.",
    federatedIdentityUnavailableMessage:
        "L'usuari {0} autenticat amb el proveïdor d'identitat {1} no existeix. Contacteu amb l'administrador.",
    federatedIdentityUnmatchedEssentialClaimMessage:
        "El codi d'autorització de l'ID emès pel proveïdor d'identitat no concorda amb la declaració essencial configurada. Contacteu amb l'administrador.",
    ...
    federatedIdentityConfirmReauthenticateMessage:
        "Identifiqueu-vos per a enllaçar el vostre compte amb {0}",
    ...
    updateEmailMessage:
        "Heu d'actualitzar la vostra adreça de correu electrònic per a activar el compte.",
    resetPasswordMessage: "Heu de canviar la contrasenya.",
    verifyEmailMessage:
        "Heu de verificar la vostra adreça de correu electrònic per a activar el compte.",
    ...
    delegationCompleteMessage:
        "Podeu tancar aquesta finestra del navegador i tornar a la vostra aplicació de consola.",
    delegationFailedHeader: "Ha fallat l'inici de sessió",
    delegationFailedMessage:
        "Podeu tancar aquesta finestra del navegador i tornar a la vostra aplicació de consola per a tornar a connectar.",
    ...
    invalidPasswordNotEmailMessage:
        "La contrasenya no és vàlida: no pot ser igual al correu electrònic.",
    invalidPasswordRegexPatternMessage:
        "La contrasenya no és vàlida: no coincideix amb el patró de l'expressió regular.",
    ...
    invalidPasswordGenericMessage:
        "La contrasenya no és vàlida: la contrasenya nova no coincideix amb les polítiques de contrasenya.",
    ...
    standardFlowDisabledMessage:
        "El client no està autoritzat a iniciar una entrada per navegador amb el tipus de resposta donada. El flux estàndard està inhabilitat per al client.",
    implicitFlowDisabledMessage:
        "El client no està autoritzat a iniciar una entrada per navegador amb el tipus de resposta donada. El flux implícit està inhabilitat per al client.",
    ...
    couldNotObtainTokenMessage:
        "No s'ha pogut obtenir el codi d'autorització del proveïdor d'identitat.",
    unexpectedErrorRetrievingTokenMessage:
        "Error inesperat en obtenir el codi d'autorització del proveïdor d'identitat.",
    ...
    identityProviderAuthenticationFailedMessage:
        "Ha fallat l'autenticació. No ha estat possible autenticar-se amb el proveïdor d'identitat.",
    ...
    cookieNotFoundMessage:
        "No s'ha trobat la galeta de reinici de sessió. Podria haver caducat; podria haver-se eliminat, o teniu les galetes inhabilitades al navegador. Si les teniu inhabilitades, activeu-les. Feu clic en Torna a l'aplicació per a tornar a iniciar la sessió.",
    ...
    identityProviderUnexpectedErrorMessage:
        "Error no esperat intentant autenticar amb el proveïdor d'identitat",
    identityProviderMissingStateMessage:
        "Manca un paràmetre d'estat a la resposta del proveïdor d'identitat.",
    ...
    identityProviderInvalidSignatureMessage:
        "La signatura de la resposta del proveïdor d'identitat no és vàlida.",
    identityProviderNotFoundMessage: "No s'ha trobat cap proveïdor d'identitat.",
    identityProviderLinkSuccess:
        "Heu verificat el vostre correu electrònic correctament. Torneu al vostre navegador original i continueu amb l'entrada allà.",
    ...
    staleEmailVerificationLink:
        "L’enllaç en què heu clicat és un enllaç antic que ja no és vàlid. Potser ja heu verificat el vostre correu electrònic.",
    identityProviderAlreadyLinkedMessage:
        "La identitat federada retornada per {0} ja està enllaçada a un altre usuari.",
    confirmAccountLinking:
        "Confirmeu l'enllaçat del compte {0} del proveïdor d'identitat {1} amb el vostre compte.",
    ...
    differentUserAuthenticated:
        "Ja esteu identificat amb l'usuari diferent «{0}» en aquesta sessió. Desconnecteu primer.",
    brokerLinkingSessionExpired:
        "S'ha sol·licitat l'enllaçat d'un compte agent, però la sessió actual ja no és vàlida.",
    ...
    "console-verify-email":
        "Heu de verificar l’adreça de correu electrònic. Hem enviat un correu electrònic a {0} que conté un codi de verificació. Introduïu aquest codi al camp següent.",
    ...
    "saml.post-form.js-disabled":
        "El JavaScript està inhabilitat. Us recomanem que l'habiliteu. Feu clic al botó de sota per a continuar.",
    ...
    "recovery-authn-codes-display-name": "Codi d’autenticació de recuperació",
    "recovery-authn-codes-help-text":
        "Introduïu un codi d’autenticació de recuperació d’una llista prèviament generada.",
    ...
    "recovery-code-config-warning-title":
        "Aquests codis de recuperació no es tornaran a mostrar després que abandoneu la pàgina",
    "recovery-code-config-warning-message":
        "Assegureu-vos que els imprimiu, baixeu o copieu a un gestor de contrasenyes i els deseu de manera segura. Cancel·lar aquesta configuració eliminarà aquests codis de recuperació del vostre compte.",
    ...
    "recovery-codes-download-file-description":
        "Els codis de recuperació són codis d'accés d'un sol ús que vos permeten entrar al vostre compte si no teniu accés al vostre autenticador.",
    ...
    "webauthn-unsupported-browser-text":
        "El WebAuthn no està implementat per aquest navegador. Proveu-ho amb un altre o contacteu amb l'administrador.",
    ...
    "webauthn-error-different-user":
        "L'usuari identificat primer no és l'autenticat per la clau de seguretat.",
    "webauthn-error-auth-verification":
        "El resultat de l'autenticació amb clau de seguretat no és vàlid.{0}",
    "webauthn-error-register-verification":
        "El resultat del registre amb clau de seguretat no és vàlid.{0}",
    ...
    "idp-email-verification-help-text":
        "Enllaceu el compte verificant la vostra adreça de correu electrònic.",
    ...
    finalDeletionConfirmation:
        "Si elimineu el vostre compte, no es podrà restaurar. Per a mantenir el vostre compte, feu clic en Cancel·la.",
    ...
    "passkey-unsupported-browser-text":
        "Aquest navegador no implementa Passkey. Proveu-ho amb un altre, o contacteu amb l'administrador.",
    ...
    "organization.member.register.title":
        "Creeu un compte per a unir-vos a l'organització ${kc.org.name}",
    ...
    invalidPasswordNotContainsUsernameMessage:
        "La contrasenya no és vàlida: no pot contenir el nom d'usuari.",
    identityProviderMissingCodeOrErrorMessage:
        "Manca el paràmetre o codi d'error a la resposta del proveïdor d'identitat.",
    ...
    federatedIdentityConfirmOverrideMessage:
        "Esteu intentant enllaçar el vostre compte {0} amb el compte {2} de {1}, però el vostre compte ja està enllaçat amb el compte de {3} diferent {4}. Podeu confirmar que voleu reemplaçar l'enllaç existent amb el compte nou?",
    "organization.confirm-membership":
        "Si feu clic al següent enllaç, esdevindreu membre de l'organització {0}:",
    ...
    "error-invalid-multivalued-size":
        "L’atribut {0} ha de tenir almenys {1} i com a molt {2} {2,choice,0#valors|1#valor|1<valor}.",
    confirmOverrideIdpTitle: "L'enllaç de l'agent ja existeix",
    notMemberOfOrganization: "L'usuari no és membre de l'organització {0}",
    notMemberOfAnyOrganization: "L’usuari no és membre de cap organització",
    emailVerifyInstruction4:
        "Per a verificar la vostra adreça de correu electrònic, us enviarem un correu amb instruccions a l’adreça {0}.",
    emailVerifyResend: "Torna a enviar el correu de verificació",
    ...
    confirmAccountLinkingBody:
        "Si enllaceu el compte, també podreu entrar amb el compte {0} del proveïdor d’identitat {1}. No continueu si no heu iniciat aquest procés o si no voleu enllaçar el compte.",
    emailVerifySendCooldown:
        "Heu d’esperar {0} segons abans de tornar a enviar el correu de verificació.",
    "error-non-ascii-local-part-email":
        "La part local de l’adreça ha de contenir només caràcters ASCII.",
    "requiredAction.delete_account": "Suprimeix el compte",
    "requiredAction.UPDATE_EMAIL": "Actualitza l’adreça de correu electrònic",
    "requiredAction.VERIFY_PROFILE": "Verifica el perfil",
    "requiredAction.delete_credential": "Suprimeix la credencial",
    "requiredAction.idp_link": "Proveïdor d’enllaç d’identitats",
    "requiredAction.update_user_locale": "Actualitza la configuració regional de l’usuari",
    ...
    emailVerificationPending:
        "S’ha enviat un correu electrònic de verificació a {0}. Podeu enviar sense canvis per a tornar a enviar el correu de verificació, o introduir una altra adreça electrònica.",
    emailVerificationCancelled:
        "Un administrador ha cancel·lat aquesta verificació de l’adreça electrònica.",
    orgMemberAlready: "Ja sou membre de l’organització {1}.",
    staleInviteOrgLink:
        "L’enllaç en què heu fet clic ja no és vàlid. És possible que hagi caducat, o que ja s’hagi utilitzat.",
