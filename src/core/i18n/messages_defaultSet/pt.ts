...
const messages = {
    ...
    "deletingAccountForbidden":
        "Não tem permissões para apagar a sua própria conta, entre em contacto com um administrador.",
    "kerberosNotConfigured": "Kerberos Não Configurado",
    "kerberosNotConfiguredTitle": "Kerberos Não Configurado",
    "bypassKerberosDetail":
        "Não possui uma sessão Kerberos ou o seu navegador não está configurado para usar o acesso do Kerberos. Por favor, clique em continuar para fazer o login através de outros meios",
    ...
    "oauthGrantInformation":
        "Certifique-se de confiar em {0} aprendendo como {0} lidará com os seus dados.",
    ...
    "emailUpdateConfirmationSent":
        "Um e-mail de confirmação foi enviado para {0}. Deve seguir as instruções do primeiro para concluir a atualização do e-mail.",
    ...
    "loginTotpStep3":
        "Digite o código de uso único fornecido pela aplicação e clique em Ok para concluir a configuração.",
    "loginTotpStep3DeviceName":
        "Forneça um nome de dispositivo para ajudá-lo a gerir os seus dispositivos de autenticação de dois fatores.",
    "loginTotpManualStep2": "Abra a aplicação e digite a chave:",
    "loginTotpManualStep3":
        "Use os seguintes valores de configuração se a aplicação permitir defini-los:",
    ...
    "oauth2DeviceExpiredUserCodeMessage":
        "O código expirou. Por favor, volte para o seu dispositivo e tente novamente.",
    "oauth2DeviceVerificationCompleteHeader": "Login do dispositivo bem-sucedido",
    "oauth2DeviceVerificationCompleteMessage":
        "Pode fechar esta janela do navegador e voltar ao seu dispositivo.",
    "oauth2DeviceVerificationFailedHeader": "Falha no login do dispositivo",
    "oauth2DeviceVerificationFailedMessage":
        "Pode fechar esta janela do navegador, voltar ao seu dispositivo e tentar novamente.",
    ...
    "oauth2DeviceAuthorizationGrantDisabledMessage":
        "O cliente não tem permissão para iniciar a concessão de autorização de dispositivo OAuth 2.0. O fluxo é desativado para o cliente.",
    "emailVerifyInstruction1":
        "Foi-lhe enviado um e-mail com instruções para verificar o seu endereço de e-mail.",
    ...
    "emailLinkIdp1":
        "Foi-lhe enviado um e-mail com instruções para vincular a conta {0} {1} com a sua conta {2}.",
    ...
    "emailInstructionUsername":
        "Insira o seu nome de utilizador e enviaremos instruções sobre como criar uma palavra-passe.",
    ...
    "federatedIdentityExistsMessage":
        "Utilizador com {0} {1} já existe. Por favor, entre no gestor de conta para vincular a conta.",
    "federatedIdentityUnavailableMessage":
        "Utilizador {0} autenticado com o provedor de identidade {1} não existe. Por favor, entre em contacto com um administrador.",
    "federatedIdentityUnmatchedEssentialClaimMessage":
        "O token de ID emitido pelo provedor de identidade não corresponde à declaração essencial configurada. Por favor, entre em contacto com um administrador.",
    ...
    "nestedFirstBrokerFlowMessage":
        "O utilizador {0} {1} não está vinculado a nenhum utilizador conhecido.",
    ...
    "configureTotpMessage":
        "Precisa configurar o seu telemóvel com o autenticador para ativar a sua conta.",
    ...
    "delegationFailedMessage":
        "Pode fechar esta janela do navegador e voltar à aplicação e tentar fazer login novamente.",
    ...
    "invalidPasswordMinLowerCaseCharsMessage":
        "Palavra-passe inválida: deve conter pelo menos {0} letra(s) minúscula(s).",
    "invalidPasswordMinUpperCaseCharsMessage":
        "Palavra-passe inválida: deve conter pelo menos {0} letra(s) maiúscula(s).",
    "invalidPasswordMinSpecialCharsMessage":
        "Palavra-passe inválida: deve conter pelo menos {0} caractere(s) especial(is).",
    "invalidPasswordNotUsernameMessage":
        "Palavra-passe inválida: não pode ser igual ao nome de utilizador",
    "invalidPasswordNotEmailMessage":
        "Palavra-passe inválida: não pode ser igual ao endereço de e-mail.",
    "invalidPasswordRegexPatternMessage":
        "Palavra-passe inválida: não corresponde ao(s) padrão(ões) de expressão regular.",
    "invalidPasswordHistoryMessage":
        "Palavra-passe inválida: não pode ser igual a qualquer uma da(s) última(s) {0} palavra-passe(s).",
    "invalidPasswordGenericMessage":
        "Palavra-passe inválida: a nova palavra-passe não cumpre as políticas de palavra-passe.",
    ...
    "bearerOnlyMessage":
        "Aplicações configuradas como Bearer-Only não têm permissão para iniciar o login pelo navegador",
    "standardFlowDisabledMessage":
        "O cliente não tem permissão para iniciar o login com o response_type definido. O fluxo padrão está desativado para o cliente.",
    "implicitFlowDisabledMessage":
        "O cliente não tem permissão para iniciar o login com o response_type definido. O fluxo implícito está desativado para o cliente.",
    ...
    "cookieNotFoundMessage":
        "Cookie não encontrado. Certifique-se de que os cookies estão ativos no seu navegador.",
    ...
    "identityProviderMissingStateMessage":
        "Parâmetro de estado ausente na resposta do provedor de identidades.",
    "identityProviderMissingCodeOrErrorMessage":
        "Código ausente ou parâmetro de erro na resposta do provedor de identidade.",
    ...
    "staleEmailVerificationLink":
        "A ligação em que clicou é uma ligação antiga e está inválida. Talvez já tenha confirmado o seu endereço de e-mail.",
    "identityProviderAlreadyLinkedMessage":
        "A conta retornada do {0} já está vinculada a outro utilizador.",
    ...
    "console-verify-email":
        "Precisa verificar o seu endereço de e-mail. Enviámos um e-mail para {0} que contém um código de verificação. Digite o código enviado no campo abaixo.",
    ...
    "saml.post-form.js-disabled":
        "O JavaScript está desativado. É altamente recomendável ativá-lo. Clique no botão abaixo para continuar.",
    ...
    "recovery-code-config-warning-title":
        "Esses códigos de recuperação não aparecerão novamente após sair desta página",
    "recovery-code-config-warning-message":
        "Certifique-se de imprimir, descarregar ou copiá-los para um gestor de senhas e guardá-los. Cancelar esta configuração removerá esses códigos de recuperação da sua conta.",
    ...
    "recovery-codes-download-file-description":
        "Os códigos de recuperação são códigos de uso único que permitem que faça login na sua conta se não tiver acesso ao seu autenticador.",
    ...
    "webauthn-passwordless-help-text":
        "Use a sua chave de segurança para fazer login sem palavra-passe.",
    ...
    "webauthn-unsupported-browser-text":
        "WebAuthn não é suportado pelo seu navegador. Tente outro navegador ou entre em contacto com um administrador.",
    ...
    "finalDeletionConfirmation":
        "Se apagar a sua conta, ela não poderá ser recuperada. Para manter a sua conta, clique em Cancelar.",
    ...
    "readOnlyUsernameMessage":
        "Não pode atualizar o seu nome de utilizador, porque é apenas de leitura.",
    "error-invalid-multivalued-size":
        "O atributo {0} tem que conter no mínimo {1} e no máximo {2} valores.",
