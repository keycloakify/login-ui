...
const messages = {
    ...
    bypassKerberosDetail:
        "Non sei connesso via Kerberos o il tuo browser non supporta l'autenticazione a Kerberos. Fai clic su Continua per accedere in un altro modo",
    ...
    loginTotpIntro:
        "Devi impostare un generatore di OTP (password temporanea valida una volta sola) per accedere a questo utente",
    ...
    loginTotpStep3:
        "Scrivi il codice monouso fornito dall'applicazione e premi Invia per completare la configurazione.",
    ...
    emailVerifyInstruction1:
        "Ti è stata inviata una email con le istruzioni per la verifica del tuo indirizzo {0}.",
    ...
    emailLinkIdp1:
        "Ti è stata inviata una email con le istruzioni per collegare l'utenza {0} {1} con il tuo utente {2}.",
    ...
    emailInstruction:
        "Inserisci il tuo nome utente o l'indirizzo email e ti manderemo le istruzioni per creare una nuova password.",
    ...
    federatedIdentityExistsMessage:
        "L'utente con {0} {1} esiste già. Accedi all'interfaccia di gestione dell'utente per associare l'utenza.",
    ...
    invalidPasswordRegexPatternMessage:
        "Password non valida: non soddisfa una o più espressioni regolari.",
    ...
    invalidPasswordGenericMessage:
        "Password non valida: la nuova password non rispetta i requisiti previsti.",
    ...
    bearerOnlyMessage:
        "Alle applicazioni di tipo Bearer-only non è consentito effettuare l'accesso tramite browser",
    standardFlowDisabledMessage:
        "Al client non è consentito effettuare l'accesso tramite browser con questo response_type. Il flusso standard è stato disabilitato per questo client.",
    implicitFlowDisabledMessage:
        "Al client non è consentito effettuare l'accesso tramite browser con questo response_type. Il flusso implicito è stato disabilitato per questo client.",
    ...
    identityProviderAuthenticationFailedMessage:
        "Autenticazione fallita. Impossibile effettuare l'autenticazione con l'identity provider.",
    ...
    identityProviderLinkSuccess:
        "Hai verificato con successo la tua email. Puoi tornare al tuo browser iniziale e continua da lì con l'accesso.",
    staleCodeMessage:
    ...
    credentialSetupRequired:
        "Impossibile effettuare l'accesso, è richiesta la configurazione delle credenziali.",
    ...
    staleEmailVerificationLink:
        "Il collegamento che hai cliccato è scaduto e non è più valido. Probabilmente hai già verificato la tua email.",
    ...
    confirmAccountLinking:
        "Conferma il collegamento per l'utenza {0} dell'identity provider {1} con il tuo utente.",
    ...
    brokerLinkingSessionExpired:
        "È stato richiesta un'associazione a un utenza broker, ma la sessione corrente non è più valida.",
    ...
    "webauthn-error-different-user":
        "Il primo utente autenticato non è quello autenticato tramite la Passkey.",
    "webauthn-error-auth-verification":
        "Il risultato dell'autenticazione con la Passkey non è valido. {0}",
    "webauthn-error-register-verification":
        "Il risultato della registrazione della Passkey non è valido. {0}",
    ...
    deletingAccountForbidden:
        "Non hai i permessi sufficienti per eliminare il tuo utente, contatta l'amministratore.",
    ...
    oauth2DeviceExpiredUserCodeMessage:
        "Il codice è scaduto. Torna sul dispositivo e prova a connetterti di nuovo.",
    oauth2DeviceVerificationCompleteHeader: "Autenticato correttamente con dispositivo",
    oauth2DeviceVerificationCompleteMessage:
        "Puoi chiudere questa finestra e tornare al tuo dispositivo.",
    oauth2DeviceVerificationFailedHeader: "Errore nell'autenticazione con dispositivo",
    oauth2DeviceVerificationFailedMessage:
        "Puoi chiudere questa finestra e tornare al tuo dispositivo per provare nuovamente.",
    oauth2DeviceAuthorizationGrantDisabledMessage:
        "Il client non è autorizzato ad effettuare l'autenticazione del dispositivo (OAuth 2.0 Device Authorization Grant). Questo flusso è disabilitato per il client.",
    ...
    federatedIdentityUnmatchedEssentialClaimMessage:
        "Il token emesso dall'identity provider non presenta i criteri richiesti. Si prega di contattare un amministratore.",
    ...
    "recovery-authn-codes-help-text":
        "Inserisci un codice di recupero da un elenco generato in precedenza.",
    ...
    "recovery-code-config-warning-message":
        "Assicurarsi di stamparli, scaricarli o copiarli in un gestore di password per conservarli. Se clicchi annulla i codici di recupero verranno rimossi dal tuo utente.",
    ...
    "recovery-codes-download-file-description":
        "I codici di recupero sono dei codici di accesso monouso che consentono di accedere alla propria utenza se non si è in grado di generare un codice OTP.",
    ...
    "passkey-unsupported-browser-text":
        "Le Passkey non sono supportate da questo browser. Prova un altro browser o contatta il tuo amministratore.",
    ...
    finalDeletionConfirmation:
        "Una volta eliminato, non sarà più possibile recuperare il tuo utente. Per mantenerlo clicca su Annulla.",
    ...
    "error-invalid-multivalued-size":
        "L'attributo {0} deve avere almeno {1} e al massimo {2}{2,choice,0#valori|1#valore|1<valori}.",
    ...
    federatedIdentityUnavailableMessage:
        "L'utente {0} autenticato con l'identity provider {1} non esiste. Si prega di contattare un amministratore.",
    ...
    "webauthn-unsupported-browser-text":
        "Il protocollo WebAuthn non è supportato in questo browser. Provane un'altro o contatta il tuo amministratore.",
    ...
    cookieNotFoundMessage:
        "Il cookie non è stato trovato. È possibile che sia scaduto, che sia stato cancellato o che i cookie siano stati disabilitati nel browser. Se i cookie sono disabilitati, attivali. Clicca su Torna all'applicazione per effettuare nuovamente l'accesso.",
    "saml.artifactResolutionServiceInvalidResponse": "Impossibile risolvere l'artefatto.",
    identityProviderInvalidSignatureMessage:
        "Nella risposta dell'identity provider la firma non è valida.",
    ...
    "organization.confirm-membership":
        "Cliccando il collegamento sottostante diventerai parte dell'organizzazione {0}:",
    accountUnusable:
        "Qualsiasi utilizzo successivo dell'applicazione non sarà più possibile con questo utente",
    ...
    emailVerifyInstruction4:
        "Per verificare la tua email ti stiamo per inviare un messaggio all'indirizzo {0}.",
    identityProviderMissingCodeOrErrorMessage:
        'Nella risposta dell\'identity provider manca il parametro "code" o "error".',
    ...
    federatedIdentityConfirmOverrideMessage:
        "Stai cercando di collegare l'utente {0} con l'utenza {1} {2}. Tuttavia esiste già un collegamento con l'utenza {3} {4}. Vuoi veramente sostituire il collegamento esistente?",
    ...
    identityProviderMissingStateMessage:
        'Nella risposta dell\'identity provider manca il parametro "state".',
    "recovery-code-config-warning-title":
        "Questi codici di recupero non saranno più visualizzati dopo che avrai lasciato questa pagina",
    ...
    emailUpdateConfirmationSent:
        "Un'email di conferma è stata inviata a {0}. Devi seguire le istruzioni contenute per completare il cambio di indirizzo.",
    ...
    emailInstructionUsername:
        "Inserisci il tuo nome utente e ti invieremo le istruzioni per creare una nuova password.",
    ...
    confirmAccountLinkingBody:
        "Se si collega l'utente, sarà possibile accedere anche utilizzando l'utenza {0} dell'identity provider {1}. Non procedere se non si è avviata questa procedura o se non si desidera collegare l'account.",
    codeSuccess: "Codice di successo",
    emailVerifySendCooldown:
        "Devi attendere {0} secondi prima di inviare nuovamente l'e-mail di verifica.",
