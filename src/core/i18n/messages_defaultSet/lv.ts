...
const messages = {
    ...
    "emailLinkIdp1":
        "E-pasts ar instrukcijām, lai saistītu {0} kontu {1} ar savu {2} kontu ir nosūtīts.",
    ...
    "invalidPasswordMinSpecialCharsMessage":
        "Nekorekta parole: tai jāsatur vismaz {0} speciālie simboli.",
    ...
    "invalidPasswordHistoryMessage":
        "Nekorekta parole: nedrīkst būt vienāda ar iepriekšējām {0} parolēm.",
