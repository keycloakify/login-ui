            ...
            prI18n_currentLanguage: isCurrentLanguageFallbackLanguage
                ...
                : (async () => {
                      const messages_defaultSet_currentLanguage = await (async () => {
                          ...
                          const isEmpty = (() => {
                              for (const _key in fromDefaultSet) {
                                  return false;
                              }
                          ...
                          if (isEmpty) {
                              assert(
                                  is<Exclude<LanguageTag, LanguageTag_defaultSet>>(currentLanguageTag)
                              );
...
function createI18nTranslationFunctionsFactory<MessageKey_themeDefined extends string>(params: {
    ...
    function createI18nTranslationFunctions(params: {
        ...
        GenericI18n<MessageKey_defaultSet | MessageKey_themeDefined, string>,
