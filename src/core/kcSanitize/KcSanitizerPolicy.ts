...
export class KcSanitizerPolicy {
    ...
    public static readonly COLOR_CODE = new RegExp("(?:#(?:[0-9a-fA-F]{3}(?:[0-9a-fA-F]{3})?))");
    ...
    public static readonly NUMBER = new RegExp("[+-]?(?:(?:[0-9]+(?:\\.[0-9]*)?)|\\.[0-9]+)");
    ...
    public static readonly HISTORY_BACK = new RegExp("(?:javascript:)?\\Qhistory.go(-1)\\E");
